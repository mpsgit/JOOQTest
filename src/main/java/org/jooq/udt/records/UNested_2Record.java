...
public class UNested_2Record extends ArrayRecordImpl<UNested_1Record> {
	...
	private static final long serialVersionUID = 564645125;
	...
	public UNested_2Record(Configuration configuration) {
		super(Wetrn.WETRN, "U_NESTED_2", org.jooq.udt.UNested_1.U_NESTED_1.getDataType(), configuration);
	}
	...
	/**
	 * Create a new <code>WETRN.U_NESTED_2</code> record
	 */
	public UNested_2Record() {
		super(Wetrn.WETRN, "U_NESTED_2", org.jooq.udt.UNested_1.U_NESTED_1.getDataType());
	}
