...
public class LkupBrchrLineNrGrpId extends AbstractRoutine<BigDecimal> {
	...
	private static final long serialVersionUID = -1951366541;

	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_LN_GRP.LKUP_BRCHR_LINE_NR_GRP_ID.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_LN_GRP.LKUP_BRCHR_LINE_NR_GRP_ID.P_LINE_NR_TYP_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_LN_GRP.LKUP_BRCHR_LINE_NR_GRP_ID.P_LEAD_BUS_DIV_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_LN_GRP.LKUP_BRCHR_LINE_NR_GRP_ID.P_FORM_ID</code>.
	 */
	...
	public LkupBrchrLineNrGrpId() {
		super("LKUP_BRCHR_LINE_NR_GRP_ID", Wetrn.WETRN, AppLnmCenaLnGrp.APP_LNM_CENA_LN_GRP, org.jooq.impl.SQLDataType.NUMERIC);
