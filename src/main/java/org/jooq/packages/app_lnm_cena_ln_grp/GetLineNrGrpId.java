...
public class GetLineNrGrpId extends AbstractRoutine<BigDecimal> {
	...
	private static final long serialVersionUID = 1034693603;

	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_LN_GRP.GET_LINE_NR_GRP_ID.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_LN_GRP.GET_LINE_NR_GRP_ID.P_LKUP_TREE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_LN_GRP.GET_LINE_NR_GRP_ID.P_LINE_NR_TYP_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_LN_GRP.GET_LINE_NR_GRP_ID.P_LEAD_BUS_DIV_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_LN_GRP.GET_LINE_NR_GRP_ID.P_BUS_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_BUS_ID = createParameter("P_BUS_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_LN_GRP.GET_LINE_NR_GRP_ID.P_CATGRY_ID</code>.
	 */
	...
	public GetLineNrGrpId() {
		super("GET_LINE_NR_GRP_ID", Wetrn.WETRN, AppLnmCenaLnGrp.APP_LNM_CENA_LN_GRP, org.jooq.impl.SQLDataType.NUMERIC);
