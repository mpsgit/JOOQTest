...
public class ReassignScrnSetDetails extends AbstractRoutine<Object> {

	private static final long serialVersionUID = 1500867500;

	/**
	 * The parameter <code>WETRN.APP_LNM_NOLA.REASSIGN_SCRN_SET_DETAILS.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_NOLA.REASSIGN_SCRN_SET_DETAILS.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_NOLA.REASSIGN_SCRN_SET_DETAILS.P_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_NOLA.REASSIGN_SCRN_SET_DETAILS.P_OFFR_SKU_SET_ID</code>.
	 */
	 ...
	 */
	public ReassignScrnSetDetails() {
		super("REASSIGN_SCRN_SET_DETAILS", Wetrn.WETRN, AppLnmNola.APP_LNM_NOLA, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
