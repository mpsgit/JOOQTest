...
public class InVehList extends AbstractRoutine<String> {
	...
	private static final long serialVersionUID = 1924206997;

	/**
	 * The parameter <code>WETRN.APP_LNM_NOLA.IN_VEH_LIST.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_NOLA.IN_VEH_LIST.P_VEH_ID</code>.
	 */
	 ...
	 */
	public InVehList() {
		super("IN_VEH_LIST", Wetrn.WETRN, AppLnmNola.APP_LNM_NOLA, org.jooq.impl.SQLDataType.CHAR.length(1));
