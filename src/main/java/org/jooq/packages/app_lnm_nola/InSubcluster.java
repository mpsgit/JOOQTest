...
public class InSubcluster extends AbstractRoutine<String> {

	private static final long serialVersionUID = 134726917;

	/**
	 * The parameter <code>WETRN.APP_LNM_NOLA.IN_SUBCLUSTER.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_NOLA.IN_SUBCLUSTER.P_MRKT_ID</code>.
	 */
	 ...
	 */
	public InSubcluster() {
		super("IN_SUBCLUSTER", Wetrn.WETRN, AppLnmNola.APP_LNM_NOLA, org.jooq.impl.SQLDataType.CHAR.length(1));
