...
public class AssignBi extends AbstractRoutine<java.lang.Void> {
	...
	private static final long serialVersionUID = 1202205105;

	/**
	 * The parameter <code>WETRN.APP_LNM_NOLA.ASSIGN_BI.P_RUN_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_RUN_ID = createParameter("P_RUN_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_NOLA.ASSIGN_BI.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_NOLA.ASSIGN_BI.P_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_NOLA.ASSIGN_BI.P_CONTINGENCY_IND</code>.
	 */
	 ...
	 */
	public AssignBi() {
		super("ASSIGN_BI", Wetrn.WETRN, AppLnmNola.APP_LNM_NOLA);
