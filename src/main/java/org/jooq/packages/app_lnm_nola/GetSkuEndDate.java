...
public class GetSkuEndDate extends AbstractRoutine<BigDecimal> {
	...
	private static final long serialVersionUID = 326020234;

	/**
	 * The parameter <code>WETRN.APP_LNM_NOLA.GET_SKU_END_DATE.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_NOLA.GET_SKU_END_DATE.P_SKU_ID</code>.
	 */
	...
	public GetSkuEndDate() {
		super("GET_SKU_END_DATE", Wetrn.WETRN, AppLnmNola.APP_LNM_NOLA, org.jooq.impl.SQLDataType.NUMERIC);
