...
public class ReassignLineNr extends AbstractRoutine<java.lang.Void> {
	...
	private static final long serialVersionUID = -1668243728;

	/**
	 * The parameter <code>WETRN.APP_LNM_NOLA.REASSIGN_LINE_NR.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_NOLA.REASSIGN_LINE_NR.P_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_NOLA.REASSIGN_LINE_NR.P_OFFR_SKU_LINE_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_NOLA.REASSIGN_LINE_NR.P_OFFR_SKU_SET_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_NOLA.REASSIGN_LINE_NR.P_LINE_NR</code>.
	 */
	...
	public ReassignLineNr() {
		super("REASSIGN_LINE_NR", Wetrn.WETRN, AppLnmNola.APP_LNM_NOLA);
