...
public class ReassignScrnSetHistory extends AbstractRoutine<Object> {

	private static final long serialVersionUID = 803420678;

	/**
	 * The parameter <code>WETRN.APP_LNM_NOLA.REASSIGN_SCRN_SET_HISTORY.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_NOLA.REASSIGN_SCRN_SET_HISTORY.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_NOLA.REASSIGN_SCRN_SET_HISTORY.P_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_NOLA.REASSIGN_SCRN_SET_HISTORY.P_OFFR_SKU_SET_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_NOLA.REASSIGN_SCRN_SET_HISTORY.P_LINE_NR_LIST</code>.
	 */
	 ...
	 */
	public ReassignScrnSetHistory() {
		super("REASSIGN_SCRN_SET_HISTORY", Wetrn.WETRN, AppLnmNola.APP_LNM_NOLA, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
