...
public class ReassignScrnItemDetails extends AbstractRoutine<Object> {

	private static final long serialVersionUID = 729148057;

	/**
	 * The parameter <code>WETRN.APP_LNM_NOLA.REASSIGN_SCRN_ITEM_DETAILS.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_NOLA.REASSIGN_SCRN_ITEM_DETAILS.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_NOLA.REASSIGN_SCRN_ITEM_DETAILS.P_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_NOLA.REASSIGN_SCRN_ITEM_DETAILS.P_SKU_ID</code>.
	 */
	 ...
	 */
	public ReassignScrnItemDetails() {
		super("REASSIGN_SCRN_ITEM_DETAILS", Wetrn.WETRN, AppLnmNola.APP_LNM_NOLA, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
