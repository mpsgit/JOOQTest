...
public class GetAssignableMiBiLineNrs extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = -2049551088;

	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BI_MI.GET_ASSIGNABLE_MI_BI_LINE_NRS.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BI_MI.GET_ASSIGNABLE_MI_BI_LINE_NRS.P_OFFR_SKU_LINE_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BI_MI.GET_ASSIGNABLE_MI_BI_LINE_NRS.P_LINE_NR_GRP_ID</code>.
	 */
	...
	public GetAssignableMiBiLineNrs() {
		super("GET_ASSIGNABLE_MI_BI_LINE_NRS", Wetrn.WETRN, AppLnmCenaReassignBiMi.APP_LNM_CENA_REASSIGN_BI_MI, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
