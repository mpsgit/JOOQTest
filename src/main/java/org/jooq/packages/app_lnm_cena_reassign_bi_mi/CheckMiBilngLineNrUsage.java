...
public class CheckMiBilngLineNrUsage extends AbstractRoutine<Object> {

	private static final long serialVersionUID = 1383556706;

	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BI_MI.CHECK_MI_BILNG_LINE_NR_USAGE.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BI_MI.CHECK_MI_BILNG_LINE_NR_USAGE.P_OFFR_SKU_LINE_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BI_MI.CHECK_MI_BILNG_LINE_NR_USAGE.P_LINE_NR</code>.
	 */
	public static final Parameter<String> P_LINE_NR = createParameter("P_LINE_NR", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BI_MI.CHECK_MI_BILNG_LINE_NR_USAGE.P_OFFR_PERD_ID</code>.
	 */
	 ...
	 */
	public CheckMiBilngLineNrUsage() {
		super("CHECK_MI_BILNG_LINE_NR_USAGE", Wetrn.WETRN, AppLnmCenaReassignBiMi.APP_LNM_CENA_REASSIGN_BI_MI, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
