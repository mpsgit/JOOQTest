...
public class GetAssignedMiBl extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = 29839920;

	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BI_MI.GET_ASSIGNED_MI_BL.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BI_MI.GET_ASSIGNED_MI_BL.P_OFFR_SKU_LINE_ID</code>.
	 */
	...
	public GetAssignedMiBl() {
		super("GET_ASSIGNED_MI_BL", Wetrn.WETRN, AppLnmCenaReassignBiMi.APP_LNM_CENA_REASSIGN_BI_MI, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
