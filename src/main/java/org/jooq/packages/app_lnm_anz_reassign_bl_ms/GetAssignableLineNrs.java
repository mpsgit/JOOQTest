...
public class GetAssignableLineNrs extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = -1462230223;

	/**
	 * The parameter <code>WETRN.APP_LNM_ANZ_REASSIGN_BL_MS.GET_ASSIGNABLE_LINE_NRS.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_ANZ_REASSIGN_BL_MS.GET_ASSIGNABLE_LINE_NRS.P_CLUSTER_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_ANZ_REASSIGN_BL_MS.GET_ASSIGNABLE_LINE_NRS.P_LEAD_MRKT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_ANZ_REASSIGN_BL_MS.GET_ASSIGNABLE_LINE_NRS.P_OFFR_SKU_SET_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_ANZ_REASSIGN_BL_MS.GET_ASSIGNABLE_LINE_NRS.P_LINE_NR_TYPE_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_ANZ_REASSIGN_BL_MS.GET_ASSIGNABLE_LINE_NRS.P_SELECTED_NUMBER</code>.
	 */
	public static final Parameter<String> P_SELECTED_NUMBER = createParameter("P_SELECTED_NUMBER", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * Create a new routine call instance
	 */
	public GetAssignableLineNrs() {
		super("GET_ASSIGNABLE_LINE_NRS", Wetrn.WETRN, AppLnmAnzReassignBlMs.APP_LNM_ANZ_REASSIGN_BL_MS, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
		...
		addInParameter(P_SELECTED_NUMBER);
	}
	...
	/**
	 * Set the <code>P_SELECTED_NUMBER</code> parameter IN value to the routine
	 */
	public void setPSelectedNumber(String value) {
		setValue(P_SELECTED_NUMBER, value);
	}

	/**
	 * Set the <code>P_SELECTED_NUMBER</code> parameter to the function to be used with a {@link org.jooq.Select} statement
	 */
	public void setPSelectedNumber(Field<String> field) {
		setField(P_SELECTED_NUMBER, field);
	}
}
