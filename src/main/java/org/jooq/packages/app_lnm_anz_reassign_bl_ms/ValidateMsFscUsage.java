...
public class ValidateMsFscUsage extends AbstractRoutine<Object> {

	private static final long serialVersionUID = -995574482;

	/**
	 * The parameter <code>WETRN.APP_LNM_ANZ_REASSIGN_BL_MS.VALIDATE_MS_FSC_USAGE.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_ANZ_REASSIGN_BL_MS.VALIDATE_MS_FSC_USAGE.P_LEAD_MRKT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_ANZ_REASSIGN_BL_MS.VALIDATE_MS_FSC_USAGE.P_OFFR_SKU_SET_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_ANZ_REASSIGN_BL_MS.VALIDATE_MS_FSC_USAGE.P_FSC</code>.
	 */
	 ...
	 */
	public ValidateMsFscUsage() {
		super("VALIDATE_MS_FSC_USAGE", Wetrn.WETRN, AppLnmAnzReassignBlMs.APP_LNM_ANZ_REASSIGN_BL_MS, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
