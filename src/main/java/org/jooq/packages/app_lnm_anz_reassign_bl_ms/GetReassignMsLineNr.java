...
public class GetReassignMsLineNr extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = 1448076902;

	/**
	 * The parameter <code>WETRN.APP_LNM_ANZ_REASSIGN_BL_MS.GET_REASSIGN_MS_LINE_NR.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_ANZ_REASSIGN_BL_MS.GET_REASSIGN_MS_LINE_NR.P_LEAD_MRKT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_ANZ_REASSIGN_BL_MS.GET_REASSIGN_MS_LINE_NR.P_FROM_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_ANZ_REASSIGN_BL_MS.GET_REASSIGN_MS_LINE_NR.P_TO_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_ANZ_REASSIGN_BL_MS.GET_REASSIGN_MS_LINE_NR.P_SET_LINE_NR</code>.
	 */
	...
	public GetReassignMsLineNr() {
		super("GET_REASSIGN_MS_LINE_NR", Wetrn.WETRN, AppLnmAnzReassignBlMs.APP_LNM_ANZ_REASSIGN_BL_MS, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
