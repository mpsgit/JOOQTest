...
public class GetAllMsReassign extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = 480412973;

	/**
	 * The parameter <code>WETRN.APP_LNM_ANZ_REASSIGN_BL_MS.GET_ALL_MS_REASSIGN.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_ANZ_REASSIGN_BL_MS.GET_ALL_MS_REASSIGN.P_LEAD_MRKT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_ANZ_REASSIGN_BL_MS.GET_ALL_MS_REASSIGN.P_FROM_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_ANZ_REASSIGN_BL_MS.GET_ALL_MS_REASSIGN.P_TO_OFFR_PERD_ID</code>.
	 */
	...
	public GetAllMsReassign() {
		super("GET_ALL_MS_REASSIGN", Wetrn.WETRN, AppLnmAnzReassignBlMs.APP_LNM_ANZ_REASSIGN_BL_MS, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
