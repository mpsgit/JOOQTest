...
public class ValidateMsFscExists extends AbstractRoutine<String> {

	private static final long serialVersionUID = -159856492;

	/**
	 * The parameter <code>WETRN.APP_LNM_ANZ_REASSIGN_BL_MS.VALIDATE_MS_FSC_EXISTS.RETURN_VALUE</code>.
	 */
	public static final Parameter<String> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_ANZ_REASSIGN_BL_MS.VALIDATE_MS_FSC_EXISTS.P_LEAD_MRKT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_ANZ_REASSIGN_BL_MS.VALIDATE_MS_FSC_EXISTS.P_FSC</code>.
	 */
	 ...
	 */
	public ValidateMsFscExists() {
		super("VALIDATE_MS_FSC_EXISTS", Wetrn.WETRN, AppLnmAnzReassignBlMs.APP_LNM_ANZ_REASSIGN_BL_MS, org.jooq.impl.SQLDataType.VARCHAR);
