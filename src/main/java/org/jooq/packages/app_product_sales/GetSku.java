...
public class GetSku extends AbstractRoutine<Object> {

	private static final long serialVersionUID = 705856067;

	/**
	 * The parameter <code>WETRN.APP_PRODUCT_SALES.GET_SKU.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_PRODUCT_SALES.GET_SKU.PMRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> PMRKT_ID = createParameter("PMRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_PRODUCT_SALES.GET_SKU.PPRFL_CD</code>.
	 */
	 ...
	 */
	public GetSku() {
		super("GET_SKU", Wetrn.WETRN, AppProductSales.APP_PRODUCT_SALES, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
