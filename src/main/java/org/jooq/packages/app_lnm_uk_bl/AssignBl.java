 ...
 */
package org.jooq.packages.app_lnm_uk_bl;
...
import org.jooq.packages.AppLnmUkBl;
...
public class AssignBl extends AbstractRoutine<java.lang.Void> {
	...
	private static final long serialVersionUID = -1992533105;

	/**
	 * The parameter <code>WETRN.APP_LNM_UK_BL.ASSIGN_BL.P_RUN_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_RUN_ID = createParameter("P_RUN_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_UK_BL.ASSIGN_BL.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_UK_BL.ASSIGN_BL.P_OFFR_PERD_ID</code>.
	 */
	 ...
	 */
	public AssignBl() {
		super("ASSIGN_BL", Wetrn.WETRN, AppLnmUkBl.APP_LNM_UK_BL);
