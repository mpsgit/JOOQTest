...
public class UnplanOffrCreation extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 440841182;

	/**
	 * The parameter <code>WETRN.SLS_ALOCTN.UNPLAN_OFFR_CREATION.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.SLS_ALOCTN.UNPLAN_OFFR_CREATION.P_SLS_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.SLS_ALOCTN.UNPLAN_OFFR_CREATION.P_STUS</code>.
	 */
	 ...
	 */
	public UnplanOffrCreation() {
		super("UNPLAN_OFFR_CREATION", Wetrn.WETRN, SlsAloctn.SLS_ALOCTN);
