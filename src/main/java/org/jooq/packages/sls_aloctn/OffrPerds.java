...
public class OffrPerds extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = -1962157698;

	/**
	 * The parameter <code>WETRN.SLS_ALOCTN.OFFR_PERDS.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.SLS_ALOCTN.OFFR_PERDS.P_SLS_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.SLS_ALOCTN.OFFR_PERDS.RESULT</code>.
	 */
	public static final Parameter<TblPerdIdRecord> RESULT = createParameter("RESULT", org.jooq.impl.SQLDataType.NUMERIC.asArrayDataType(org.jooq.udt.records.TblPerdIdRecord.class), false);

	/**
	 * Create a new routine call instance
	 */
	public OffrPerds() {
		super("OFFR_PERDS", Wetrn.WETRN, SlsAloctn.SLS_ALOCTN);
	 ...
	 */
	public TblPerdIdRecord getResult() {
