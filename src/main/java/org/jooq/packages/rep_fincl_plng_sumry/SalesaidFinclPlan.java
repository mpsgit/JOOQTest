...
public class SalesaidFinclPlan extends AbstractRoutine<Object> {

	private static final long serialVersionUID = -1301494968;

	/**
	 * The parameter <code>WETRN.REP_FINCL_PLNG_SUMRY.SALESAID_FINCL_PLAN.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_FINCL_PLNG_SUMRY.SALESAID_FINCL_PLAN.P_CURRENCY</code>.
	 */
	public static final Parameter<String> P_CURRENCY = createParameter("P_CURRENCY", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.REP_FINCL_PLNG_SUMRY.SALESAID_FINCL_PLAN.P_ACC_BY_IMP_CAT</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_FINCL_PLNG_SUMRY.SALESAID_FINCL_PLAN.P_INC_SUP_BUD</code>.
	 */
	public static final Parameter<String> P_INC_SUP_BUD = createParameter("P_INC_SUP_BUD", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.REP_FINCL_PLNG_SUMRY.SALESAID_FINCL_PLAN.P_SLS_AID</code>.
	 */
	public static final Parameter<String> P_SLS_AID = createParameter("P_SLS_AID", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.REP_FINCL_PLNG_SUMRY.SALESAID_FINCL_PLAN.P_CAMPAIGN_SLS</code>.
	 */
	 ...
	 */
	public SalesaidFinclPlan() {
		super("SALESAID_FINCL_PLAN", Wetrn.WETRN, RepFinclPlngSumry.REP_FINCL_PLNG_SUMRY, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
