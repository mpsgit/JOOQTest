...
public class OffrFinplanPriorRpt extends AbstractRoutine<Object> {

	private static final long serialVersionUID = -1281281466;

	/**
	 * The parameter <code>WETRN.REP_FINCL_PLNG_SUMRY.OFFR_FINPLAN_PRIOR_RPT.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_FINCL_PLNG_SUMRY.OFFR_FINPLAN_PRIOR_RPT.P_OFFR_VER_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_FINCL_PLNG_SUMRY.OFFR_FINPLAN_PRIOR_RPT.P_CURRENCY</code>.
	 */
	public static final Parameter<String> P_CURRENCY = createParameter("P_CURRENCY", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.REP_FINCL_PLNG_SUMRY.OFFR_FINPLAN_PRIOR_RPT.P_ACC_BY_IMP_CAT</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_FINCL_PLNG_SUMRY.OFFR_FINPLAN_PRIOR_RPT.P_INC_SUP_BUD</code>.
	 */
	public static final Parameter<String> P_INC_SUP_BUD = createParameter("P_INC_SUP_BUD", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.REP_FINCL_PLNG_SUMRY.OFFR_FINPLAN_PRIOR_RPT.P_SLS_AID</code>.
	 */
	public static final Parameter<String> P_SLS_AID = createParameter("P_SLS_AID", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.REP_FINCL_PLNG_SUMRY.OFFR_FINPLAN_PRIOR_RPT.P_CAMPAIGN_SLS</code>.
	 */
	 ...
	 */
	public OffrFinplanPriorRpt() {
		super("OFFR_FINPLAN_PRIOR_RPT", Wetrn.WETRN, RepFinclPlngSumry.REP_FINCL_PLNG_SUMRY, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
