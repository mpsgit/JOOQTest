...
public class OffrFinplanPriorRptTmp extends AbstractRoutine<Object> {

	private static final long serialVersionUID = -1765389184;

	/**
	 * The parameter <code>WETRN.REP_FINCL_PLNG_SUMRY.OFFR_FINPLAN_PRIOR_RPT_TMP.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_FINCL_PLNG_SUMRY.OFFR_FINPLAN_PRIOR_RPT_TMP.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.REP_FINCL_PLNG_SUMRY.OFFR_FINPLAN_PRIOR_RPT_TMP.P_PERD_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_PERD_ID = createParameter("P_PERD_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.REP_FINCL_PLNG_SUMRY.OFFR_FINPLAN_PRIOR_RPT_TMP.P_OBJCTV_ID</code>.
	 */
	public static final Parameter<String> P_OBJCTV_ID = createParameter("P_OBJCTV_ID", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.REP_FINCL_PLNG_SUMRY.OFFR_FINPLAN_PRIOR_RPT_TMP.P_FIN_VER_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_FINCL_PLNG_SUMRY.OFFR_FINPLAN_PRIOR_RPT_TMP.P_OFFR_VER_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_FINCL_PLNG_SUMRY.OFFR_FINPLAN_PRIOR_RPT_TMP.P_CURRENCY</code>.
	 */
	public static final Parameter<String> P_CURRENCY = createParameter("P_CURRENCY", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.REP_FINCL_PLNG_SUMRY.OFFR_FINPLAN_PRIOR_RPT_TMP.P_ACC_BY_IMP_CAT</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_FINCL_PLNG_SUMRY.OFFR_FINPLAN_PRIOR_RPT_TMP.P_INC_SUP_BUD</code>.
	 */
	public static final Parameter<String> P_INC_SUP_BUD = createParameter("P_INC_SUP_BUD", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.REP_FINCL_PLNG_SUMRY.OFFR_FINPLAN_PRIOR_RPT_TMP.P_SLS_AID</code>.
	 */
	public static final Parameter<String> P_SLS_AID = createParameter("P_SLS_AID", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.REP_FINCL_PLNG_SUMRY.OFFR_FINPLAN_PRIOR_RPT_TMP.P_CAMPAIGN_SLS</code>.
	 */
	 ...
	 */
	public OffrFinplanPriorRptTmp() {
		super("OFFR_FINPLAN_PRIOR_RPT_TMP", Wetrn.WETRN, RepFinclPlngSumry.REP_FINCL_PLNG_SUMRY, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
