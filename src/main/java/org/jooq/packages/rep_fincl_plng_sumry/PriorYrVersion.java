...
public class PriorYrVersion extends AbstractRoutine<Object> {

	private static final long serialVersionUID = 1495247334;

	/**
	 * The parameter <code>WETRN.REP_FINCL_PLNG_SUMRY.PRIOR_YR_VERSION.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_FINCL_PLNG_SUMRY.PRIOR_YR_VERSION.P_CURRENCY</code>.
	 */
	public static final Parameter<String> P_CURRENCY = createParameter("P_CURRENCY", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.REP_FINCL_PLNG_SUMRY.PRIOR_YR_VERSION.P_ACC_BY_IMP_CAT</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_FINCL_PLNG_SUMRY.PRIOR_YR_VERSION.P_INC_SUP_BUD</code>.
	 */
	public static final Parameter<String> P_INC_SUP_BUD = createParameter("P_INC_SUP_BUD", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.REP_FINCL_PLNG_SUMRY.PRIOR_YR_VERSION.P_SLS_AID</code>.
	 */
	public static final Parameter<String> P_SLS_AID = createParameter("P_SLS_AID", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.REP_FINCL_PLNG_SUMRY.PRIOR_YR_VERSION.P_CAMPAIGN_SLS</code>.
	 */
	 ...
	 */
	public PriorYrVersion() {
		super("PRIOR_YR_VERSION", Wetrn.WETRN, RepFinclPlngSumry.REP_FINCL_PLNG_SUMRY, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
