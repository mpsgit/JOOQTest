...
public class CalcPageWghtCncptLvl extends AbstractRoutine<Object> {

	private static final long serialVersionUID = -490152798;

	/**
	 * The parameter <code>WETRN.PA_MAPS_PAGE_WGHT.CALC_PAGE_WGHT_CNCPT_LVL.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_PAGE_WGHT.CALC_PAGE_WGHT_CNCPT_LVL.P_OFFR_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_OFFR_ID = createParameter("P_OFFR_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.PA_MAPS_PAGE_WGHT.CALC_PAGE_WGHT_CNCPT_LVL.P_USER_ID</code>.
	 */
	 ...
	 */
	public CalcPageWghtCncptLvl() {
		super("CALC_PAGE_WGHT_CNCPT_LVL", Wetrn.WETRN, PaMapsPageWght.PA_MAPS_PAGE_WGHT, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
