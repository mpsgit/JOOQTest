...
public class SetOffsetUnits extends AbstractRoutine<java.lang.Void> {
	...
	private static final long serialVersionUID = -1845972073;

	/**
	 * The parameter <code>WETRN.PA_MAPS_UNIT_IMPORT.SET_OFFSET_UNITS.POFFER_ID</code>.
	 */
	public static final Parameter<BigDecimal> POFFER_ID = createParameter("POFFER_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.PA_MAPS_UNIT_IMPORT.SET_OFFSET_UNITS.PSALES_TYPE_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_UNIT_IMPORT.SET_OFFSET_UNITS.PUSER_ID</code>.
	 */
	...
	public SetOffsetUnits() {
		super("SET_OFFSET_UNITS", Wetrn.WETRN, PaMapsUnitImport.PA_MAPS_UNIT_IMPORT);
