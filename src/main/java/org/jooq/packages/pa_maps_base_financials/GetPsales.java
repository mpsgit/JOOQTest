...
public class GetPsales extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = 1190531234;

	/**
	 * The parameter <code>WETRN.PA_MAPS_BASE_FINANCIALS.GET_PSALES.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_BASE_FINANCIALS.GET_PSALES.PSRCE_OF_SLS_ELMNT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_BASE_FINANCIALS.GET_PSALES.POBJCTV_ID</code>.
	 */
	 ...
	 */
	public GetPsales() {
		super("GET_PSALES", Wetrn.WETRN, PaMapsBaseFinancials.PA_MAPS_BASE_FINANCIALS, org.jooq.impl.SQLDataType.NUMERIC);
