...
public class GetBestVersion extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = -687888967;

	/**
	 * The parameter <code>WETRN.PA_MAPS_BASE_FINANCIALS.GET_BEST_VERSION.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_BASE_FINANCIALS.GET_BEST_VERSION.PMRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> PMRKT_ID = createParameter("PMRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.PA_MAPS_BASE_FINANCIALS.GET_BEST_VERSION.POFFR_PERD_ID</code>.
	 */
	 ...
	 */
	public GetBestVersion() {
		super("GET_BEST_VERSION", Wetrn.WETRN, PaMapsBaseFinancials.PA_MAPS_BASE_FINANCIALS, org.jooq.impl.SQLDataType.NUMERIC);
