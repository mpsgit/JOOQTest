...
public class GetPunits extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = -1341950959;

	/**
	 * The parameter <code>WETRN.PA_MAPS_BASE_FINANCIALS.GET_PUNITS.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_BASE_FINANCIALS.GET_PUNITS.PSRCE_OF_SLS_ELMNT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_BASE_FINANCIALS.GET_PUNITS.POBJCTV_ID</code>.
	 */
	 ...
	 */
	public GetPunits() {
		super("GET_PUNITS", Wetrn.WETRN, PaMapsBaseFinancials.PA_MAPS_BASE_FINANCIALS, org.jooq.impl.SQLDataType.NUMERIC);
