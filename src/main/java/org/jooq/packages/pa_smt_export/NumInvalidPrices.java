...
public class NumInvalidPrices extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = -1645038406;

	/**
	 * The parameter <code>WETRN.PA_SMT_EXPORT.NUM_INVALID_PRICES.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_SMT_EXPORT.NUM_INVALID_PRICES.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.PA_SMT_EXPORT.NUM_INVALID_PRICES.P_OFFR_PERD_ID</code>.
	 */
	 ...
	 */
	public NumInvalidPrices() {
		super("NUM_INVALID_PRICES", Wetrn.WETRN, PaSmtExport.PA_SMT_EXPORT, org.jooq.impl.SQLDataType.NUMERIC);
