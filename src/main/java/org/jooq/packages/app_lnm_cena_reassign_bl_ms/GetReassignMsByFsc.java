...
public class GetReassignMsByFsc extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = 1489291324;

	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BL_MS.GET_REASSIGN_MS_BY_FSC.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BL_MS.GET_REASSIGN_MS_BY_FSC.P_LEAD_MRKT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BL_MS.GET_REASSIGN_MS_BY_FSC.P_STRT_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BL_MS.GET_REASSIGN_MS_BY_FSC.P_END_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BL_MS.GET_REASSIGN_MS_BY_FSC.P_SET_FSC</code>.
	 */
	...
	public GetReassignMsByFsc() {
		super("GET_REASSIGN_MS_BY_FSC", Wetrn.WETRN, AppLnmCenaReassignBlMs.APP_LNM_CENA_REASSIGN_BL_MS, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
