...
public class GetReassignMsAll extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = -1326581047;

	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BL_MS.GET_REASSIGN_MS_ALL.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BL_MS.GET_REASSIGN_MS_ALL.P_LEAD_MRKT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BL_MS.GET_REASSIGN_MS_ALL.P_STRT_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BL_MS.GET_REASSIGN_MS_ALL.P_END_OFFR_PERD_ID</code>.
	 */
	...
	public GetReassignMsAll() {
		super("GET_REASSIGN_MS_ALL", Wetrn.WETRN, AppLnmCenaReassignBlMs.APP_LNM_CENA_REASSIGN_BL_MS, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
