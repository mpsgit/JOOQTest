...
public class GetAssignableMsFscs extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = -1106423250;

	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BL_MS.GET_ASSIGNABLE_MS_FSCS.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BL_MS.GET_ASSIGNABLE_MS_FSCS.P_OFFR_SKU_SET_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BL_MS.GET_ASSIGNABLE_MS_FSCS.P_SELECTED_FSCS</code>.
	 */
	...
	public GetAssignableMsFscs() {
		super("GET_ASSIGNABLE_MS_FSCS", Wetrn.WETRN, AppLnmCenaReassignBlMs.APP_LNM_CENA_REASSIGN_BL_MS, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
