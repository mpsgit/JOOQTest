...
public class ModifyMsLineNr extends AbstractRoutine<java.lang.Void> {
	...
	private static final long serialVersionUID = -1112501532;

	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BL_MS.MODIFY_MS_LINE_NR.P_OFFR_SKU_SET_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BL_MS.MODIFY_MS_LINE_NR.P_LINE_NR</code>.
	 */
	public static final Parameter<String> P_LINE_NR = createParameter("P_LINE_NR", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BL_MS.MODIFY_MS_LINE_NR.P_USER_ID</code>.
	 */
	...
	public ModifyMsLineNr() {
		super("MODIFY_MS_LINE_NR", Wetrn.WETRN, AppLnmCenaReassignBlMs.APP_LNM_CENA_REASSIGN_BL_MS);
