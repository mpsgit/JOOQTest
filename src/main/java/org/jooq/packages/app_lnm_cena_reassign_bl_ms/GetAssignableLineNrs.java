...
public class GetAssignableLineNrs extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = 1789093004;

	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BL_MS.GET_ASSIGNABLE_LINE_NRS.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BL_MS.GET_ASSIGNABLE_LINE_NRS.P_OFFR_SKU_SET_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BL_MS.GET_ASSIGNABLE_LINE_NRS.P_SELECTED_NUMBERS</code>.
	 */
	public static final Parameter<String> P_SELECTED_NUMBERS = createParameter("P_SELECTED_NUMBERS", org.jooq.impl.SQLDataType.VARCHAR.length(32767), false);

	/**
	 * Create a new routine call instance
	 */
	public GetAssignableLineNrs() {
		super("GET_ASSIGNABLE_LINE_NRS", Wetrn.WETRN, AppLnmCenaReassignBlMs.APP_LNM_CENA_REASSIGN_BL_MS, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
