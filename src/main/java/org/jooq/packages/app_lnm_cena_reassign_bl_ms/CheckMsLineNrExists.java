...
public class CheckMsLineNrExists extends AbstractRoutine<String> {

	private static final long serialVersionUID = 969184338;

	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BL_MS.CHECK_MS_LINE_NR_EXISTS.RETURN_VALUE</code>.
	 */
	public static final Parameter<String> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BL_MS.CHECK_MS_LINE_NR_EXISTS.P_LEAD_MRKT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BL_MS.CHECK_MS_LINE_NR_EXISTS.P_LINE_NR</code>.
	 */
	 ...
	 */
	public CheckMsLineNrExists() {
		super("CHECK_MS_LINE_NR_EXISTS", Wetrn.WETRN, AppLnmCenaReassignBlMs.APP_LNM_CENA_REASSIGN_BL_MS, org.jooq.impl.SQLDataType.VARCHAR);
