...
public class GetAssignableLineNrs extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = -1761532741;

	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_REASSIGN_BL_MI.GET_ASSIGNABLE_LINE_NRS.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_REASSIGN_BL_MI.GET_ASSIGNABLE_LINE_NRS.P_CLUSTER_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_REASSIGN_BL_MI.GET_ASSIGNABLE_LINE_NRS.P_LEAD_MRKT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_REASSIGN_BL_MI.GET_ASSIGNABLE_LINE_NRS.P_OFFR_SKU_LINE_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_REASSIGN_BL_MI.GET_ASSIGNABLE_LINE_NRS.P_LINE_NR_TYPE_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_REASSIGN_BL_MI.GET_ASSIGNABLE_LINE_NRS.P_LEAD_BUS_DIV_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_REASSIGN_BL_MI.GET_ASSIGNABLE_LINE_NRS.P_BUS_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_BUS_ID = createParameter("P_BUS_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_REASSIGN_BL_MI.GET_ASSIGNABLE_LINE_NRS.P_CATGRY_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_CATGRY_ID = createParameter("P_CATGRY_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_REASSIGN_BL_MI.GET_ASSIGNABLE_LINE_NRS.P_SGMT_ID</code>.
	 */
	...
	public GetAssignableLineNrs() {
		super("GET_ASSIGNABLE_LINE_NRS", Wetrn.WETRN, AppLnmSeaReassignBlMi.APP_LNM_SEA_REASSIGN_BL_MI, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
