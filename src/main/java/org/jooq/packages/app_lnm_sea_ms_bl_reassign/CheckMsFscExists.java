...
public class CheckMsFscExists extends AbstractRoutine<String> {
	...
	private static final long serialVersionUID = 820356870;

	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN.CHECK_MS_FSC_EXISTS.RETURN_VALUE</code>.
	 */
	public static final Parameter<String> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN.CHECK_MS_FSC_EXISTS.P_LEAD_MRKT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN.CHECK_MS_FSC_EXISTS.P_FSC</code>.
	 */
	...
	public CheckMsFscExists() {
		super("CHECK_MS_FSC_EXISTS", Wetrn.WETRN, AppLnmSeaMsBlReassign.APP_LNM_SEA_MS_BL_REASSIGN, org.jooq.impl.SQLDataType.VARCHAR);
