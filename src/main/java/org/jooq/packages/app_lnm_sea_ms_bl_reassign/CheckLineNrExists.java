...
public class CheckLineNrExists extends AbstractRoutine<String> {
	...
	private static final long serialVersionUID = -1216166895;

	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN.CHECK_LINE_NR_EXISTS.RETURN_VALUE</code>.
	 */
	public static final Parameter<String> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN.CHECK_LINE_NR_EXISTS.P_LEAD_MRKT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN.CHECK_LINE_NR_EXISTS.P_LINE_NR</code>.
	 */
	public static final Parameter<String> P_LINE_NR = createParameter("P_LINE_NR", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN.CHECK_LINE_NR_EXISTS.P_LINE_NR_TYP_ID</code>.
	 */
	...
	public CheckLineNrExists() {
		super("CHECK_LINE_NR_EXISTS", Wetrn.WETRN, AppLnmSeaMsBlReassign.APP_LNM_SEA_MS_BL_REASSIGN, org.jooq.impl.SQLDataType.VARCHAR);
