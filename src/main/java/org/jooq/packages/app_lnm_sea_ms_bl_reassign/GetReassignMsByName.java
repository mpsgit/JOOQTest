...
public class GetReassignMsByName extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = -1808735552;

	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN.GET_REASSIGN_MS_BY_NAME.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN.GET_REASSIGN_MS_BY_NAME.P_LEAD_MRKT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN.GET_REASSIGN_MS_BY_NAME.P_STRT_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN.GET_REASSIGN_MS_BY_NAME.P_END_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN.GET_REASSIGN_MS_BY_NAME.P_SET_NAME</code>.
	 */
	...
	public GetReassignMsByName() {
		super("GET_REASSIGN_MS_BY_NAME", Wetrn.WETRN, AppLnmSeaMsBlReassign.APP_LNM_SEA_MS_BL_REASSIGN, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
