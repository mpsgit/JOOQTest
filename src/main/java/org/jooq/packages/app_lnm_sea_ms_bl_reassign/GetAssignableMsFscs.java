...
public class GetAssignableMsFscs extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = 1997272354;

	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN.GET_ASSIGNABLE_MS_FSCS.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN.GET_ASSIGNABLE_MS_FSCS.P_OFFR_SKU_SET_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN.GET_ASSIGNABLE_MS_FSCS.P_SELECTED_FSCS</code>.
	 */
	...
	public GetAssignableMsFscs() {
		super("GET_ASSIGNABLE_MS_FSCS", Wetrn.WETRN, AppLnmSeaMsBlReassign.APP_LNM_SEA_MS_BL_REASSIGN, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
