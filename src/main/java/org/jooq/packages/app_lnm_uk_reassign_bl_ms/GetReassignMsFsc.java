...
public class GetReassignMsFsc extends AbstractRoutine<Object> {

	private static final long serialVersionUID = -1532008211;

	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BL_MS.GET_REASSIGN_MS_FSC.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BL_MS.GET_REASSIGN_MS_FSC.P_CLUSTER_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BL_MS.GET_REASSIGN_MS_FSC.P_LEAD_MRKT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BL_MS.GET_REASSIGN_MS_FSC.P_FROM_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BL_MS.GET_REASSIGN_MS_FSC.P_TO_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BL_MS.GET_REASSIGN_MS_FSC.P_SET_FSC</code>.
	 */
	 ...
	 */
	public GetReassignMsFsc() {
		super("GET_REASSIGN_MS_FSC", Wetrn.WETRN, AppLnmUkReassignBlMs.APP_LNM_UK_REASSIGN_BL_MS, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
