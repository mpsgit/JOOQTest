...
public class GetReassignMsName extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = 498205004;

	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BL_MS.GET_REASSIGN_MS_NAME.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BL_MS.GET_REASSIGN_MS_NAME.P_CLUSTER_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BL_MS.GET_REASSIGN_MS_NAME.P_LEAD_MRKT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BL_MS.GET_REASSIGN_MS_NAME.P_FROM_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BL_MS.GET_REASSIGN_MS_NAME.P_TO_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BL_MS.GET_REASSIGN_MS_NAME.P_SET_NAME</code>.
	 */
	...
	public GetReassignMsName() {
		super("GET_REASSIGN_MS_NAME", Wetrn.WETRN, AppLnmUkReassignBlMs.APP_LNM_UK_REASSIGN_BL_MS, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
