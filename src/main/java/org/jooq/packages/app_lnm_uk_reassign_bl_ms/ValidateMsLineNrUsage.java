...
public class ValidateMsLineNrUsage extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = 1809523191;

	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BL_MS.VALIDATE_MS_LINE_NR_USAGE.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BL_MS.VALIDATE_MS_LINE_NR_USAGE.P_CLUSTER_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BL_MS.VALIDATE_MS_LINE_NR_USAGE.P_LEAD_MRKT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BL_MS.VALIDATE_MS_LINE_NR_USAGE.P_OFFR_SKU_SET_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BL_MS.VALIDATE_MS_LINE_NR_USAGE.P_LINE_NR</code>.
	 */
	...
	public ValidateMsLineNrUsage() {
		super("VALIDATE_MS_LINE_NR_USAGE", Wetrn.WETRN, AppLnmUkReassignBlMs.APP_LNM_UK_REASSIGN_BL_MS, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
