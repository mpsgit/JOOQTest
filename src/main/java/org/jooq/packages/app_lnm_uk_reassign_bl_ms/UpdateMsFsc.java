...
public class UpdateMsFsc extends AbstractRoutine<java.lang.Void> {
	...
	private static final long serialVersionUID = -7076995;

	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BL_MS.UPDATE_MS_FSC.P_CLUSTER_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BL_MS.UPDATE_MS_FSC.P_LEAD_MRKT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BL_MS.UPDATE_MS_FSC.P_OFFR_SKU_SET_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BL_MS.UPDATE_MS_FSC.P_FSC</code>.
	 */
	public static final Parameter<String> P_FSC = createParameter("P_FSC", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BL_MS.UPDATE_MS_FSC.P_USER_ID</code>.
	 */
	 ...
	 */
	public UpdateMsFsc() {
		super("UPDATE_MS_FSC", Wetrn.WETRN, AppLnmUkReassignBlMs.APP_LNM_UK_REASSIGN_BL_MS);
