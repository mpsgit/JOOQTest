...
public class ValidateMsLineNrExists extends AbstractRoutine<String> {
	...
	private static final long serialVersionUID = 225511167;

	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BL_MS.VALIDATE_MS_LINE_NR_EXISTS.RETURN_VALUE</code>.
	 */
	public static final Parameter<String> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BL_MS.VALIDATE_MS_LINE_NR_EXISTS.P_CLUSTER_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BL_MS.VALIDATE_MS_LINE_NR_EXISTS.P_LEAD_MRKT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BL_MS.VALIDATE_MS_LINE_NR_EXISTS.P_LINE_NR</code>.
	 */
	public static final Parameter<String> P_LINE_NR = createParameter("P_LINE_NR", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BL_MS.VALIDATE_MS_LINE_NR_EXISTS.P_LINE_NR_TYP_ID</code>.
	 */
	...
	public ValidateMsLineNrExists() {
		super("VALIDATE_MS_LINE_NR_EXISTS", Wetrn.WETRN, AppLnmUkReassignBlMs.APP_LNM_UK_REASSIGN_BL_MS, org.jooq.impl.SQLDataType.VARCHAR);
