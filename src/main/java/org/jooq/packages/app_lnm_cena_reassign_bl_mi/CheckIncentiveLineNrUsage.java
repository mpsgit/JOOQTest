...
public class CheckIncentiveLineNrUsage extends AbstractRoutine<String> {

	private static final long serialVersionUID = -552547314;

	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BL_MI.CHECK_INCENTIVE_LINE_NR_USAGE.RETURN_VALUE</code>.
	 */
	public static final Parameter<String> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BL_MI.CHECK_INCENTIVE_LINE_NR_USAGE.P_CLUSTER_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BL_MI.CHECK_INCENTIVE_LINE_NR_USAGE.P_LEAD_MRKT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BL_MI.CHECK_INCENTIVE_LINE_NR_USAGE.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BL_MI.CHECK_INCENTIVE_LINE_NR_USAGE.P_OFFR_SKU_LINE_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BL_MI.CHECK_INCENTIVE_LINE_NR_USAGE.P_LINE_NR</code>.
	 */
	public static final Parameter<String> P_LINE_NR = createParameter("P_LINE_NR", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BL_MI.CHECK_INCENTIVE_LINE_NR_USAGE.P_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BL_MI.CHECK_INCENTIVE_LINE_NR_USAGE.P_ITEM_TYP_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_ITEM_TYP_ID = createParameter("P_ITEM_TYP_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * Create a new routine call instance
	 */
	public CheckIncentiveLineNrUsage() {
		super("CHECK_INCENTIVE_LINE_NR_USAGE", Wetrn.WETRN, AppLnmCenaReassignBlMi.APP_LNM_CENA_REASSIGN_BL_MI, org.jooq.impl.SQLDataType.VARCHAR);
	...
	/**
	 * Set the <code>P_ITEM_TYP_ID</code> parameter IN value to the routine
	 */
	public void setPItemTypId(Number value) {
		setNumber(P_ITEM_TYP_ID, value);
	}

	/**
	 * Set the <code>P_ITEM_TYP_ID</code> parameter to the function to be used with a {@link org.jooq.Select} statement
	 */
	public void setPItemTypId(Field<? extends Number> field) {
		setNumber(P_ITEM_TYP_ID, field);
	}
}
