...
public class GetAssignableLineNrs extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = -740863516;

	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BL_MI.GET_ASSIGNABLE_LINE_NRS.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BL_MI.GET_ASSIGNABLE_LINE_NRS.P_OFFR_SKU_LINE_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BL_MI.GET_ASSIGNABLE_LINE_NRS.P_LINE_NR_TYP_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BL_MI.GET_ASSIGNABLE_LINE_NRS.P_LEAD_BUS_DIV_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BL_MI.GET_ASSIGNABLE_LINE_NRS.P_BUS_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_BUS_ID = createParameter("P_BUS_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BL_MI.GET_ASSIGNABLE_LINE_NRS.P_CATGRY_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_CATGRY_ID = createParameter("P_CATGRY_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BL_MI.GET_ASSIGNABLE_LINE_NRS.P_SGMT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_SGMT_ID = createParameter("P_SGMT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BL_MI.GET_ASSIGNABLE_LINE_NRS.P_PROD_TYP_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BL_MI.GET_ASSIGNABLE_LINE_NRS.P_FORM_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_FORM_ID = createParameter("P_FORM_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BL_MI.GET_ASSIGNABLE_LINE_NRS.P_ITEM_TYPE</code>.
	 */
	public static final Parameter<BigDecimal> P_ITEM_TYPE = createParameter("P_ITEM_TYPE", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * Create a new routine call instance
	 */
	public GetAssignableLineNrs() {
		super("GET_ASSIGNABLE_LINE_NRS", Wetrn.WETRN, AppLnmCenaReassignBlMi.APP_LNM_CENA_REASSIGN_BL_MI, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
	...
	/**
	 * Set the <code>P_ITEM_TYPE</code> parameter IN value to the routine
	 */
	public void setPItemType(Number value) {
		setNumber(P_ITEM_TYPE, value);
	}

	/**
	 * Set the <code>P_ITEM_TYPE</code> parameter to the function to be used with a {@link org.jooq.Select} statement
	 */
	public void setPItemType(Field<? extends Number> field) {
		setNumber(P_ITEM_TYPE, field);
	}
}
