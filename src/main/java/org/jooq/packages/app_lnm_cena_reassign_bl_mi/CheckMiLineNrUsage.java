...
public class CheckMiLineNrUsage extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = -951064781;

	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BL_MI.CHECK_MI_LINE_NR_USAGE.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BL_MI.CHECK_MI_LINE_NR_USAGE.P_OFFR_SKU_LINE_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BL_MI.CHECK_MI_LINE_NR_USAGE.P_LINE_NR</code>.
	 */
	public static final Parameter<String> P_LINE_NR = createParameter("P_LINE_NR", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_BL_MI.CHECK_MI_LINE_NR_USAGE.P_OFFR_PERD_ID</code>.
	 */
	...
	public CheckMiLineNrUsage() {
		super("CHECK_MI_LINE_NR_USAGE", Wetrn.WETRN, AppLnmCenaReassignBlMi.APP_LNM_CENA_REASSIGN_BL_MI, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
