...
public class GetBilngLineNrUsage extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = 1198308253;

	/**
	 * The parameter <code>WETRN.APP_LNM_MCA_REPORTS.GET_BILNG_LINE_NR_USAGE.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_MCA_REPORTS.GET_BILNG_LINE_NR_USAGE.P_CLSTR_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_CLSTR_ID = createParameter("P_CLSTR_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_MCA_REPORTS.GET_BILNG_LINE_NR_USAGE.P_LEAD_MRKT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_MCA_REPORTS.GET_BILNG_LINE_NR_USAGE.P_LINE_NR</code>.
	 */
	public static final Parameter<String> P_LINE_NR = createParameter("P_LINE_NR", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_MCA_REPORTS.GET_BILNG_LINE_NR_USAGE.P_MIN_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_MCA_REPORTS.GET_BILNG_LINE_NR_USAGE.P_MAX_OFFR_PERD_ID</code>.
	 */
	...
	public GetBilngLineNrUsage() {
		super("GET_BILNG_LINE_NR_USAGE", Wetrn.WETRN, AppLnmMcaReports.APP_LNM_MCA_REPORTS, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
