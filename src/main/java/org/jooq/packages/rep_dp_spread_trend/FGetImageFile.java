...
public class FGetImageFile extends AbstractRoutine<String> {
	...
	private static final long serialVersionUID = -824913581;

	/**
	 * The parameter <code>WETRN.REP_DP_SPREAD_TREND.F_GET_IMAGE_FILE.RETURN_VALUE</code>.
	 */
	public static final Parameter<String> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.REP_DP_SPREAD_TREND.F_GET_IMAGE_FILE.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.REP_DP_SPREAD_TREND.F_GET_IMAGE_FILE.P_VEH_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_VEH_ID = createParameter("P_VEH_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.REP_DP_SPREAD_TREND.F_GET_IMAGE_FILE.P_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_DP_SPREAD_TREND.F_GET_IMAGE_FILE.P_STRTG_PG_NR</code>.
	 */
	...
	public FGetImageFile() {
		super("F_GET_IMAGE_FILE", Wetrn.WETRN, RepDpSpreadTrend.REP_DP_SPREAD_TREND, org.jooq.impl.SQLDataType.VARCHAR);
