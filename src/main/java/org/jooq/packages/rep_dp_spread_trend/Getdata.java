...
public class Getdata extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = -137933092;

	/**
	 * The parameter <code>WETRN.REP_DP_SPREAD_TREND.GETDATA.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_DP_SPREAD_TREND.GETDATA.P_BRCHR_PLCMT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_DP_SPREAD_TREND.GETDATA.P_OFFSET_MAX</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_DP_SPREAD_TREND.GETDATA.P_CURRENCY</code>.
	 */
	 ...
	 */
	public Getdata() {
		super("GETDATA", Wetrn.WETRN, RepDpSpreadTrend.REP_DP_SPREAD_TREND, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
