...
public class GetBimultimarketReport extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = -783318540;

	/**
	 * The parameter <code>WETRN.APP_LNM_ANZ_REPORTS.GET_BIMULTIMARKET_REPORT.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_ANZ_REPORTS.GET_BIMULTIMARKET_REPORT.P_MRKT_ID_LIST</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_ANZ_REPORTS.GET_BIMULTIMARKET_REPORT.P_START_PERIOD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_ANZ_REPORTS.GET_BIMULTIMARKET_REPORT.P_END_PERIOD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_ANZ_REPORTS.GET_BIMULTIMARKET_REPORT.P_VEH_ID_LIST</code>.
	 */
	...
	public GetBimultimarketReport() {
		super("GET_BIMULTIMARKET_REPORT", Wetrn.WETRN, AppLnmAnzReports.APP_LNM_ANZ_REPORTS, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
