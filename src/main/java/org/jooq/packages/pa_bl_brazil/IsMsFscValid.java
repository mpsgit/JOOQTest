...
public class IsMsFscValid extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = -400501010;

	/**
	 * The parameter <code>WETRN.PA_BL_BRAZIL.IS_MS_FSC_VALID.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_BL_BRAZIL.IS_MS_FSC_VALID.PAR_OFFR_SKU_SET_ID</code>.
	 */
	 ...
	 */
	public IsMsFscValid() {
		super("IS_MS_FSC_VALID", Wetrn.WETRN, PaBlBrazil.PA_BL_BRAZIL, org.jooq.impl.SQLDataType.NUMERIC);
