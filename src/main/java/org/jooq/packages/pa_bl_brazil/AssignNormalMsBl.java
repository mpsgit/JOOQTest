...
public class AssignNormalMsBl extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 641621866;

	/**
	 * The parameter <code>WETRN.PA_BL_BRAZIL.ASSIGN_NORMAL_MS_BL.PAR_RUN_ID</code>.
	 */
	public static final Parameter<BigDecimal> PAR_RUN_ID = createParameter("PAR_RUN_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.PA_BL_BRAZIL.ASSIGN_NORMAL_MS_BL.PAR_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> PAR_MRKT_ID = createParameter("PAR_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.PA_BL_BRAZIL.ASSIGN_NORMAL_MS_BL.PAR_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_BL_BRAZIL.ASSIGN_NORMAL_MS_BL.PAR_VEH_ID_LIST</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_BL_BRAZIL.ASSIGN_NORMAL_MS_BL.PAR_VER_ID</code>.
	 */
	public static final Parameter<BigDecimal> PAR_VER_ID = createParameter("PAR_VER_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.PA_BL_BRAZIL.ASSIGN_NORMAL_MS_BL.PAR_USER_ID</code>.
	 */
	 ...
	 */
	public AssignNormalMsBl() {
		super("ASSIGN_NORMAL_MS_BL", Wetrn.WETRN, PaBlBrazil.PA_BL_BRAZIL);
