...
public class UpdateMsBln extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 1505468206;

	/**
	 * The parameter <code>WETRN.PA_BL_BRAZIL.UPDATE_MS_BLN.PAR_OFFR_SKU_SET_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_BL_BRAZIL.UPDATE_MS_BLN.PAR_LINE_NR</code>.
	 */
	public static final Parameter<String> PAR_LINE_NR = createParameter("PAR_LINE_NR", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.PA_BL_BRAZIL.UPDATE_MS_BLN.PAR_LINE_NR_TYP_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_BL_BRAZIL.UPDATE_MS_BLN.PAR_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_BL_BRAZIL.UPDATE_MS_BLN.PAR_USER_ID</code>.
	 */
	public static final Parameter<String> PAR_USER_ID = createParameter("PAR_USER_ID", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.PA_BL_BRAZIL.UPDATE_MS_BLN.PAR_LINE_NR_ASGNMT_TYP_ID</code>.
	 */
	 ...
	 */
	public UpdateMsBln() {
		super("UPDATE_MS_BLN", Wetrn.WETRN, PaBlBrazil.PA_BL_BRAZIL);
