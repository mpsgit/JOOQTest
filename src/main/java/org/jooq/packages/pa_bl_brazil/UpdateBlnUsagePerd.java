...
public class UpdateBlnUsagePerd extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 625668430;

	/**
	 * The parameter <code>WETRN.PA_BL_BRAZIL.UPDATE_BLN_USAGE_PERD.PAR_LINE_NR</code>.
	 */
	public static final Parameter<String> PAR_LINE_NR = createParameter("PAR_LINE_NR", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.PA_BL_BRAZIL.UPDATE_BLN_USAGE_PERD.PAR_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_BL_BRAZIL.UPDATE_BLN_USAGE_PERD.PAR_USER_ID</code>.
	 */
	 ...
	 */
	public UpdateBlnUsagePerd() {
		super("UPDATE_BLN_USAGE_PERD", Wetrn.WETRN, PaBlBrazil.PA_BL_BRAZIL);
