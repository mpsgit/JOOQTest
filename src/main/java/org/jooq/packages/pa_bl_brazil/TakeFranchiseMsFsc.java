...
public class TakeFranchiseMsFsc extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = -2012773282;

	/**
	 * The parameter <code>WETRN.PA_BL_BRAZIL.TAKE_FRANCHISE_MS_FSC.PAR_RUN_ID</code>.
	 */
	public static final Parameter<BigDecimal> PAR_RUN_ID = createParameter("PAR_RUN_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.PA_BL_BRAZIL.TAKE_FRANCHISE_MS_FSC.PAR_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> PAR_MRKT_ID = createParameter("PAR_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.PA_BL_BRAZIL.TAKE_FRANCHISE_MS_FSC.PAR_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_BL_BRAZIL.TAKE_FRANCHISE_MS_FSC.PAR_VEH_ID_LIST</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_BL_BRAZIL.TAKE_FRANCHISE_MS_FSC.PAR_VER_ID</code>.
	 */
	public static final Parameter<BigDecimal> PAR_VER_ID = createParameter("PAR_VER_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.PA_BL_BRAZIL.TAKE_FRANCHISE_MS_FSC.PAR_USER_ID</code>.
	 */
	 ...
	 */
	public TakeFranchiseMsFsc() {
		super("TAKE_FRANCHISE_MS_FSC", Wetrn.WETRN, PaBlBrazil.PA_BL_BRAZIL);
