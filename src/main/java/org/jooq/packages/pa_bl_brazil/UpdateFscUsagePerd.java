...
public class UpdateFscUsagePerd extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 1527979168;

	/**
	 * The parameter <code>WETRN.PA_BL_BRAZIL.UPDATE_FSC_USAGE_PERD.PAR_FSC_CD</code>.
	 */
	public static final Parameter<String> PAR_FSC_CD = createParameter("PAR_FSC_CD", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.PA_BL_BRAZIL.UPDATE_FSC_USAGE_PERD.PAR_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> PAR_MRKT_ID = createParameter("PAR_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.PA_BL_BRAZIL.UPDATE_FSC_USAGE_PERD.PAR_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_BL_BRAZIL.UPDATE_FSC_USAGE_PERD.PAR_USER_ID</code>.
	 */
	 ...
	 */
	public UpdateFscUsagePerd() {
		super("UPDATE_FSC_USAGE_PERD", Wetrn.WETRN, PaBlBrazil.PA_BL_BRAZIL);
