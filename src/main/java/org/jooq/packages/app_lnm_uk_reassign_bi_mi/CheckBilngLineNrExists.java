...
public class CheckBilngLineNrExists extends AbstractRoutine<String> {
	...
	private static final long serialVersionUID = -1312196956;

	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BI_MI.CHECK_BILNG_LINE_NR_EXISTS.RETURN_VALUE</code>.
	 */
	public static final Parameter<String> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BI_MI.CHECK_BILNG_LINE_NR_EXISTS.P_BILNG_SYS_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BI_MI.CHECK_BILNG_LINE_NR_EXISTS.P_LEAD_MRKT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BI_MI.CHECK_BILNG_LINE_NR_EXISTS.P_LINE_NR</code>.
	 */
	public static final Parameter<String> P_LINE_NR = createParameter("P_LINE_NR", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BI_MI.CHECK_BILNG_LINE_NR_EXISTS.P_LINE_NR_GRP_ID</code>.
	 */
	...
	public CheckBilngLineNrExists() {
		super("CHECK_BILNG_LINE_NR_EXISTS", Wetrn.WETRN, AppLnmUkReassignBiMi.APP_LNM_UK_REASSIGN_BI_MI, org.jooq.impl.SQLDataType.VARCHAR);
