...
public class GetAssignedMiBl extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = -1642561550;

	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BI_MI.GET_ASSIGNED_MI_BL.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BI_MI.GET_ASSIGNED_MI_BL.P_OFFR_SKU_LINE_ID</code>.
	 */
	...
	public GetAssignedMiBl() {
		super("GET_ASSIGNED_MI_BL", Wetrn.WETRN, AppLnmUkReassignBiMi.APP_LNM_UK_REASSIGN_BI_MI, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
