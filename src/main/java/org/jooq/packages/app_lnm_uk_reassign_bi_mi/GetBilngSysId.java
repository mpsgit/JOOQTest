...
public class GetBilngSysId extends AbstractRoutine<BigDecimal> {
	...
	private static final long serialVersionUID = 2047198887;

	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BI_MI.GET_BILNG_SYS_ID.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BI_MI.GET_BILNG_SYS_ID.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BI_MI.GET_BILNG_SYS_ID.P_OFFR_PERD_ID</code>.
	 */
	...
	public GetBilngSysId() {
		super("GET_BILNG_SYS_ID", Wetrn.WETRN, AppLnmUkReassignBiMi.APP_LNM_UK_REASSIGN_BI_MI, org.jooq.impl.SQLDataType.NUMERIC);
