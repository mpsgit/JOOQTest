...
public class FGetUpdtCategoryTobeData extends AbstractRoutine<Object> {

	private static final long serialVersionUID = -1963976793;

	/**
	 * The parameter <code>WETRN.APP_GLOBAL_UNIT_ADJUSTMENT.F_GET_UPDT_CATEGORY_TOBE_DATA.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_GLOBAL_UNIT_ADJUSTMENT.F_GET_UPDT_CATEGORY_TOBE_DATA.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_GLOBAL_UNIT_ADJUSTMENT.F_GET_UPDT_CATEGORY_TOBE_DATA.P_CATEGORY_IDS</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_GLOBAL_UNIT_ADJUSTMENT.F_GET_UPDT_CATEGORY_TOBE_DATA.P_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_GLOBAL_UNIT_ADJUSTMENT.F_GET_UPDT_CATEGORY_TOBE_DATA.P_SALES_TYPE_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_GLOBAL_UNIT_ADJUSTMENT.F_GET_UPDT_CATEGORY_TOBE_DATA.P_OFF_SCHEDULE_FLAG</code>.
	 */
	public static final Parameter<String> P_OFF_SCHEDULE_FLAG = createParameter("P_OFF_SCHEDULE_FLAG", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_GLOBAL_UNIT_ADJUSTMENT.F_GET_UPDT_CATEGORY_TOBE_DATA.P_SUPPORT_BUDGET</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_GLOBAL_UNIT_ADJUSTMENT.F_GET_UPDT_CATEGORY_TOBE_DATA.P_SALES_AIDS</code>.
	 */
	public static final Parameter<String> P_SALES_AIDS = createParameter("P_SALES_AIDS", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_GLOBAL_UNIT_ADJUSTMENT.F_GET_UPDT_CATEGORY_TOBE_DATA.P_IMPACT_CATEGORY</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_GLOBAL_UNIT_ADJUSTMENT.F_GET_UPDT_CATEGORY_TOBE_DATA.P_VEHICLE_IDS</code>.
	 */
	 ...
	 */
	public FGetUpdtCategoryTobeData() {
		super("F_GET_UPDT_CATEGORY_TOBE_DATA", Wetrn.WETRN, AppGlobalUnitAdjustment.APP_GLOBAL_UNIT_ADJUSTMENT, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
		...
		addInParameter(P_OFF_SCHEDULE_FLAG);
	...
	/**
	 * Set the <code>P_OFF_SCHEDULE_FLAG</code> parameter IN value to the routine
	 */
	public void setPOffScheduleFlag(String value) {
		setValue(P_OFF_SCHEDULE_FLAG, value);
	}

	/**
	 * Set the <code>P_OFF_SCHEDULE_FLAG</code> parameter to the function to be used with a {@link org.jooq.Select} statement
	 */
	public void setPOffScheduleFlag(Field<String> field) {
		setField(P_OFF_SCHEDULE_FLAG, field);
	}
