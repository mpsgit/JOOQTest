...
public class FGetTobeResultTmp extends AbstractRoutine<Object> {

	private static final long serialVersionUID = -1530197570;

	/**
	 * The parameter <code>WETRN.APP_GLOBAL_UNIT_ADJUSTMENT.F_GET_TOBE_RESULT_TMP.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_GLOBAL_UNIT_ADJUSTMENT.F_GET_TOBE_RESULT_TMP.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_GLOBAL_UNIT_ADJUSTMENT.F_GET_TOBE_RESULT_TMP.P_VEHICLE_IDS</code>.
	 */
	public static final Parameter<String> P_VEHICLE_IDS = createParameter("P_VEHICLE_IDS", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_GLOBAL_UNIT_ADJUSTMENT.F_GET_TOBE_RESULT_TMP.P_VARIANCE</code>.
	 */
	public static final Parameter<String> P_VARIANCE = createParameter("P_VARIANCE", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_GLOBAL_UNIT_ADJUSTMENT.F_GET_TOBE_RESULT_TMP.P_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_GLOBAL_UNIT_ADJUSTMENT.F_GET_TOBE_RESULT_TMP.P_SALES_TYPE_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_GLOBAL_UNIT_ADJUSTMENT.F_GET_TOBE_RESULT_TMP.P_SUPPORT_BUDGET</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_GLOBAL_UNIT_ADJUSTMENT.F_GET_TOBE_RESULT_TMP.P_SALES_AIDS</code>.
	 */
	public static final Parameter<String> P_SALES_AIDS = createParameter("P_SALES_AIDS", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_GLOBAL_UNIT_ADJUSTMENT.F_GET_TOBE_RESULT_TMP.P_IMPACT_CATEGORY</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_GLOBAL_UNIT_ADJUSTMENT.F_GET_TOBE_RESULT_TMP.P_GRPBY_FLAG</code>.
	 */
	public static final Parameter<String> P_GRPBY_FLAG = createParameter("P_GRPBY_FLAG", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_GLOBAL_UNIT_ADJUSTMENT.F_GET_TOBE_RESULT_TMP.P_CATEGORY_IDS</code>.
	 */
	 ...
	 */
	public FGetTobeResultTmp() {
		super("F_GET_TOBE_RESULT_TMP", Wetrn.WETRN, AppGlobalUnitAdjustment.APP_GLOBAL_UNIT_ADJUSTMENT, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
