...
public class FGetUpdtVehicleTobeData extends AbstractRoutine<Object> {

	private static final long serialVersionUID = -98001032;

	/**
	 * The parameter <code>WETRN.APP_GLOBAL_UNIT_ADJUSTMENT.F_GET_UPDT_VEHICLE_TOBE_DATA.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_GLOBAL_UNIT_ADJUSTMENT.F_GET_UPDT_VEHICLE_TOBE_DATA.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_GLOBAL_UNIT_ADJUSTMENT.F_GET_UPDT_VEHICLE_TOBE_DATA.P_VEHICLE_IDS</code>.
	 */
	public static final Parameter<String> P_VEHICLE_IDS = createParameter("P_VEHICLE_IDS", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_GLOBAL_UNIT_ADJUSTMENT.F_GET_UPDT_VEHICLE_TOBE_DATA.P_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_GLOBAL_UNIT_ADJUSTMENT.F_GET_UPDT_VEHICLE_TOBE_DATA.P_SALES_TYPE_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_GLOBAL_UNIT_ADJUSTMENT.F_GET_UPDT_VEHICLE_TOBE_DATA.P_OFF_SCHEDULE_FLAG</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_GLOBAL_UNIT_ADJUSTMENT.F_GET_UPDT_VEHICLE_TOBE_DATA.P_SUPPORT_BUDGET</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_GLOBAL_UNIT_ADJUSTMENT.F_GET_UPDT_VEHICLE_TOBE_DATA.P_SALES_AIDS</code>.
	 */
	public static final Parameter<String> P_SALES_AIDS = createParameter("P_SALES_AIDS", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_GLOBAL_UNIT_ADJUSTMENT.F_GET_UPDT_VEHICLE_TOBE_DATA.P_CATEGORY_IDS</code>.
	 */
	 ...
	 */
	public FGetUpdtVehicleTobeData() {
		super("F_GET_UPDT_VEHICLE_TOBE_DATA", Wetrn.WETRN, AppGlobalUnitAdjustment.APP_GLOBAL_UNIT_ADJUSTMENT, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
