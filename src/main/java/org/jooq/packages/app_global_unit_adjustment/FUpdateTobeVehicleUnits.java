...
public class FUpdateTobeVehicleUnits extends AbstractRoutine<String> {

	private static final long serialVersionUID = -721233536;

	/**
	 * The parameter <code>WETRN.APP_GLOBAL_UNIT_ADJUSTMENT.F_UPDATE_TOBE_VEHICLE_UNITS.RETURN_VALUE</code>.
	 */
	public static final Parameter<String> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_GLOBAL_UNIT_ADJUSTMENT.F_UPDATE_TOBE_VEHICLE_UNITS.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_GLOBAL_UNIT_ADJUSTMENT.F_UPDATE_TOBE_VEHICLE_UNITS.P_VEHICLE_IDS</code>.
	 */
	public static final Parameter<String> P_VEHICLE_IDS = createParameter("P_VEHICLE_IDS", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_GLOBAL_UNIT_ADJUSTMENT.F_UPDATE_TOBE_VEHICLE_UNITS.P_VARIANCE</code>.
	 */
	public static final Parameter<String> P_VARIANCE = createParameter("P_VARIANCE", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_GLOBAL_UNIT_ADJUSTMENT.F_UPDATE_TOBE_VEHICLE_UNITS.P_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_GLOBAL_UNIT_ADJUSTMENT.F_UPDATE_TOBE_VEHICLE_UNITS.P_SALES_TYPE_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_GLOBAL_UNIT_ADJUSTMENT.F_UPDATE_TOBE_VEHICLE_UNITS.P_SUPPORT_BUDGET</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_GLOBAL_UNIT_ADJUSTMENT.F_UPDATE_TOBE_VEHICLE_UNITS.P_SALES_AIDS</code>.
	 */
	public static final Parameter<String> P_SALES_AIDS = createParameter("P_SALES_AIDS", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_GLOBAL_UNIT_ADJUSTMENT.F_UPDATE_TOBE_VEHICLE_UNITS.P_CATEGORY_IDS</code>.
	 */
	 ...
	 */
	public FUpdateTobeVehicleUnits() {
		super("F_UPDATE_TOBE_VEHICLE_UNITS", Wetrn.WETRN, AppGlobalUnitAdjustment.APP_GLOBAL_UNIT_ADJUSTMENT, org.jooq.impl.SQLDataType.VARCHAR);
