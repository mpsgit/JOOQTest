...
public class PerdPlus extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = -1662550165;

	/**
	 * The parameter <code>WETRN.PA_MAPS_PUBLIC.PERD_PLUS.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_PUBLIC.PERD_PLUS.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.PA_MAPS_PUBLIC.PERD_PLUS.P_PERD1</code>.
	 */
	public static final Parameter<BigDecimal> P_PERD1 = createParameter("P_PERD1", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.PA_MAPS_PUBLIC.PERD_PLUS.P_PERD_DIFF</code>.
	 */
	public static final Parameter<BigDecimal> P_PERD_DIFF = createParameter("P_PERD_DIFF", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * Create a new routine call instance
	 */
	public PerdPlus() {
		super("PERD_PLUS", Wetrn.WETRN, PaMapsPublic.PA_MAPS_PUBLIC, org.jooq.impl.SQLDataType.NUMERIC);

		setReturnParameter(RETURN_VALUE);
		addInParameter(P_MRKT_ID);
		addInParameter(P_PERD1);
		addInParameter(P_PERD_DIFF);
	}
	...
	/**
	 * Set the <code>P_PERD_DIFF</code> parameter IN value to the routine
	 */
	public void setPPerdDiff(Number value) {
		setNumber(P_PERD_DIFF, value);
	}

	/**
	 * Set the <code>P_PERD_DIFF</code> parameter to the function to be used with a {@link org.jooq.Select} statement
	 */
	public void setPPerdDiff(Field<? extends Number> field) {
		setNumber(P_PERD_DIFF, field);
	}
}
