...
public class InVehList extends AbstractRoutine<String> {
	...
	private static final long serialVersionUID = 455492459;

	/**
	 * The parameter <code>WETRN.APP_LNM_CN.IN_VEH_LIST.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CN.IN_VEH_LIST.P_VEH_ID</code>.
	 */
	 ...
	 */
	public InVehList() {
		super("IN_VEH_LIST", Wetrn.WETRN, AppLnmCn.APP_LNM_CN, org.jooq.impl.SQLDataType.CHAR.length(1));
