...
public class GetSkuEndDate extends AbstractRoutine<BigDecimal> {
	...
	private static final long serialVersionUID = 366244148;

	/**
	 * The parameter <code>WETRN.APP_LNM_CN.GET_SKU_END_DATE.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CN.GET_SKU_END_DATE.P_SKU_ID</code>.
	 */
	...
	public GetSkuEndDate() {
		super("GET_SKU_END_DATE", Wetrn.WETRN, AppLnmCn.APP_LNM_CN, org.jooq.impl.SQLDataType.NUMERIC);
