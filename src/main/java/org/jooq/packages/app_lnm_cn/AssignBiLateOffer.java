...
public class AssignBiLateOffer extends AbstractRoutine<java.lang.Void> {
	...
	private static final long serialVersionUID = -926689668;

	/**
	 * The parameter <code>WETRN.APP_LNM_CN.ASSIGN_BI_LATE_OFFER.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_CN.ASSIGN_BI_LATE_OFFER.P_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CN.ASSIGN_BI_LATE_OFFER.P_CONTINGENCY_IND</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CN.ASSIGN_BI_LATE_OFFER.P_USER_ID</code>.
	 */
	public static final Parameter<String> P_USER_ID = createParameter("P_USER_ID", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_CN.ASSIGN_BI_LATE_OFFER.P_STATUS</code>.
	 */
	...
	public AssignBiLateOffer() {
		super("ASSIGN_BI_LATE_OFFER", Wetrn.WETRN, AppLnmCn.APP_LNM_CN);
