...
public class GetValidOffsetsTxt extends AbstractRoutine<String> {
	...
	private static final long serialVersionUID = -1807192819;

	/**
	 * The parameter <code>WETRN.REP_ENERGY_CHART.GET_VALID_OFFSETS_TXT.RETURN_VALUE</code>.
	 */
	public static final Parameter<String> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.REP_ENERGY_CHART.GET_VALID_OFFSETS_TXT.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.REP_ENERGY_CHART.GET_VALID_OFFSETS_TXT.P_FROM_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_ENERGY_CHART.GET_VALID_OFFSETS_TXT.P_TO_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_ENERGY_CHART.GET_VALID_OFFSETS_TXT.P_MIN_OFFSET</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_ENERGY_CHART.GET_VALID_OFFSETS_TXT.P_MAX_OFFSET</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_ENERGY_CHART.GET_VALID_OFFSETS_TXT.P_COO</code>.
	 */
	public static final Parameter<BigDecimal> P_COO = createParameter("P_COO", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.REP_ENERGY_CHART.GET_VALID_OFFSETS_TXT.P_PERD_TYP</code>.
	 */
	...
	public GetValidOffsetsTxt() {
		super("GET_VALID_OFFSETS_TXT", Wetrn.WETRN, RepEnergyChart.REP_ENERGY_CHART, org.jooq.impl.SQLDataType.VARCHAR);
