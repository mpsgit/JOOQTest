...
public class GetOffsetsTable extends AbstractRoutine<Object> {

	private static final long serialVersionUID = 33287374;

	/**
	 * The parameter <code>WETRN.REP_ENERGY_CHART.GET_OFFSETS_TABLE.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_ENERGY_CHART.GET_OFFSETS_TABLE.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.REP_ENERGY_CHART.GET_OFFSETS_TABLE.P_FROM_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_ENERGY_CHART.GET_OFFSETS_TABLE.P_TO_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_ENERGY_CHART.GET_OFFSETS_TABLE.P_MIN_OFFSET</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_ENERGY_CHART.GET_OFFSETS_TABLE.P_MAX_OFFSET</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_ENERGY_CHART.GET_OFFSETS_TABLE.P_COO</code>.
	 */
	public static final Parameter<BigDecimal> P_COO = createParameter("P_COO", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.REP_ENERGY_CHART.GET_OFFSETS_TABLE.P_PERD_TYP</code>.
	 */
	 ...
	 */
	public GetOffsetsTable() {
		super("GET_OFFSETS_TABLE", Wetrn.WETRN, RepEnergyChart.REP_ENERGY_CHART, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
