...
import org.jooq.packages.app_lnm_mca_ms_bl_reassign.CheckLineNrExists;
import org.jooq.packages.app_lnm_mca_ms_bl_reassign.CheckMsFscExists;
import org.jooq.packages.app_lnm_mca_ms_bl_reassign.CheckMsFscUsage;
import org.jooq.packages.app_lnm_mca_ms_bl_reassign.CheckMsLineNrUsage;
import org.jooq.packages.app_lnm_mca_ms_bl_reassign.GetAssignableLineNrs;
import org.jooq.packages.app_lnm_mca_ms_bl_reassign.GetAssignableMsFscs;
import org.jooq.packages.app_lnm_mca_ms_bl_reassign.GetReassignMsAll;
import org.jooq.packages.app_lnm_mca_ms_bl_reassign.GetReassignMsByFsc;
import org.jooq.packages.app_lnm_mca_ms_bl_reassign.GetReassignMsByLineNr;
import org.jooq.packages.app_lnm_mca_ms_bl_reassign.GetReassignMsByName;
import org.jooq.packages.app_lnm_mca_ms_bl_reassign.ModifyMsFsc;
import org.jooq.packages.app_lnm_mca_ms_bl_reassign.ModifyMsLineNr;


/**
 * Convenience access to all stored procedures and functions in APP_LNM_MCA_MS_BL_REASSIGN
 */
@Generated(
	value = {
		"http://www.jooq.org",
...
public class AppLnmMcaMsBlReassign extends PackageImpl {

	private static final long serialVersionUID = -1444576456;

	/**
	 * The reference instance of <code>WETRN.APP_LNM_MCA_MS_BL_REASSIGN</code>
	 */
	public static final AppLnmMcaMsBlReassign APP_LNM_MCA_MS_BL_REASSIGN = new AppLnmMcaMsBlReassign();

	/**
	 * Call <code>WETRN.APP_LNM_MCA_MS_BL_REASSIGN.CHECK_LINE_NR_EXISTS</code>
	 */
	...
	/**
	 * Get <code>WETRN.APP_LNM_MCA_MS_BL_REASSIGN.CHECK_LINE_NR_EXISTS</code> as a field.
	 */
	...
	/**
	 * Call <code>WETRN.APP_LNM_MCA_MS_BL_REASSIGN.CHECK_MS_FSC_EXISTS</code>
	 */
	...
	/**
	 * Get <code>WETRN.APP_LNM_MCA_MS_BL_REASSIGN.CHECK_MS_FSC_EXISTS</code> as a field.
	 */
	...
	/**
	 * Call <code>WETRN.APP_LNM_MCA_MS_BL_REASSIGN.CHECK_MS_FSC_USAGE</code>
	 */
	...
	/**
	 * Get <code>WETRN.APP_LNM_MCA_MS_BL_REASSIGN.CHECK_MS_FSC_USAGE</code> as a field.
	 */
	...
	/**
	 * Call <code>WETRN.APP_LNM_MCA_MS_BL_REASSIGN.CHECK_MS_LINE_NR_USAGE</code>
	 */
	...
	/**
	 * Get <code>WETRN.APP_LNM_MCA_MS_BL_REASSIGN.CHECK_MS_LINE_NR_USAGE</code> as a field.
	 */
	...
	/**
	 * Call <code>WETRN.APP_LNM_MCA_MS_BL_REASSIGN.GET_ASSIGNABLE_LINE_NRS</code>
	 */
	...
	/**
	 * Get <code>WETRN.APP_LNM_MCA_MS_BL_REASSIGN.GET_ASSIGNABLE_LINE_NRS</code> as a field.
	 */
	...
	/**
	 * Call <code>WETRN.APP_LNM_MCA_MS_BL_REASSIGN.GET_ASSIGNABLE_MS_FSCS</code>
	 */
	...
	/**
	 * Get <code>WETRN.APP_LNM_MCA_MS_BL_REASSIGN.GET_ASSIGNABLE_MS_FSCS</code> as a field.
	 */
	...
	/**
	 * Call <code>WETRN.APP_LNM_MCA_MS_BL_REASSIGN.GET_REASSIGN_MS_ALL</code>
	 */
	...
	/**
	 * Get <code>WETRN.APP_LNM_MCA_MS_BL_REASSIGN.GET_REASSIGN_MS_ALL</code> as a field.
	 */
	...
	/**
	 * Call <code>WETRN.APP_LNM_MCA_MS_BL_REASSIGN.GET_REASSIGN_MS_BY_FSC</code>
	 */
	...
	/**
	 * Get <code>WETRN.APP_LNM_MCA_MS_BL_REASSIGN.GET_REASSIGN_MS_BY_FSC</code> as a field.
	 */
	...
	/**
	 * Call <code>WETRN.APP_LNM_MCA_MS_BL_REASSIGN.GET_REASSIGN_MS_BY_LINE_NR</code>
	 */
	...
	/**
	 * Get <code>WETRN.APP_LNM_MCA_MS_BL_REASSIGN.GET_REASSIGN_MS_BY_LINE_NR</code> as a field.
	 */
	...
	/**
	 * Call <code>WETRN.APP_LNM_MCA_MS_BL_REASSIGN.GET_REASSIGN_MS_BY_NAME</code>
	 */
	...
	/**
	 * Get <code>WETRN.APP_LNM_MCA_MS_BL_REASSIGN.GET_REASSIGN_MS_BY_NAME</code> as a field.
	 */
	...
	/**
	 * Call <code>WETRN.APP_LNM_MCA_MS_BL_REASSIGN.MODIFY_MS_FSC</code>
	 */
	...
	/**
	 * Call <code>WETRN.APP_LNM_MCA_MS_BL_REASSIGN.MODIFY_MS_LINE_NR</code>
	 */
	 ...
	 */
	private AppLnmMcaMsBlReassign() {
		super("APP_LNM_MCA_MS_BL_REASSIGN", Wetrn.WETRN);
	}
}
