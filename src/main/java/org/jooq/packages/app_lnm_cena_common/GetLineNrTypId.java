...
public class GetLineNrTypId extends AbstractRoutine<BigDecimal> {
	...
	private static final long serialVersionUID = -1746455378;

	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_COMMON.GET_LINE_NR_TYP_ID.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_COMMON.GET_LINE_NR_TYP_ID.P_LEAD_MRKT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_COMMON.GET_LINE_NR_TYP_ID.P_PROD_TYP_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_COMMON.GET_LINE_NR_TYP_ID.P_FORM_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_FORM_ID = createParameter("P_FORM_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_COMMON.GET_LINE_NR_TYP_ID.P_CNSMR_INVSTMT_BDGT_ID</code>.
	 */
	...
	public GetLineNrTypId() {
		super("GET_LINE_NR_TYP_ID", Wetrn.WETRN, AppLnmCenaCommon.APP_LNM_CENA_COMMON, org.jooq.impl.SQLDataType.NUMERIC);
