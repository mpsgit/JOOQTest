...
public class GetMrktBilngInfo extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = -1805785486;

	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_COMMON.GET_MRKT_BILNG_INFO.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_COMMON.GET_MRKT_BILNG_INFO.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_COMMON.GET_MRKT_BILNG_INFO.P_OFFR_PERD_ID</code>.
	 */
	...
	public GetMrktBilngInfo() {
		super("GET_MRKT_BILNG_INFO", Wetrn.WETRN, AppLnmCenaCommon.APP_LNM_CENA_COMMON, org.jooq.impl.DefaultDataType.getDefaultDataType("PL/SQL RECORD"));
