...
public class GetLeadMrktId extends AbstractRoutine<BigDecimal> {
	...
	private static final long serialVersionUID = -1805501040;

	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_COMMON.GET_LEAD_MRKT_ID.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_COMMON.GET_LEAD_MRKT_ID.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_COMMON.GET_LEAD_MRKT_ID.P_OFFR_PERD_ID</code>.
	 */
	...
	public GetLeadMrktId() {
		super("GET_LEAD_MRKT_ID", Wetrn.WETRN, AppLnmCenaCommon.APP_LNM_CENA_COMMON, org.jooq.impl.SQLDataType.NUMERIC);
