...
public class InitBilngSubclstrInfo extends AbstractRoutine<java.lang.Void> {
	...
	private static final long serialVersionUID = -2022873187;

	/**
	 * The parameter <code>WETRN.APP_LNM_SUBCLSTR_INFO.INIT_BILNG_SUBCLSTR_INFO.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_SUBCLSTR_INFO.INIT_BILNG_SUBCLSTR_INFO.P_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SUBCLSTR_INFO.INIT_BILNG_SUBCLSTR_INFO.P_LEAD_MRKT_ID</code>.
	 */
	...
	public InitBilngSubclstrInfo() {
		super("INIT_BILNG_SUBCLSTR_INFO", Wetrn.WETRN, AppLnmSubclstrInfo.APP_LNM_SUBCLSTR_INFO);
