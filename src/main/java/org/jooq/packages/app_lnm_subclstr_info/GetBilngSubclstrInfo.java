...
public class GetBilngSubclstrInfo extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = -1804639866;

	/**
	 * The parameter <code>WETRN.APP_LNM_SUBCLSTR_INFO.GET_BILNG_SUBCLSTR_INFO.RETURN_VALUE</code>.
	 */
	...
	public GetBilngSubclstrInfo() {
		super("GET_BILNG_SUBCLSTR_INFO", Wetrn.WETRN, AppLnmSubclstrInfo.APP_LNM_SUBCLSTR_INFO, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
