...
public class GetBrchrLineNrGrpId extends AbstractRoutine<BigDecimal> {
	...
	private static final long serialVersionUID = 1109171295;

	/**
	 * The parameter <code>WETRN.APP_LNM_LN_GRP.GET_BRCHR_LINE_NR_GRP_ID.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_LN_GRP.GET_BRCHR_LINE_NR_GRP_ID.P_CLSTR_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_CLSTR_ID = createParameter("P_CLSTR_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_LN_GRP.GET_BRCHR_LINE_NR_GRP_ID.P_LEAD_MRKT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_LN_GRP.GET_BRCHR_LINE_NR_GRP_ID.P_LINE_NR_TYP_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_LN_GRP.GET_BRCHR_LINE_NR_GRP_ID.P_LEAD_BUS_DIV_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_LN_GRP.GET_BRCHR_LINE_NR_GRP_ID.P_BUS_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_BUS_ID = createParameter("P_BUS_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_LN_GRP.GET_BRCHR_LINE_NR_GRP_ID.P_CATGRY_ID</code>.
	 */
	...
	public GetBrchrLineNrGrpId() {
		super("GET_BRCHR_LINE_NR_GRP_ID", Wetrn.WETRN, AppLnmLnGrp.APP_LNM_LN_GRP, org.jooq.impl.SQLDataType.NUMERIC);
