...
public class LoadBilngLineNrGrpLkup extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = -1995519463;

	/**
	 * The parameter <code>WETRN.APP_LNM_LN_GRP.LOAD_BILNG_LINE_NR_GRP_LKUP.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_LN_GRP.LOAD_BILNG_LINE_NR_GRP_LKUP.P_CLSTR_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_CLSTR_ID = createParameter("P_CLSTR_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_LN_GRP.LOAD_BILNG_LINE_NR_GRP_LKUP.P_BILNG_SYS_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_LN_GRP.LOAD_BILNG_LINE_NR_GRP_LKUP.P_LEAD_MRKT_ID</code>.
	 */
	...
	public LoadBilngLineNrGrpLkup() {
		super("LOAD_BILNG_LINE_NR_GRP_LKUP", Wetrn.WETRN, AppLnmLnGrp.APP_LNM_LN_GRP, org.jooq.impl.DefaultDataType.getDefaultDataType("PL/SQL TABLE"));
