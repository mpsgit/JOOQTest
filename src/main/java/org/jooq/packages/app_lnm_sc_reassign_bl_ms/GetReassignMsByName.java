...
public class GetReassignMsByName extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = -1598708420;

	/**
	 * The parameter <code>WETRN.APP_LNM_SC_REASSIGN_BL_MS.GET_REASSIGN_MS_BY_NAME.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SC_REASSIGN_BL_MS.GET_REASSIGN_MS_BY_NAME.P_STRT_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SC_REASSIGN_BL_MS.GET_REASSIGN_MS_BY_NAME.P_END_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SC_REASSIGN_BL_MS.GET_REASSIGN_MS_BY_NAME.P_SET_NAME</code>.
	 */
	...
	public GetReassignMsByName() {
		super("GET_REASSIGN_MS_BY_NAME", Wetrn.WETRN, AppLnmScReassignBlMs.APP_LNM_SC_REASSIGN_BL_MS, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
