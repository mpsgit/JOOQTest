...
public class CheckMsFscUsage extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = 1451256758;

	/**
	 * The parameter <code>WETRN.APP_LNM_SC_REASSIGN_BL_MS.CHECK_MS_FSC_USAGE.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SC_REASSIGN_BL_MS.CHECK_MS_FSC_USAGE.P_OFFR_SKU_SET_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SC_REASSIGN_BL_MS.CHECK_MS_FSC_USAGE.P_FSC</code>.
	 */
	public static final Parameter<String> P_FSC = createParameter("P_FSC", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_SC_REASSIGN_BL_MS.CHECK_MS_FSC_USAGE.P_OFFR_PERD_ID</code>.
	 */
	...
	public CheckMsFscUsage() {
		super("CHECK_MS_FSC_USAGE", Wetrn.WETRN, AppLnmScReassignBlMs.APP_LNM_SC_REASSIGN_BL_MS, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
