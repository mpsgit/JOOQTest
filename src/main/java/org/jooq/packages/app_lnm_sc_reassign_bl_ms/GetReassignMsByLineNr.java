...
public class GetReassignMsByLineNr extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = -2114460392;

	/**
	 * The parameter <code>WETRN.APP_LNM_SC_REASSIGN_BL_MS.GET_REASSIGN_MS_BY_LINE_NR.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SC_REASSIGN_BL_MS.GET_REASSIGN_MS_BY_LINE_NR.P_STRT_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SC_REASSIGN_BL_MS.GET_REASSIGN_MS_BY_LINE_NR.P_END_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SC_REASSIGN_BL_MS.GET_REASSIGN_MS_BY_LINE_NR.P_SET_LINE_NR</code>.
	 */
	...
	public GetReassignMsByLineNr() {
		super("GET_REASSIGN_MS_BY_LINE_NR", Wetrn.WETRN, AppLnmScReassignBlMs.APP_LNM_SC_REASSIGN_BL_MS, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
