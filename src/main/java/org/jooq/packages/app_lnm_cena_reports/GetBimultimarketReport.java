...
public class GetBimultimarketReport extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = 320171805;

	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REPORTS.GET_BIMULTIMARKET_REPORT.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REPORTS.GET_BIMULTIMARKET_REPORT.P_MRKT_ID_LIST</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REPORTS.GET_BIMULTIMARKET_REPORT.P_CAL_MRKT</code>.
	 */
	public static final Parameter<BigDecimal> P_CAL_MRKT = createParameter("P_CAL_MRKT", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REPORTS.GET_BIMULTIMARKET_REPORT.P_START_PERIOD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REPORTS.GET_BIMULTIMARKET_REPORT.P_END_PERIOD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REPORTS.GET_BIMULTIMARKET_REPORT.P_VEH_ID_LIST</code>.
	 */
	...
	public GetBimultimarketReport() {
		super("GET_BIMULTIMARKET_REPORT", Wetrn.WETRN, AppLnmCenaReports.APP_LNM_CENA_REPORTS, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));

		setReturnParameter(RETURN_VALUE);
		addInParameter(P_MRKT_ID_LIST);
		addInParameter(P_CAL_MRKT);
	...
	/**
	 * Set the <code>P_CAL_MRKT</code> parameter IN value to the routine
	 */
	public void setPCalMrkt(Number value) {
		setNumber(P_CAL_MRKT, value);
	}

	/**
	 * Set the <code>P_CAL_MRKT</code> parameter to the function to be used with a {@link org.jooq.Select} statement
	 */
	public void setPCalMrkt(Field<? extends Number> field) {
		setNumber(P_CAL_MRKT, field);
	}
