...
public class GetBilngLineNrData extends AbstractRoutine<Object> {

	private static final long serialVersionUID = -1883229929;

	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REPORTS.GET_BILNG_LINE_NR_DATA.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REPORTS.GET_BILNG_LINE_NR_DATA.P_CLSTR_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_CLSTR_ID = createParameter("P_CLSTR_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REPORTS.GET_BILNG_LINE_NR_DATA.P_LEAD_MRKT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REPORTS.GET_BILNG_LINE_NR_DATA.P_LINE_NR</code>.
	 */
	public static final Parameter<String> P_LINE_NR = createParameter("P_LINE_NR", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REPORTS.GET_BILNG_LINE_NR_DATA.P_REF_OFFR_PERD_ID</code>.
	 */
	 ...
	 */
	public GetBilngLineNrData() {
		super("GET_BILNG_LINE_NR_DATA", Wetrn.WETRN, AppLnmCenaReports.APP_LNM_CENA_REPORTS, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
