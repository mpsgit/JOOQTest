...
public class GetBlmultimarketReport extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = -56555526;

	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REPORTS.GET_BLMULTIMARKET_REPORT.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REPORTS.GET_BLMULTIMARKET_REPORT.P_MRKT_ID_LIST</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REPORTS.GET_BLMULTIMARKET_REPORT.P_CAL_MRKT</code>.
	 */
	public static final Parameter<BigDecimal> P_CAL_MRKT = createParameter("P_CAL_MRKT", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REPORTS.GET_BLMULTIMARKET_REPORT.P_START_PERIOD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REPORTS.GET_BLMULTIMARKET_REPORT.P_END_PERIOD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REPORTS.GET_BLMULTIMARKET_REPORT.P_VEH_ID_LIST</code>.
	 */
	...
	public GetBlmultimarketReport() {
		super("GET_BLMULTIMARKET_REPORT", Wetrn.WETRN, AppLnmCenaReports.APP_LNM_CENA_REPORTS, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
