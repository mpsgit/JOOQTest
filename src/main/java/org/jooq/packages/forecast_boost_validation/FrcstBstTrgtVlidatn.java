...
public class FrcstBstTrgtVlidatn extends AbstractRoutine<String> {

	private static final long serialVersionUID = 189754052;

	/**
	 * The parameter <code>WETRN.FORECAST_BOOST_VALIDATION.FRCST_BST_TRGT_VLIDATN.RETURN_VALUE</code>.
	 */
	public static final Parameter<String> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.FORECAST_BOOST_VALIDATION.FRCST_BST_TRGT_VLIDATN.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.FORECAST_BOOST_VALIDATION.FRCST_BST_TRGT_VLIDATN.P_PERD_ID</code>.
	 */
	 ...
	 */
	public FrcstBstTrgtVlidatn() {
		super("FRCST_BST_TRGT_VLIDATN", Wetrn.WETRN, ForecastBoostValidation.FORECAST_BOOST_VALIDATION, org.jooq.impl.SQLDataType.VARCHAR);
