...
public class ProductUpdates extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = -1864653952;

	/**
	 * The parameter <code>WETRN.PA_MAPS.PRODUCT_UPDATES.PA_MAPS_RC</code>.
	 */
	...
	public ProductUpdates() {
		super("PRODUCT_UPDATES", Wetrn.WETRN, PaMaps.PA_MAPS);
