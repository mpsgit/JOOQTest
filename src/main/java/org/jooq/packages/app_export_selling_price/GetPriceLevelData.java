...
public class GetPriceLevelData extends AbstractRoutine<Object> {

	private static final long serialVersionUID = 293625438;

	/**
	 * The parameter <code>WETRN.APP_EXPORT_SELLING_PRICE.GET_PRICE_LEVEL_DATA.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_EXPORT_SELLING_PRICE.GET_PRICE_LEVEL_DATA.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_EXPORT_SELLING_PRICE.GET_PRICE_LEVEL_DATA.P_OFFR_PERD_ID</code>.
	 */
	 ...
	 */
	public GetPriceLevelData() {
		super("GET_PRICE_LEVEL_DATA", Wetrn.WETRN, AppExportSellingPrice.APP_EXPORT_SELLING_PRICE, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
