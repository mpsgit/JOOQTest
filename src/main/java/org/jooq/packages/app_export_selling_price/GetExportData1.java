 ...
 */
package org.jooq.packages.app_export_selling_price;
...
import org.jooq.packages.AppExportSellingPrice;
...
public class GetExportData1 extends AbstractRoutine<Object> {

	private static final long serialVersionUID = 149858313;

	/**
	 * The parameter <code>WETRN.APP_EXPORT_SELLING_PRICE.GET_EXPORT_DATA.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_EXPORT_SELLING_PRICE.GET_EXPORT_DATA.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_EXPORT_SELLING_PRICE.GET_EXPORT_DATA.P_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_EXPORT_SELLING_PRICE.GET_EXPORT_DATA.P_VEH_ID_LIST</code>.
	 */
	public static final Parameter<String> P_VEH_ID_LIST = createParameter("P_VEH_ID_LIST", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_EXPORT_SELLING_PRICE.GET_EXPORT_DATA.P_CATGRY_ID_LIST</code>.
	 */
	 ...
	 */
	public GetExportData1() {
		super("GET_EXPORT_DATA", Wetrn.WETRN, AppExportSellingPrice.APP_EXPORT_SELLING_PRICE, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
