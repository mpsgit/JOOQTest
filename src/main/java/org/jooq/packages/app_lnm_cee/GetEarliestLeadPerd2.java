...
public class GetEarliestLeadPerd2 extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = 1001493965;

	/**
	 * The parameter <code>WETRN.APP_LNM_CEE.GET_EARLIEST_LEAD_PERD.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CEE.GET_EARLIEST_LEAD_PERD.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_CEE.GET_EARLIEST_LEAD_PERD.P_PERD_ID</code>.
	 */
	 ...
	 */
	public GetEarliestLeadPerd2() {
		super("GET_EARLIEST_LEAD_PERD", Wetrn.WETRN, AppLnmCee.APP_LNM_CEE, org.jooq.impl.SQLDataType.NUMERIC);
