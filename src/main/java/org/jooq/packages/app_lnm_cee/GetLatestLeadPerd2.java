...
public class GetLatestLeadPerd2 extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = 1563990541;
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CEE.GET_LATEST_LEAD_PERD.P_MRKT_ID</code>.
	 */
