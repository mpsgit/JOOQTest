...
public class GetSkuStartDate extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = -436024903;

	/**
	 * The parameter <code>WETRN.APP_LNM_CEE.GET_SKU_START_DATE.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CEE.GET_SKU_START_DATE.P_SKU_ID</code>.
	 */
	 ...
	 */
	public GetSkuStartDate() {
		super("GET_SKU_START_DATE", Wetrn.WETRN, AppLnmCee.APP_LNM_CEE, org.jooq.impl.SQLDataType.NUMERIC);
