...
public class ValidateLineNr extends AbstractRoutine<String> {
	...
	private static final long serialVersionUID = -723048646;

	/**
	 * The parameter <code>WETRN.APP_LNM_ANZ_REASSIGN_NORMAL.VALIDATE_LINE_NR.RETURN_VALUE</code>.
	 */
	public static final Parameter<String> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_ANZ_REASSIGN_NORMAL.VALIDATE_LINE_NR.P_LEAD_MRKT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_ANZ_REASSIGN_NORMAL.VALIDATE_LINE_NR.P_LINE_NR</code>.
	 */
	public static final Parameter<String> P_LINE_NR = createParameter("P_LINE_NR", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_ANZ_REASSIGN_NORMAL.VALIDATE_LINE_NR.P_LINE_NR_TYPE_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_ANZ_REASSIGN_NORMAL.VALIDATE_LINE_NR.P_LINE_NR_GRP_ID</code>.
	 */
	...
	public ValidateLineNr() {
		super("VALIDATE_LINE_NR", Wetrn.WETRN, AppLnmAnzReassignNormal.APP_LNM_ANZ_REASSIGN_NORMAL, org.jooq.impl.SQLDataType.VARCHAR);
