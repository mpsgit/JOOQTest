...
public class CheckLineNrUsage extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = -548041408;

	/**
	 * The parameter <code>WETRN.APP_LNM_ANZ_REASSIGN_NORMAL.CHECK_LINE_NR_USAGE.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_ANZ_REASSIGN_NORMAL.CHECK_LINE_NR_USAGE.P_LEAD_MRKT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_ANZ_REASSIGN_NORMAL.CHECK_LINE_NR_USAGE.P_LINE_NR</code>.
	 */
	public static final Parameter<String> P_LINE_NR = createParameter("P_LINE_NR", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_ANZ_REASSIGN_NORMAL.CHECK_LINE_NR_USAGE.P_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_ANZ_REASSIGN_NORMAL.CHECK_LINE_NR_USAGE.P_SKU_ID</code>.
	 */
	...
	public CheckLineNrUsage() {
		super("CHECK_LINE_NR_USAGE", Wetrn.WETRN, AppLnmAnzReassignNormal.APP_LNM_ANZ_REASSIGN_NORMAL, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
