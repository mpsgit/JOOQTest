...
public class GetReassignItemsSpecific extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = 266861460;

	/**
	 * The parameter <code>WETRN.APP_LNM_SC_REASSIGN_NORMAL.GET_REASSIGN_ITEMS_SPECIFIC.RETURN_VALUE</code>.
	 */
	...
	public GetReassignItemsSpecific() {
		super("GET_REASSIGN_ITEMS_SPECIFIC", Wetrn.WETRN, AppLnmScReassignNormal.APP_LNM_SC_REASSIGN_NORMAL, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
