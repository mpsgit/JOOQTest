...
public class AssignLineNr extends AbstractRoutine<java.lang.Void> {
	...
	private static final long serialVersionUID = -1975745698;

	/**
	 * The parameter <code>WETRN.APP_LNM_SC_REASSIGN_NORMAL.ASSIGN_LINE_NR.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_SC_REASSIGN_NORMAL.ASSIGN_LINE_NR.P_SKU_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_SKU_ID = createParameter("P_SKU_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_SC_REASSIGN_NORMAL.ASSIGN_LINE_NR.P_LINE_NR</code>.
	 */
	public static final Parameter<String> P_LINE_NR = createParameter("P_LINE_NR", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_SC_REASSIGN_NORMAL.ASSIGN_LINE_NR.P_START_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SC_REASSIGN_NORMAL.ASSIGN_LINE_NR.P_END_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SC_REASSIGN_NORMAL.ASSIGN_LINE_NR.P_USER_ID</code>.
	 */
	 ...
	 */
	public AssignLineNr() {
		super("ASSIGN_LINE_NR", Wetrn.WETRN, AppLnmScReassignNormal.APP_LNM_SC_REASSIGN_NORMAL);
