...
public class ModifyMiLineNr extends AbstractRoutine<java.lang.Void> {
	...
	private static final long serialVersionUID = 1981372061;

	/**
	 * The parameter <code>WETRN.APP_LNM_SC_REASSIGN_BL_MI.MODIFY_MI_LINE_NR.P_OFFR_SKU_LINE_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SC_REASSIGN_BL_MI.MODIFY_MI_LINE_NR.P_LINE_NR_TYP_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SC_REASSIGN_BL_MI.MODIFY_MI_LINE_NR.P_LINE_NR_GRP_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SC_REASSIGN_BL_MI.MODIFY_MI_LINE_NR.P_LINE_NR</code>.
	 */
	public static final Parameter<String> P_LINE_NR = createParameter("P_LINE_NR", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_SC_REASSIGN_BL_MI.MODIFY_MI_LINE_NR.P_USER_ID</code>.
	 */
	...
	public ModifyMiLineNr() {
		super("MODIFY_MI_LINE_NR", Wetrn.WETRN, AppLnmScReassignBlMi.APP_LNM_SC_REASSIGN_BL_MI);
