...
public class SubbrndDisp extends AbstractRoutine<Object> {

	private static final long serialVersionUID = 1310970702;

	/**
	 * The parameter <code>WETRN.REP_TOP_BRANDS.SUBBRND_DISP.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_TOP_BRANDS.SUBBRND_DISP.P_INC_SUP_BUD</code>.
	 */
	public static final Parameter<String> P_INC_SUP_BUD = createParameter("P_INC_SUP_BUD", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.REP_TOP_BRANDS.SUBBRND_DISP.P_CAMPAIGN_SLS</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_TOP_BRANDS.SUBBRND_DISP.P_OFFSET_MIN</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_TOP_BRANDS.SUBBRND_DISP.P_OFFSET_MAX</code>.
	 */
	 ...
	 */
	public SubbrndDisp() {
		super("SUBBRND_DISP", Wetrn.WETRN, RepTopBrands.REP_TOP_BRANDS, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
