...
public class OffrVersion extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = -327253038;

	/**
	 * The parameter <code>WETRN.REP_TOP_BRANDS.OFFR_VERSION.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_TOP_BRANDS.OFFR_VERSION.P_INC_SUP_BUD</code>.
	 */
	public static final Parameter<String> P_INC_SUP_BUD = createParameter("P_INC_SUP_BUD", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.REP_TOP_BRANDS.OFFR_VERSION.P_CAMPAIGN_SLS</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_TOP_BRANDS.OFFR_VERSION.P_OFFSET_MIN</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_TOP_BRANDS.OFFR_VERSION.P_OFFSET_MAX</code>.
	 */
	 ...
	 */
	public OffrVersion() {
		super("OFFR_VERSION", Wetrn.WETRN, RepTopBrands.REP_TOP_BRANDS, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
