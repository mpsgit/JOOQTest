...
public class OffrPriorTopBrandsRpt extends AbstractRoutine<Object> {

	private static final long serialVersionUID = 1789888790;

	/**
	 * The parameter <code>WETRN.REP_TOP_BRANDS.OFFR_PRIOR_TOP_BRANDS_RPT.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_TOP_BRANDS.OFFR_PRIOR_TOP_BRANDS_RPT.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.REP_TOP_BRANDS.OFFR_PRIOR_TOP_BRANDS_RPT.P_PERD_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_PERD_ID = createParameter("P_PERD_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.REP_TOP_BRANDS.OFFR_PRIOR_TOP_BRANDS_RPT.P_OFFR_VER_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_TOP_BRANDS.OFFR_PRIOR_TOP_BRANDS_RPT.P_PRIOR_VER_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_PRIOR_VER_ID = createParameter("P_PRIOR_VER_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.REP_TOP_BRANDS.OFFR_PRIOR_TOP_BRANDS_RPT.P_VEH_ID</code>.
	 */
	public static final Parameter<String> P_VEH_ID = createParameter("P_VEH_ID", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.REP_TOP_BRANDS.OFFR_PRIOR_TOP_BRANDS_RPT.P_CATGRY_ID</code>.
	 */
	public static final Parameter<String> P_CATGRY_ID = createParameter("P_CATGRY_ID", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.REP_TOP_BRANDS.OFFR_PRIOR_TOP_BRANDS_RPT.P_SUBBRND_ID</code>.
	 */
	public static final Parameter<String> P_SUBBRND_ID = createParameter("P_SUBBRND_ID", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.REP_TOP_BRANDS.OFFR_PRIOR_TOP_BRANDS_RPT.P_CURRENCY</code>.
	 */
	public static final Parameter<String> P_CURRENCY = createParameter("P_CURRENCY", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.REP_TOP_BRANDS.OFFR_PRIOR_TOP_BRANDS_RPT.P_ACC_BY_IMP_CAT</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_TOP_BRANDS.OFFR_PRIOR_TOP_BRANDS_RPT.P_INC_SUP_BUD</code>.
	 */
	public static final Parameter<String> P_INC_SUP_BUD = createParameter("P_INC_SUP_BUD", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.REP_TOP_BRANDS.OFFR_PRIOR_TOP_BRANDS_RPT.P_CAMPAIGN_SLS</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_TOP_BRANDS.OFFR_PRIOR_TOP_BRANDS_RPT.P_OFFSET_MIN</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_TOP_BRANDS.OFFR_PRIOR_TOP_BRANDS_RPT.P_OFFSET_MAX</code>.
	 */
	 ...
	 */
	public OffrPriorTopBrandsRpt() {
		super("OFFR_PRIOR_TOP_BRANDS_RPT", Wetrn.WETRN, RepTopBrands.REP_TOP_BRANDS, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));

		setReturnParameter(RETURN_VALUE);
		addInParameter(P_MRKT_ID);
		addInParameter(P_PERD_ID);
		addInParameter(P_OFFR_VER_ID);
		addInParameter(P_PRIOR_VER_ID);
	...
	/**
	 * Set the <code>P_PRIOR_VER_ID</code> parameter IN value to the routine
	 */
	public void setPPriorVerId(Number value) {
		setNumber(P_PRIOR_VER_ID, value);
	}

	/**
	 * Set the <code>P_PRIOR_VER_ID</code> parameter to the function to be used with a {@link org.jooq.Select} statement
	 */
	public void setPPriorVerId(Field<? extends Number> field) {
		setNumber(P_PRIOR_VER_ID, field);
	}
