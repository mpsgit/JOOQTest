...
public class CheckLineNrExists extends AbstractRoutine<String> {
	...
	private static final long serialVersionUID = 1776726737;

	/**
	 * The parameter <code>WETRN.APP_LNM_SC_COMMON.CHECK_LINE_NR_EXISTS.RETURN_VALUE</code>.
	 */
	public static final Parameter<String> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_SC_COMMON.CHECK_LINE_NR_EXISTS.P_LINE_NR</code>.
	 */
	public static final Parameter<String> P_LINE_NR = createParameter("P_LINE_NR", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_SC_COMMON.CHECK_LINE_NR_EXISTS.P_LINE_NR_TYP_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SC_COMMON.CHECK_LINE_NR_EXISTS.P_LINE_NR_GRP_ID</code>.
	 */
	...
	public CheckLineNrExists() {
		super("CHECK_LINE_NR_EXISTS", Wetrn.WETRN, AppLnmScCommon.APP_LNM_SC_COMMON, org.jooq.impl.SQLDataType.VARCHAR);
