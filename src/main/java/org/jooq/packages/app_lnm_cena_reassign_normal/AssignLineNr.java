...
public class AssignLineNr extends AbstractRoutine<java.lang.Void> {
	...
	private static final long serialVersionUID = -689212746;

	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_NORMAL.ASSIGN_LINE_NR.P_LEAD_MRKT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_NORMAL.ASSIGN_LINE_NR.P_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_NORMAL.ASSIGN_LINE_NR.P_END_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_CENA_REASSIGN_NORMAL.ASSIGN_LINE_NR.P_USER_ID</code>.
	 */
	 ...
	 */
	public AssignLineNr() {
		super("ASSIGN_LINE_NR", Wetrn.WETRN, AppLnmCenaReassignNormal.APP_LNM_CENA_REASSIGN_NORMAL);
