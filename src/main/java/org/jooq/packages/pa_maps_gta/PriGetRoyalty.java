...
public class PriGetRoyalty extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = 608571326;

	/**
	 * The parameter <code>WETRN.PA_MAPS_GTA.PRI_GET_ROYALTY.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_GTA.PRI_GET_ROYALTY.PMRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> PMRKT_ID = createParameter("PMRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.PA_MAPS_GTA.PRI_GET_ROYALTY.POFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_GTA.PRI_GET_ROYALTY.PPRFL_CD</code>.
	 */
	 ...
	 */
	public PriGetRoyalty() {
		super("PRI_GET_ROYALTY", Wetrn.WETRN, PaMapsGta.PA_MAPS_GTA, org.jooq.impl.SQLDataType.NUMERIC);
