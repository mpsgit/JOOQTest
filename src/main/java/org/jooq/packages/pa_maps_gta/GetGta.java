...
public class GetGta extends AbstractRoutine<BigDecimal> {
	...
	private static final long serialVersionUID = -1834013660;

	/**
	 * The parameter <code>WETRN.PA_MAPS_GTA.GET_GTA.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_GTA.GET_GTA.PMRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> PMRKT_ID = createParameter("PMRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.PA_MAPS_GTA.GET_GTA.POFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_GTA.GET_GTA.PSLS_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_GTA.GET_GTA.POFFR_SKU_LINE_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_GTA.GET_GTA.PSLS_TYP_ID</code>.
	 */
	 ...
	 */
	public GetGta() {
		super("GET_GTA", Wetrn.WETRN, PaMapsGta.PA_MAPS_GTA, org.jooq.impl.SQLDataType.NUMERIC);
