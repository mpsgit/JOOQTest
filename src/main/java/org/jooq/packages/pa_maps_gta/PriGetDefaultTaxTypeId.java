...
public class PriGetDefaultTaxTypeId extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = 691696404;

	/**
	 * The parameter <code>WETRN.PA_MAPS_GTA.PRI_GET_DEFAULT_TAX_TYPE_ID.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_GTA.PRI_GET_DEFAULT_TAX_TYPE_ID.PMRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> PMRKT_ID = createParameter("PMRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.PA_MAPS_GTA.PRI_GET_DEFAULT_TAX_TYPE_ID.PPRFL_CD</code>.
	 */
	public static final Parameter<BigDecimal> PPRFL_CD = createParameter("PPRFL_CD", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.PA_MAPS_GTA.PRI_GET_DEFAULT_TAX_TYPE_ID.POFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_GTA.PRI_GET_DEFAULT_TAX_TYPE_ID.PVEH_ID</code>.
	 */
	public static final Parameter<BigDecimal> PVEH_ID = createParameter("PVEH_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.PA_MAPS_GTA.PRI_GET_DEFAULT_TAX_TYPE_ID.PSLS_CLS_CD</code>.
	 */
	 ...
	 */
	public PriGetDefaultTaxTypeId() {
		super("PRI_GET_DEFAULT_TAX_TYPE_ID", Wetrn.WETRN, PaMapsGta.PA_MAPS_GTA, org.jooq.impl.SQLDataType.NUMERIC);
