...
public class PriGetTaxAmount extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = 1285338594;

	/**
	 * The parameter <code>WETRN.PA_MAPS_GTA.PRI_GET_TAX_AMOUNT.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_GTA.PRI_GET_TAX_AMOUNT.PMRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> PMRKT_ID = createParameter("PMRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.PA_MAPS_GTA.PRI_GET_TAX_AMOUNT.PTAX_TYPE_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_GTA.PRI_GET_TAX_AMOUNT.POFFR_PERD_ID</code>.
	 */
	 ...
	 */
	public PriGetTaxAmount() {
		super("PRI_GET_TAX_AMOUNT", Wetrn.WETRN, PaMapsGta.PA_MAPS_GTA, org.jooq.impl.SQLDataType.NUMERIC);
