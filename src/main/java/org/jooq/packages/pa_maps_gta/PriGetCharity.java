...
public class PriGetCharity extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = -1008398606;

	/**
	 * The parameter <code>WETRN.PA_MAPS_GTA.PRI_GET_CHARITY.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_GTA.PRI_GET_CHARITY.PMRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> PMRKT_ID = createParameter("PMRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.PA_MAPS_GTA.PRI_GET_CHARITY.POFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_GTA.PRI_GET_CHARITY.PPRFL_CD</code>.
	 */
	 ...
	 */
	public PriGetCharity() {
		super("PRI_GET_CHARITY", Wetrn.WETRN, PaMapsGta.PA_MAPS_GTA, org.jooq.impl.SQLDataType.NUMERIC);
