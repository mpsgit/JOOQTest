...
public class GetReassignItemsSpecific extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = 1854165777;

	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_NORMAL.GET_REASSIGN_ITEMS_SPECIFIC.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_NORMAL.GET_REASSIGN_ITEMS_SPECIFIC.P_CLSTR_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_CLSTR_ID = createParameter("P_CLSTR_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_NORMAL.GET_REASSIGN_ITEMS_SPECIFIC.P_LEAD_MRKT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_NORMAL.GET_REASSIGN_ITEMS_SPECIFIC.P_PRFL_CD</code>.
	 */
	public static final Parameter<BigDecimal> P_PRFL_CD = createParameter("P_PRFL_CD", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_NORMAL.GET_REASSIGN_ITEMS_SPECIFIC.P_PRFL_NM</code>.
	 */
	public static final Parameter<String> P_PRFL_NM = createParameter("P_PRFL_NM", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_NORMAL.GET_REASSIGN_ITEMS_SPECIFIC.P_SKU_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_SKU_ID = createParameter("P_SKU_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_NORMAL.GET_REASSIGN_ITEMS_SPECIFIC.P_SKU_NM</code>.
	 */
	public static final Parameter<String> P_SKU_NM = createParameter("P_SKU_NM", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_NORMAL.GET_REASSIGN_ITEMS_SPECIFIC.P_FSC_CD</code>.
	 */
	public static final Parameter<String> P_FSC_CD = createParameter("P_FSC_CD", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_NORMAL.GET_REASSIGN_ITEMS_SPECIFIC.P_LINE_NR</code>.
	 */
	public static final Parameter<String> P_LINE_NR = createParameter("P_LINE_NR", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_NORMAL.GET_REASSIGN_ITEMS_SPECIFIC.P_REF_PERD_ID</code>.
	 */
	public static final Parameter<String> P_REF_PERD_ID = createParameter("P_REF_PERD_ID", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * Create a new routine call instance
	 */
	public GetReassignItemsSpecific() {
		super("GET_REASSIGN_ITEMS_SPECIFIC", Wetrn.WETRN, AppLnmUkReassignNormal.APP_LNM_UK_REASSIGN_NORMAL, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
	 ...
	 */
	public void setPRefPerdId(String value) {
		setValue(P_REF_PERD_ID, value);
	}

	/**
	 * Set the <code>P_REF_PERD_ID</code> parameter to the function to be used with a {@link org.jooq.Select} statement
	 */
	public void setPRefPerdId(Field<String> field) {
		setField(P_REF_PERD_ID, field);
	}
}
