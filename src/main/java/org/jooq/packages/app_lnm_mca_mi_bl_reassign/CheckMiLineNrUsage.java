...
public class CheckMiLineNrUsage extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = 104049732;

	/**
	 * The parameter <code>WETRN.APP_LNM_MCA_MI_BL_REASSIGN.CHECK_MI_LINE_NR_USAGE.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_MCA_MI_BL_REASSIGN.CHECK_MI_LINE_NR_USAGE.P_OFFR_SKU_LINE_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_MCA_MI_BL_REASSIGN.CHECK_MI_LINE_NR_USAGE.P_LEAD_MRKT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_MCA_MI_BL_REASSIGN.CHECK_MI_LINE_NR_USAGE.P_LINE_NR</code>.
	 */
	public static final Parameter<String> P_LINE_NR = createParameter("P_LINE_NR", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_MCA_MI_BL_REASSIGN.CHECK_MI_LINE_NR_USAGE.P_OFFR_PERD_ID</code>.
	 */
	...
	public CheckMiLineNrUsage() {
		super("CHECK_MI_LINE_NR_USAGE", Wetrn.WETRN, AppLnmMcaMiBlReassign.APP_LNM_MCA_MI_BL_REASSIGN, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
