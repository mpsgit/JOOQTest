...
public class FGetData extends AbstractRoutine<Object> {

	private static final long serialVersionUID = -1423527694;

	/**
	 * The parameter <code>WETRN.REP_PROD_CONTRBN_BY_SLS_CLS.F_GET_DATA.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_PROD_CONTRBN_BY_SLS_CLS.F_GET_DATA.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.REP_PROD_CONTRBN_BY_SLS_CLS.F_GET_DATA.P_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_PROD_CONTRBN_BY_SLS_CLS.F_GET_DATA.P_INC_SUP_BUD</code>.
	 */
	public static final Parameter<String> P_INC_SUP_BUD = createParameter("P_INC_SUP_BUD", org.jooq.impl.SQLDataType.CHAR, false);

	/**
	 * The parameter <code>WETRN.REP_PROD_CONTRBN_BY_SLS_CLS.F_GET_DATA.P_INC_SLS_AID</code>.
	 */
	public static final Parameter<String> P_INC_SLS_AID = createParameter("P_INC_SLS_AID", org.jooq.impl.SQLDataType.CHAR, false);

	/**
	 * The parameter <code>WETRN.REP_PROD_CONTRBN_BY_SLS_CLS.F_GET_DATA.P_INC_CNCPT_DTL</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_PROD_CONTRBN_BY_SLS_CLS.F_GET_DATA.P_CAMPAIGN_SLS</code>.
	 */
	public static final Parameter<String> P_CAMPAIGN_SLS = createParameter("P_CAMPAIGN_SLS", org.jooq.impl.SQLDataType.CHAR, false);

	/**
	 * The parameter <code>WETRN.REP_PROD_CONTRBN_BY_SLS_CLS.F_GET_DATA.P_MIN_OFFSET</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_PROD_CONTRBN_BY_SLS_CLS.F_GET_DATA.P_MAX_OFFSET</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_PROD_CONTRBN_BY_SLS_CLS.F_GET_DATA.P_CURRENCY</code>.
	 */
	 ...
	 */
	public FGetData() {
		super("F_GET_DATA", Wetrn.WETRN, RepProdContrbnBySlsCls.REP_PROD_CONTRBN_BY_SLS_CLS, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
