...
public class FGetCydata extends AbstractRoutine<Object> {

	private static final long serialVersionUID = -881083544;

	/**
	 * The parameter <code>WETRN.REP_PROD_CONTRBN_BY_SLS_CLS.F_GET_CYDATA.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_PROD_CONTRBN_BY_SLS_CLS.F_GET_CYDATA.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.REP_PROD_CONTRBN_BY_SLS_CLS.F_GET_CYDATA.P_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_PROD_CONTRBN_BY_SLS_CLS.F_GET_CYDATA.P_CY_VER_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_CY_VER_ID = createParameter("P_CY_VER_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.REP_PROD_CONTRBN_BY_SLS_CLS.F_GET_CYDATA.P_PY_VER_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_PY_VER_ID = createParameter("P_PY_VER_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.REP_PROD_CONTRBN_BY_SLS_CLS.F_GET_CYDATA.P_CATGRY_IDS</code>.
	 */
	public static final Parameter<String> P_CATGRY_IDS = createParameter("P_CATGRY_IDS", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.REP_PROD_CONTRBN_BY_SLS_CLS.F_GET_CYDATA.P_SLS_CLS_CDS</code>.
	 */
	public static final Parameter<String> P_SLS_CLS_CDS = createParameter("P_SLS_CLS_CDS", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.REP_PROD_CONTRBN_BY_SLS_CLS.F_GET_CYDATA.P_BRND_IDS</code>.
	 */
	public static final Parameter<String> P_BRND_IDS = createParameter("P_BRND_IDS", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.REP_PROD_CONTRBN_BY_SLS_CLS.F_GET_CYDATA.P_ACC_BY_IMP_CAT</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_PROD_CONTRBN_BY_SLS_CLS.F_GET_CYDATA.P_INC_SUP_BUD</code>.
	 */
	public static final Parameter<String> P_INC_SUP_BUD = createParameter("P_INC_SUP_BUD", org.jooq.impl.SQLDataType.CHAR, false);

	/**
	 * The parameter <code>WETRN.REP_PROD_CONTRBN_BY_SLS_CLS.F_GET_CYDATA.P_INC_SLS_AID</code>.
	 */
	public static final Parameter<String> P_INC_SLS_AID = createParameter("P_INC_SLS_AID", org.jooq.impl.SQLDataType.CHAR, false);

	/**
	 * The parameter <code>WETRN.REP_PROD_CONTRBN_BY_SLS_CLS.F_GET_CYDATA.P_INC_CNCPT_DTL</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_PROD_CONTRBN_BY_SLS_CLS.F_GET_CYDATA.P_CAMPAIGN_SLS</code>.
	 */
	public static final Parameter<String> P_CAMPAIGN_SLS = createParameter("P_CAMPAIGN_SLS", org.jooq.impl.SQLDataType.CHAR, false);

	/**
	 * The parameter <code>WETRN.REP_PROD_CONTRBN_BY_SLS_CLS.F_GET_CYDATA.P_MIN_OFFSET</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_PROD_CONTRBN_BY_SLS_CLS.F_GET_CYDATA.P_MAX_OFFSET</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_PROD_CONTRBN_BY_SLS_CLS.F_GET_CYDATA.P_CURRENCY</code>.
	 */
	 ...
	 */
	public FGetCydata() {
		super("F_GET_CYDATA", Wetrn.WETRN, RepProdContrbnBySlsCls.REP_PROD_CONTRBN_BY_SLS_CLS, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));

		setReturnParameter(RETURN_VALUE);
		addInParameter(P_MRKT_ID);
		addInParameter(P_OFFR_PERD_ID);
		addInParameter(P_CY_VER_ID);
		addInParameter(P_PY_VER_ID);
	...
	/**
	 * Set the <code>P_CY_VER_ID</code> parameter IN value to the routine
	 */
	public void setPCyVerId(Number value) {
		setNumber(P_CY_VER_ID, value);
	}

	/**
	 * Set the <code>P_CY_VER_ID</code> parameter to the function to be used with a {@link org.jooq.Select} statement
	 */
	public void setPCyVerId(Field<? extends Number> field) {
		setNumber(P_CY_VER_ID, field);
	}

	/**
	 * Set the <code>P_PY_VER_ID</code> parameter IN value to the routine
	 */
	public void setPPyVerId(Number value) {
		setNumber(P_PY_VER_ID, value);
	}

	/**
	 * Set the <code>P_PY_VER_ID</code> parameter to the function to be used with a {@link org.jooq.Select} statement
	 */
	public void setPPyVerId(Field<? extends Number> field) {
		setNumber(P_PY_VER_ID, field);
	}
