...
public class FGetReportDataPy extends AbstractRoutine<Object> {

	private static final long serialVersionUID = 1705201757;

	/**
	 * The parameter <code>WETRN.REP_PROD_CONTRBN_BY_SLS_CLS.F_GET_REPORT_DATA_PY.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_PROD_CONTRBN_BY_SLS_CLS.F_GET_REPORT_DATA_PY.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.REP_PROD_CONTRBN_BY_SLS_CLS.F_GET_REPORT_DATA_PY.P_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_PROD_CONTRBN_BY_SLS_CLS.F_GET_REPORT_DATA_PY.P_INC_SUP_BUD</code>.
	 */
	public static final Parameter<String> P_INC_SUP_BUD = createParameter("P_INC_SUP_BUD", org.jooq.impl.SQLDataType.CHAR, false);

	/**
	 * The parameter <code>WETRN.REP_PROD_CONTRBN_BY_SLS_CLS.F_GET_REPORT_DATA_PY.P_INC_SLS_AID</code>.
	 */
	public static final Parameter<String> P_INC_SLS_AID = createParameter("P_INC_SLS_AID", org.jooq.impl.SQLDataType.CHAR, false);

	/**
	 * The parameter <code>WETRN.REP_PROD_CONTRBN_BY_SLS_CLS.F_GET_REPORT_DATA_PY.P_INC_CNCPT_DTL</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_PROD_CONTRBN_BY_SLS_CLS.F_GET_REPORT_DATA_PY.P_CAMPAIGN_SLS</code>.
	 */
	public static final Parameter<String> P_CAMPAIGN_SLS = createParameter("P_CAMPAIGN_SLS", org.jooq.impl.SQLDataType.CHAR, false);

	/**
	 * The parameter <code>WETRN.REP_PROD_CONTRBN_BY_SLS_CLS.F_GET_REPORT_DATA_PY.P_MIN_OFFSET</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_PROD_CONTRBN_BY_SLS_CLS.F_GET_REPORT_DATA_PY.P_MAX_OFFSET</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_PROD_CONTRBN_BY_SLS_CLS.F_GET_REPORT_DATA_PY.P_CURRENCY</code>.
	 */
	public static final Parameter<String> P_CURRENCY = createParameter("P_CURRENCY", org.jooq.impl.SQLDataType.CHAR, false);

	/**
	 * The parameter <code>WETRN.REP_PROD_CONTRBN_BY_SLS_CLS.F_GET_REPORT_DATA_PY.P_GRP_BY_BUSINESS</code>.
	 */
	 ...
	 */
	public FGetReportDataPy() {
		super("F_GET_REPORT_DATA_PY", Wetrn.WETRN, RepProdContrbnBySlsCls.REP_PROD_CONTRBN_BY_SLS_CLS, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
