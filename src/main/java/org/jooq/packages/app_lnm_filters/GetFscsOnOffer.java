...
public class GetFscsOnOffer extends AbstractRoutine<Object> {

	private static final long serialVersionUID = -1619843026;

	/**
	 * The parameter <code>WETRN.APP_LNM_FILTERS.GET_FSCS_ON_OFFER.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_FILTERS.GET_FSCS_ON_OFFER.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_FILTERS.GET_FSCS_ON_OFFER.P_OFFR_PERD_ID</code>.
	 */
	 ...
	 */
	public GetFscsOnOffer() {
		super("GET_FSCS_ON_OFFER", Wetrn.WETRN, AppLnmFilters.APP_LNM_FILTERS, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
