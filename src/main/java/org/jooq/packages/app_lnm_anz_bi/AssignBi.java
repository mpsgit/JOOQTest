 ...
 */
package org.jooq.packages.app_lnm_anz_bi;
...
import org.jooq.packages.AppLnmAnzBi;
...
public class AssignBi extends AbstractRoutine<java.lang.Void> {
	...
	private static final long serialVersionUID = -1759352629;

	/**
	 * The parameter <code>WETRN.APP_LNM_ANZ_BI.ASSIGN_BI.P_RUN_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_RUN_ID = createParameter("P_RUN_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_ANZ_BI.ASSIGN_BI.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_ANZ_BI.ASSIGN_BI.P_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_ANZ_BI.ASSIGN_BI.P_CONTINGENCY</code>.
	 */
	public static final Parameter<String> P_CONTINGENCY = createParameter("P_CONTINGENCY", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_ANZ_BI.ASSIGN_BI.P_USER_ID</code>.
	 */
	 ...
	 */
	public AssignBi() {
		super("ASSIGN_BI", Wetrn.WETRN, AppLnmAnzBi.APP_LNM_ANZ_BI);
