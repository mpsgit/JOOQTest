...
public class CopyEstimateLinks extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = 128231732;

	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.COPY_ESTIMATE_LINKS.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.COPY_ESTIMATE_LINKS.PAR_OLDOFFRID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.COPY_ESTIMATE_LINKS.PAR_NEWOFFRID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.COPY_ESTIMATE_LINKS.PAR_USER</code>.
	 */
	 ...
	 */
	public CopyEstimateLinks() {
		super("COPY_ESTIMATE_LINKS", Wetrn.WETRN, PaMapsCopy.PA_MAPS_COPY, org.jooq.impl.SQLDataType.NUMERIC);
