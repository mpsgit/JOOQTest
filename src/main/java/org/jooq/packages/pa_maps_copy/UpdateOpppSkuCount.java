...
public class UpdateOpppSkuCount extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = 828335056;

	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.UPDATE_OPPP_SKU_COUNT.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.UPDATE_OPPP_SKU_COUNT.PAR_OFFRID</code>.
	 */
	 ...
	 */
	public UpdateOpppSkuCount() {
		super("UPDATE_OPPP_SKU_COUNT", Wetrn.WETRN, PaMapsCopy.PA_MAPS_COPY, org.jooq.impl.SQLDataType.NUMERIC);
