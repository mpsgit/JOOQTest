...
public class CopyOffr extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = -1726014982;

	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.COPY_OFFR.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.COPY_OFFR.PAR_OFFRID</code>.
	 */
	public static final Parameter<BigDecimal> PAR_OFFRID = createParameter("PAR_OFFRID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.COPY_OFFR.PAR_NEWMARKETID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.COPY_OFFR.PAR_NEWOFFERPERIOD</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.COPY_OFFR.PAR_NEWVEHID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.COPY_OFFR.PAR_NEWOFFRDESC</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.COPY_OFFR.PAR_WHATIF</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.COPY_OFFR.PAR_PAGINATIONCOPY</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.COPY_OFFR.PAR_USER</code>.
	 */
	 ...
	 */
	public CopyOffr() {
		super("COPY_OFFR", Wetrn.WETRN, PaMapsCopy.PA_MAPS_COPY, org.jooq.impl.SQLDataType.NUMERIC);
