...
public class CloneOffer extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = -853190115;

	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.CLONE_OFFER.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.CLONE_OFFER.PAR_OFFRID</code>.
	 */
	public static final Parameter<BigDecimal> PAR_OFFRID = createParameter("PAR_OFFRID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.CLONE_OFFER.PAR_NEWMARKETID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.CLONE_OFFER.PAR_NEWOFFERPERIOD</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.CLONE_OFFER.PAR_NEWVEHID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.CLONE_OFFER.PAR_NEWOFFRDESC</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.CLONE_OFFER.PAR_ZEROUNITS</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.CLONE_OFFER.PAR_WHATIF</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.CLONE_OFFER.PAR_PAGINATIONCOPY</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.CLONE_OFFER.PAR_USER</code>.
	 */
	 ...
	 */
	public CloneOffer() {
		super("CLONE_OFFER", Wetrn.WETRN, PaMapsCopy.PA_MAPS_COPY, org.jooq.impl.SQLDataType.NUMERIC);
