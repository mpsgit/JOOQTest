...
public class UpdateOffrSkuCount extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = -1940649974;

	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.UPDATE_OFFR_SKU_COUNT.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.UPDATE_OFFR_SKU_COUNT.PAR_OFFRID</code>.
	 */
	 ...
	 */
	public UpdateOffrSkuCount() {
		super("UPDATE_OFFR_SKU_COUNT", Wetrn.WETRN, PaMapsCopy.PA_MAPS_COPY, org.jooq.impl.SQLDataType.NUMERIC);
