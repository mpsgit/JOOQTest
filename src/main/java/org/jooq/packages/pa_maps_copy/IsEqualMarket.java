...
public class IsEqualMarket extends AbstractRoutine<Object> {

	private static final long serialVersionUID = 1454245740;

	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.IS_EQUAL_MARKET.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.IS_EQUAL_MARKET.PAR_OLDOFFRID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.IS_EQUAL_MARKET.PAR_NEWOFFRID</code>.
	 */
	 ...
	 */
	public IsEqualMarket() {
		super("IS_EQUAL_MARKET", Wetrn.WETRN, PaMapsCopy.PA_MAPS_COPY, org.jooq.impl.DefaultDataType.getDefaultDataType("PL/SQL BOOLEAN"));
