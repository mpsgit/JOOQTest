...
public class DeleteEmptySlsCls extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = -19733244;

	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.DELETE_EMPTY_SLS_CLS.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.DELETE_EMPTY_SLS_CLS.PAR_NEWOFFERID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.DELETE_EMPTY_SLS_CLS.PAR_NEWMARKETID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.DELETE_EMPTY_SLS_CLS.PAR_NEWOFFERPERIOD</code>.
	 */
	 ...
	 */
	public DeleteEmptySlsCls() {
		super("DELETE_EMPTY_SLS_CLS", Wetrn.WETRN, PaMapsCopy.PA_MAPS_COPY, org.jooq.impl.SQLDataType.NUMERIC);
