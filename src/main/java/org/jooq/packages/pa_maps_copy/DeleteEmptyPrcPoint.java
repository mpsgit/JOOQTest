...
public class DeleteEmptyPrcPoint extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = 508474067;

	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.DELETE_EMPTY_PRC_POINT.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.DELETE_EMPTY_PRC_POINT.PAR_NEWOFFERID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.DELETE_EMPTY_PRC_POINT.PAR_NEWMARKETID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.DELETE_EMPTY_PRC_POINT.PAR_NEWOFFERPERIOD</code>.
	 */
	 ...
	 */
	public DeleteEmptyPrcPoint() {
		super("DELETE_EMPTY_PRC_POINT", Wetrn.WETRN, PaMapsCopy.PA_MAPS_COPY, org.jooq.impl.SQLDataType.NUMERIC);
