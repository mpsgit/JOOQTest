...
public class CopyOfferHeaderJava extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = 1825558568;

	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.COPY_OFFER_HEADER_JAVA.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.COPY_OFFER_HEADER_JAVA.PAR_OFFRID</code>.
	 */
	public static final Parameter<BigDecimal> PAR_OFFRID = createParameter("PAR_OFFRID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.COPY_OFFER_HEADER_JAVA.PAR_NEWMARKETID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.COPY_OFFER_HEADER_JAVA.PAR_NEWOFFERPERIOD</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.COPY_OFFER_HEADER_JAVA.PAR_NEWVEHID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.COPY_OFFER_HEADER_JAVA.PAR_NEWOFFRDESC</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.COPY_OFFER_HEADER_JAVA.PAR_WHATIF</code>.
	 */
	public static final Parameter<BigDecimal> PAR_WHATIF = createParameter("PAR_WHATIF", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.COPY_OFFER_HEADER_JAVA.PAR_PAGINATIONCOPY</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.COPY_OFFER_HEADER_JAVA.PAR_USER</code>.
	 */
	 ...
	 */
	public CopyOfferHeaderJava() {
		super("COPY_OFFER_HEADER_JAVA", Wetrn.WETRN, PaMapsCopy.PA_MAPS_COPY, org.jooq.impl.SQLDataType.NUMERIC);
