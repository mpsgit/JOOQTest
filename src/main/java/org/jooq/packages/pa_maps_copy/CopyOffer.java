...
public class CopyOffer extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = 1027628843;

	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.COPY_OFFER.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.COPY_OFFER.PAR_OFFERID</code>.
	 */
	public static final Parameter<BigDecimal> PAR_OFFERID = createParameter("PAR_OFFERID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.COPY_OFFER.PAR_NEWMARKETID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.COPY_OFFER.PAR_NEWOFFERPERIOD</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.COPY_OFFER.PAR_NEWVEHID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.COPY_OFFER.PAR_NEWOFFRDESC</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.COPY_OFFER.PAR_ZEROUNITS</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.COPY_OFFER.PAR_WHATIF</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.COPY_OFFER.PAR_PAGINATIONCOPY</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.COPY_OFFER.PAR_USER</code>.
	 */
	 ...
	 */
	public CopyOffer() {
		super("COPY_OFFER", Wetrn.WETRN, PaMapsCopy.PA_MAPS_COPY, org.jooq.impl.SQLDataType.NUMERIC);
