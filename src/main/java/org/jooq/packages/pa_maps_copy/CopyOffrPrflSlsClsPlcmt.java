...
public class CopyOffrPrflSlsClsPlcmt extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = 1323386193;

	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.COPY_OFFR_PRFL_SLS_CLS_PLCMT.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.COPY_OFFR_PRFL_SLS_CLS_PLCMT.PAR_OLDOFFRID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.COPY_OFFR_PRFL_SLS_CLS_PLCMT.PAR_NEWOFFRID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.COPY_OFFR_PRFL_SLS_CLS_PLCMT.PAR_NEWMARKETID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.COPY_OFFR_PRFL_SLS_CLS_PLCMT.PAR_NEWOFFERPERIOD</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.COPY_OFFR_PRFL_SLS_CLS_PLCMT.PAR_NEWVEHID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_COPY.COPY_OFFR_PRFL_SLS_CLS_PLCMT.PAR_USER</code>.
	 */
	 ...
	 */
	public CopyOffrPrflSlsClsPlcmt() {
		super("COPY_OFFR_PRFL_SLS_CLS_PLCMT", Wetrn.WETRN, PaMapsCopy.PA_MAPS_COPY, org.jooq.impl.SQLDataType.NUMERIC);
