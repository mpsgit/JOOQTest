...
public class GetBlmultimarketReport extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = -593966412;

	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_REPORTS.GET_BLMULTIMARKET_REPORT.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_REPORTS.GET_BLMULTIMARKET_REPORT.P_MRKT_ID_LIST</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_REPORTS.GET_BLMULTIMARKET_REPORT.P_START_PERIOD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_REPORTS.GET_BLMULTIMARKET_REPORT.P_END_PERIOD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_REPORTS.GET_BLMULTIMARKET_REPORT.P_VEH_ID_LIST</code>.
	 */
	...
	public GetBlmultimarketReport() {
		super("GET_BLMULTIMARKET_REPORT", Wetrn.WETRN, AppLnmSeaReports.APP_LNM_SEA_REPORTS, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
