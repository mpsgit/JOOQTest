...
public class SetSku extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = -911036529;

	/**
	 * The parameter <code>WETRN.APP_PRODUCT_LAUNCH.SET_SKU.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_PRODUCT_LAUNCH.SET_SKU.DATA_RECORD</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_PRODUCT_LAUNCH.SET_SKU.SKU_TABLE</code>.
	 */
	 ...
	 */
	public SetSku() {
		super("SET_SKU", Wetrn.WETRN, AppProductLaunch.APP_PRODUCT_LAUNCH, org.jooq.impl.DefaultDataType.getDefaultDataType("PL/SQL RECORD"));
