...
public class GetBireassignItems extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = 459813552;

	/**
	 * The parameter <code>WETRN.APP_LNM_SC_REASSIGN_BI_MI.GET_BIREASSIGN_ITEMS.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SC_REASSIGN_BI_MI.GET_BIREASSIGN_ITEMS.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_SC_REASSIGN_BI_MI.GET_BIREASSIGN_ITEMS.P_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SC_REASSIGN_BI_MI.GET_BIREASSIGN_ITEMS.P_SKU_ID</code>.
	 */
	...
	public GetBireassignItems() {
		super("GET_BIREASSIGN_ITEMS", Wetrn.WETRN, AppLnmScReassignBiMi.APP_LNM_SC_REASSIGN_BI_MI, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
