...
public class GetRowsBlDynamic extends AbstractRoutine<Object> {

	private static final long serialVersionUID = -1052471178;

	/**
	 * The parameter <code>WETRN.REP_MAIN.GET_ROWS_BL_DYNAMIC.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_MAIN.GET_ROWS_BL_DYNAMIC.P_MRKT_ID_LIST</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_MAIN.GET_ROWS_BL_DYNAMIC.P_FROM_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_MAIN.GET_ROWS_BL_DYNAMIC.P_TO_PERD_ID</code>.
	 */
	 ...
	 */
	public GetRowsBlDynamic() {
		super("GET_ROWS_BL_DYNAMIC", Wetrn.WETRN, RepMain.REP_MAIN, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
