...
public class GetSubclstrPerdInfo extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = -1419058922;

	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_SUBCLSTR_INFO.GET_SUBCLSTR_PERD_INFO.RETURN_VALUE</code>.
	 */
	...
	public GetSubclstrPerdInfo() {
		super("GET_SUBCLSTR_PERD_INFO", Wetrn.WETRN, AppLnmSeaSubclstrInfo.APP_LNM_SEA_SUBCLSTR_INFO, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
