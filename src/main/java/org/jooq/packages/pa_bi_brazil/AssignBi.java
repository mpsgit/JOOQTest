...
public class AssignBi extends AbstractRoutine<java.lang.Void> {
	...
	private static final long serialVersionUID = -890192802;

	/**
	 * The parameter <code>WETRN.PA_BI_BRAZIL.ASSIGN_BI.PAR_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> PAR_MRKT_ID = createParameter("PAR_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.PA_BI_BRAZIL.ASSIGN_BI.PAR_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_BI_BRAZIL.ASSIGN_BI.CONT_IND</code>.
	 */
	public static final Parameter<String> CONT_IND = createParameter("CONT_IND", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.PA_BI_BRAZIL.ASSIGN_BI.PAR_USER_ID</code>.
	 */
	 ...
	 */
	public AssignBi() {
		super("ASSIGN_BI", Wetrn.WETRN, PaBiBrazil.PA_BI_BRAZIL);
