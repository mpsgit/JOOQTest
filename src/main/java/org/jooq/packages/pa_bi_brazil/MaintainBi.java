...
public class MaintainBi extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 2018616189;

	/**
	 * The parameter <code>WETRN.PA_BI_BRAZIL.MAINTAIN_BI.PAR_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> PAR_MRKT_ID = createParameter("PAR_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.PA_BI_BRAZIL.MAINTAIN_BI.PAR_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_BI_BRAZIL.MAINTAIN_BI.ADDITIONAL_PERD</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_BI_BRAZIL.MAINTAIN_BI.PAR_USER_ID</code>.
	 */
	 ...
	 */
	public MaintainBi() {
		super("MAINTAIN_BI", Wetrn.WETRN, PaBiBrazil.PA_BI_BRAZIL);
