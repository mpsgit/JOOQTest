...
public class GetPlugUnits extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = -1941556840;

	/**
	 * The parameter <code>WETRN.REP_BUS_CONTR_CATGRY.GET_PLUG_UNITS.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_BUS_CONTR_CATGRY.GET_PLUG_UNITS.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.REP_BUS_CONTR_CATGRY.GET_PLUG_UNITS.P_VEH_ID</code>.
	 */
	public static final Parameter<String> P_VEH_ID = createParameter("P_VEH_ID", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.REP_BUS_CONTR_CATGRY.GET_PLUG_UNITS.P_FROM_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_BUS_CONTR_CATGRY.GET_PLUG_UNITS.P_TO_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_BUS_CONTR_CATGRY.GET_PLUG_UNITS.P_MIN_OFFSET</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_BUS_CONTR_CATGRY.GET_PLUG_UNITS.P_MAX_OFFSET</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_BUS_CONTR_CATGRY.GET_PLUG_UNITS.P_CATGRY_ID</code>.
	 */
	 ...
	 */
	public GetPlugUnits() {
		super("GET_PLUG_UNITS", Wetrn.WETRN, RepBusContrCatgry.REP_BUS_CONTR_CATGRY, org.jooq.impl.SQLDataType.NUMERIC);
