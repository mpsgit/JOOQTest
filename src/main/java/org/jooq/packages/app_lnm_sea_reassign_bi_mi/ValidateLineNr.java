...
public class ValidateLineNr extends AbstractRoutine<String> {
	...
	private static final long serialVersionUID = -935500330;

	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_REASSIGN_BI_MI.VALIDATE_LINE_NR.RETURN_VALUE</code>.
	 */
	public static final Parameter<String> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_REASSIGN_BI_MI.VALIDATE_LINE_NR.P_CLUSTER_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_REASSIGN_BI_MI.VALIDATE_LINE_NR.P_LEAD_MRKT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_REASSIGN_BI_MI.VALIDATE_LINE_NR.P_LINE_NR</code>.
	 */
	...
	public ValidateLineNr() {
		super("VALIDATE_LINE_NR", Wetrn.WETRN, AppLnmSeaReassignBiMi.APP_LNM_SEA_REASSIGN_BI_MI, org.jooq.impl.SQLDataType.VARCHAR);
