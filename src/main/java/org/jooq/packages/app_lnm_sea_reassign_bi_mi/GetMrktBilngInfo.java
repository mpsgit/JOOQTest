...
public class GetMrktBilngInfo extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = -1523684760;

	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_REASSIGN_BI_MI.GET_MRKT_BILNG_INFO.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_REASSIGN_BI_MI.GET_MRKT_BILNG_INFO.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_REASSIGN_BI_MI.GET_MRKT_BILNG_INFO.P_OFFR_PERD_ID</code>.
	 */
	...
	public GetMrktBilngInfo() {
		super("GET_MRKT_BILNG_INFO", Wetrn.WETRN, AppLnmSeaReassignBiMi.APP_LNM_SEA_REASSIGN_BI_MI, org.jooq.impl.DefaultDataType.getDefaultDataType("PL/SQL RECORD"));
