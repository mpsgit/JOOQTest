...
public class ModifyMiBiNr extends AbstractRoutine<java.lang.Void> {
	...
	private static final long serialVersionUID = 753781140;

	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_REASSIGN_BI_MI.MODIFY_MI_BI_NR.P_OFFR_SKU_LINE_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_REASSIGN_BI_MI.MODIFY_MI_BI_NR.P_LINE_NR_TYP_CD</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_REASSIGN_BI_MI.MODIFY_MI_BI_NR.P_LINE_NR</code>.
	 */
	public static final Parameter<String> P_LINE_NR = createParameter("P_LINE_NR", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_REASSIGN_BI_MI.MODIFY_MI_BI_NR.P_USER_ID</code>.
	 */
	 ...
	 */
	public ModifyMiBiNr() {
		super("MODIFY_MI_BI_NR", Wetrn.WETRN, AppLnmSeaReassignBiMi.APP_LNM_SEA_REASSIGN_BI_MI);
