...
public class CheckMsFscExists extends AbstractRoutine<String> {
	...
	private static final long serialVersionUID = -680899845;

	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN_FSC.CHECK_MS_FSC_EXISTS.RETURN_VALUE</code>.
	 */
	public static final Parameter<String> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN_FSC.CHECK_MS_FSC_EXISTS.P_LEAD_MRKT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN_FSC.CHECK_MS_FSC_EXISTS.P_FSC</code>.
	 */
	...
	public CheckMsFscExists() {
		super("CHECK_MS_FSC_EXISTS", Wetrn.WETRN, AppLnmSeaMsBlReassignFsc.APP_LNM_SEA_MS_BL_REASSIGN_FSC, org.jooq.impl.SQLDataType.VARCHAR);
