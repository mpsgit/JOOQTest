...
public class CheckEquMsFscUsageOcmp extends AbstractRoutine<Object> {

	private static final long serialVersionUID = 1946411875;

	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN_FSC.CHECK_EQU_MS_FSC_USAGE_OCMP.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN_FSC.CHECK_EQU_MS_FSC_USAGE_OCMP.P_OFFR_SKU_SET_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN_FSC.CHECK_EQU_MS_FSC_USAGE_OCMP.P_LEAD_MRKT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN_FSC.CHECK_EQU_MS_FSC_USAGE_OCMP.P_FSC</code>.
	 */
	public static final Parameter<String> P_FSC = createParameter("P_FSC", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN_FSC.CHECK_EQU_MS_FSC_USAGE_OCMP.P_OFFR_PERD_ID</code>.
	 */
	 ...
	 */
	public CheckEquMsFscUsageOcmp() {
		super("CHECK_EQU_MS_FSC_USAGE_OCMP", Wetrn.WETRN, AppLnmSeaMsBlReassignFsc.APP_LNM_SEA_MS_BL_REASSIGN_FSC, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
