...
public class ModifyMsFsc extends AbstractRoutine<java.lang.Void> {
	...
	private static final long serialVersionUID = -867591653;

	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN_FSC.MODIFY_MS_FSC.P_OFFR_SKU_SET_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN_FSC.MODIFY_MS_FSC.P_LEAD_MRKT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN_FSC.MODIFY_MS_FSC.P_FSC</code>.
	 */
	public static final Parameter<String> P_FSC = createParameter("P_FSC", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN_FSC.MODIFY_MS_FSC.P_USER_ID</code>.
	 */
	 ...
	 */
	public ModifyMsFsc() {
		super("MODIFY_MS_FSC", Wetrn.WETRN, AppLnmSeaMsBlReassignFsc.APP_LNM_SEA_MS_BL_REASSIGN_FSC);
