...
public class GetReassignMsByLineNr extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = -180799087;

	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN_FSC.GET_REASSIGN_MS_BY_LINE_NR.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN_FSC.GET_REASSIGN_MS_BY_LINE_NR.P_LEAD_MRKT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN_FSC.GET_REASSIGN_MS_BY_LINE_NR.P_STRT_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN_FSC.GET_REASSIGN_MS_BY_LINE_NR.P_END_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN_FSC.GET_REASSIGN_MS_BY_LINE_NR.P_SET_LINE_NR</code>.
	 */
	...
	public GetReassignMsByLineNr() {
		super("GET_REASSIGN_MS_BY_LINE_NR", Wetrn.WETRN, AppLnmSeaMsBlReassignFsc.APP_LNM_SEA_MS_BL_REASSIGN_FSC, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
