...
public class GetReassignMsAll extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = -1688890035;

	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN_FSC.GET_REASSIGN_MS_ALL.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN_FSC.GET_REASSIGN_MS_ALL.P_LEAD_MRKT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN_FSC.GET_REASSIGN_MS_ALL.P_STRT_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN_FSC.GET_REASSIGN_MS_ALL.P_END_OFFR_PERD_ID</code>.
	 */
	...
	public GetReassignMsAll() {
		super("GET_REASSIGN_MS_ALL", Wetrn.WETRN, AppLnmSeaMsBlReassignFsc.APP_LNM_SEA_MS_BL_REASSIGN_FSC, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
