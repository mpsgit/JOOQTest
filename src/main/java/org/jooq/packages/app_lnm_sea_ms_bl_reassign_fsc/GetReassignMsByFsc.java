...
public class GetReassignMsByFsc extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = -95885373;

	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN_FSC.GET_REASSIGN_MS_BY_FSC.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN_FSC.GET_REASSIGN_MS_BY_FSC.P_LEAD_MRKT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN_FSC.GET_REASSIGN_MS_BY_FSC.P_STRT_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN_FSC.GET_REASSIGN_MS_BY_FSC.P_END_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN_FSC.GET_REASSIGN_MS_BY_FSC.P_SET_FSC</code>.
	 */
	...
	public GetReassignMsByFsc() {
		super("GET_REASSIGN_MS_BY_FSC", Wetrn.WETRN, AppLnmSeaMsBlReassignFsc.APP_LNM_SEA_MS_BL_REASSIGN_FSC, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
