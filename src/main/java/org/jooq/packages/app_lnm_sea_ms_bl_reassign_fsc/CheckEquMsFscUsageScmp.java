...
public class CheckEquMsFscUsageScmp extends AbstractRoutine<Object> {

	private static final long serialVersionUID = 1440518107;

	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN_FSC.CHECK_EQU_MS_FSC_USAGE_SCMP.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN_FSC.CHECK_EQU_MS_FSC_USAGE_SCMP.P_OFFR_SKU_SET_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN_FSC.CHECK_EQU_MS_FSC_USAGE_SCMP.P_LEAD_MRKT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN_FSC.CHECK_EQU_MS_FSC_USAGE_SCMP.P_FSC</code>.
	 */
	public static final Parameter<String> P_FSC = createParameter("P_FSC", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_MS_BL_REASSIGN_FSC.CHECK_EQU_MS_FSC_USAGE_SCMP.P_OFFR_PERD_ID</code>.
	 */
	 ...
	 */
	public CheckEquMsFscUsageScmp() {
		super("CHECK_EQU_MS_FSC_USAGE_SCMP", Wetrn.WETRN, AppLnmSeaMsBlReassignFsc.APP_LNM_SEA_MS_BL_REASSIGN_FSC, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
