...
public class GetReassignMi extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = -396495187;

	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BL_MI.GET_REASSIGN_MI.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BL_MI.GET_REASSIGN_MI.P_CLUSTER_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BL_MI.GET_REASSIGN_MI.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BL_MI.GET_REASSIGN_MI.P_LEAD_MRKT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BL_MI.GET_REASSIGN_MI.P_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BL_MI.GET_REASSIGN_MI.P_SKU_ID</code>.
	 */
	...
	public GetReassignMi() {
		super("GET_REASSIGN_MI", Wetrn.WETRN, AppLnmUkReassignBlMi.APP_LNM_UK_REASSIGN_BL_MI, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
