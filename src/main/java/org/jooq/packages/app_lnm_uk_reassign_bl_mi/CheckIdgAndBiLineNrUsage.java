...
public class CheckIdgAndBiLineNrUsage extends AbstractRoutine<String> {

	private static final long serialVersionUID = -915471957;

	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BL_MI.CHECK_IDG_AND_BI_LINE_NR_USAGE.RETURN_VALUE</code>.
	 */
	public static final Parameter<String> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BL_MI.CHECK_IDG_AND_BI_LINE_NR_USAGE.P_CLUSTER_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BL_MI.CHECK_IDG_AND_BI_LINE_NR_USAGE.P_LEAD_MRKT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BL_MI.CHECK_IDG_AND_BI_LINE_NR_USAGE.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BL_MI.CHECK_IDG_AND_BI_LINE_NR_USAGE.P_OFFR_SKU_LINE_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BL_MI.CHECK_IDG_AND_BI_LINE_NR_USAGE.P_LINE_NR</code>.
	 */
	public static final Parameter<String> P_LINE_NR = createParameter("P_LINE_NR", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_UK_REASSIGN_BL_MI.CHECK_IDG_AND_BI_LINE_NR_USAGE.P_OFFR_PERD_ID</code>.
	 */
	 ...
	 */
	public CheckIdgAndBiLineNrUsage() {
		super("CHECK_IDG_AND_BI_LINE_NR_USAGE", Wetrn.WETRN, AppLnmUkReassignBlMi.APP_LNM_UK_REASSIGN_BL_MI, org.jooq.impl.SQLDataType.VARCHAR);
