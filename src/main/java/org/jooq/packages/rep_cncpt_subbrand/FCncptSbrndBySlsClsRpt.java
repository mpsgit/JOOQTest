...
public class FCncptSbrndBySlsClsRpt extends AbstractRoutine<Object> {

	private static final long serialVersionUID = -81641843;

	/**
	 * The parameter <code>WETRN.REP_CNCPT_SUBBRAND.F_CNCPT_SBRND_BY_SLS_CLS_RPT.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_CNCPT_SUBBRAND.F_CNCPT_SBRND_BY_SLS_CLS_RPT.P_REG_PRC_OFFR</code>.
	 */
	public static final Parameter<String> P_REG_PRC_OFFR = createParameter("P_REG_PRC_OFFR", org.jooq.impl.SQLDataType.CHAR, false);

	/**
	 * The parameter <code>WETRN.REP_CNCPT_SUBBRAND.F_CNCPT_SBRND_BY_SLS_CLS_RPT.P_OFFSET_MIN</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_CNCPT_SUBBRAND.F_CNCPT_SBRND_BY_SLS_CLS_RPT.P_OFFSET_MAX</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_CNCPT_SUBBRAND.F_CNCPT_SBRND_BY_SLS_CLS_RPT.P_SLS_AID</code>.
	 */
	public static final Parameter<String> P_SLS_AID = createParameter("P_SLS_AID", org.jooq.impl.SQLDataType.CHAR, false);

	/**
	 * The parameter <code>WETRN.REP_CNCPT_SUBBRAND.F_CNCPT_SBRND_BY_SLS_CLS_RPT.P_CAMPAIGN_SLS</code>.
	 */
	 ...
	 */
	public FCncptSbrndBySlsClsRpt() {
		super("F_CNCPT_SBRND_BY_SLS_CLS_RPT", Wetrn.WETRN, RepCncptSubbrand.REP_CNCPT_SUBBRAND, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
