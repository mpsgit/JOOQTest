...
public class FGetDataCy extends AbstractRoutine<Object> {

	private static final long serialVersionUID = -999842406;

	/**
	 * The parameter <code>WETRN.REP_CNCPT_SUBBRAND.F_GET_DATA_CY.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_CNCPT_SUBBRAND.F_GET_DATA_CY.P_REG_PRC_OFFR</code>.
	 */
	public static final Parameter<String> P_REG_PRC_OFFR = createParameter("P_REG_PRC_OFFR", org.jooq.impl.SQLDataType.CHAR, false);

	/**
	 * The parameter <code>WETRN.REP_CNCPT_SUBBRAND.F_GET_DATA_CY.P_MIN_OFFSET</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_CNCPT_SUBBRAND.F_GET_DATA_CY.P_MAX_OFFSET</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_CNCPT_SUBBRAND.F_GET_DATA_CY.P_SLS_AID</code>.
	 */
	public static final Parameter<String> P_SLS_AID = createParameter("P_SLS_AID", org.jooq.impl.SQLDataType.CHAR, false);

	/**
	 * The parameter <code>WETRN.REP_CNCPT_SUBBRAND.F_GET_DATA_CY.P_CAMPAIGN_SLS</code>.
	 */
	 ...
	 */
	public FGetDataCy() {
		super("F_GET_DATA_CY", Wetrn.WETRN, RepCncptSubbrand.REP_CNCPT_SUBBRAND, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
