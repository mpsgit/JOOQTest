...
public class GetOffsetsString extends AbstractRoutine<String> {
	...
	private static final long serialVersionUID = 681388211;

	/**
	 * The parameter <code>WETRN.REP_CNCPT_SUBBRAND.GET_OFFSETS_STRING.RETURN_VALUE</code>.
	 */
	public static final Parameter<String> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.REP_CNCPT_SUBBRAND.GET_OFFSETS_STRING.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.REP_CNCPT_SUBBRAND.GET_OFFSETS_STRING.P_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_CNCPT_SUBBRAND.GET_OFFSETS_STRING.P_MIN_OFFSET</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_CNCPT_SUBBRAND.GET_OFFSETS_STRING.P_MAX_OFFSET</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_CNCPT_SUBBRAND.GET_OFFSETS_STRING.P_COO</code>.
	 */
	public static final Parameter<BigDecimal> P_COO = createParameter("P_COO", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.REP_CNCPT_SUBBRAND.GET_OFFSETS_STRING.P_PERD_TYP</code>.
	 */
	...
	public GetOffsetsString() {
		super("GET_OFFSETS_STRING", Wetrn.WETRN, RepCncptSubbrand.REP_CNCPT_SUBBRAND, org.jooq.impl.SQLDataType.VARCHAR);
