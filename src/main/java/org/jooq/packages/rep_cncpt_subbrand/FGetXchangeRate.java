...
public class FGetXchangeRate extends AbstractRoutine<BigDecimal> {
	...
	private static final long serialVersionUID = 2063838465;

	/**
	 * The parameter <code>WETRN.REP_CNCPT_SUBBRAND.F_GET_XCHANGE_RATE.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.REP_CNCPT_SUBBRAND.F_GET_XCHANGE_RATE.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.REP_CNCPT_SUBBRAND.F_GET_XCHANGE_RATE.P_PERD_ID</code>.
	 */
	...
	public FGetXchangeRate() {
		super("F_GET_XCHANGE_RATE", Wetrn.WETRN, RepCncptSubbrand.REP_CNCPT_SUBBRAND, org.jooq.impl.SQLDataType.NUMERIC);
