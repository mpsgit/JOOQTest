...
public class ConcatSalesClassItem extends AbstractRoutine<String> {

	private static final long serialVersionUID = 1219376146;

	/**
	 * The parameter <code>WETRN.LOCAL_BUSINESS_REPORT.CONCAT_SALES_CLASS_ITEM.RETURN_VALUE</code>.
	 */
	public static final Parameter<String> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.LOCAL_BUSINESS_REPORT.CONCAT_SALES_CLASS_ITEM.PSKU_ID</code>.
	 */
	public static final Parameter<BigDecimal> PSKU_ID = createParameter("PSKU_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.LOCAL_BUSINESS_REPORT.CONCAT_SALES_CLASS_ITEM.VERSION_ID</code>.
	 */
	public static final Parameter<BigDecimal> VERSION_ID = createParameter("VERSION_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.LOCAL_BUSINESS_REPORT.CONCAT_SALES_CLASS_ITEM.MARKET_ID</code>.
	 */
	public static final Parameter<BigDecimal> MARKET_ID = createParameter("MARKET_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.LOCAL_BUSINESS_REPORT.CONCAT_SALES_CLASS_ITEM.PERD</code>.
	 */
	 ...
	 */
	public ConcatSalesClassItem() {
		super("CONCAT_SALES_CLASS_ITEM", Wetrn.WETRN, LocalBusinessReport.LOCAL_BUSINESS_REPORT, org.jooq.impl.SQLDataType.VARCHAR);
