...
public class EstDirectProfitItem extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = 2036271459;

	/**
	 * The parameter <code>WETRN.LOCAL_BUSINESS_REPORT.EST_DIRECT_PROFIT_ITEM.RETURN_VALUE</code>.
	 */
	 ...
	 */
	public EstDirectProfitItem() {
		super("EST_DIRECT_PROFIT_ITEM", Wetrn.WETRN, LocalBusinessReport.LOCAL_BUSINESS_REPORT, org.jooq.impl.SQLDataType.NUMERIC);
