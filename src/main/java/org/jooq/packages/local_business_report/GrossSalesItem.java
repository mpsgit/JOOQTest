...
public class GrossSalesItem extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = -526017406;

	/**
	 * The parameter <code>WETRN.LOCAL_BUSINESS_REPORT.GROSS_SALES_ITEM.RETURN_VALUE</code>.
	 */
	 ...
	 */
	public GrossSalesItem() {
		super("GROSS_SALES_ITEM", Wetrn.WETRN, LocalBusinessReport.LOCAL_BUSINESS_REPORT, org.jooq.impl.SQLDataType.NUMERIC);
