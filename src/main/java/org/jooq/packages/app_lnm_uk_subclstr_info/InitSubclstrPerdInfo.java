...
public class InitSubclstrPerdInfo extends AbstractRoutine<java.lang.Void> {
	...
	private static final long serialVersionUID = 1959203367;

	/**
	 * The parameter <code>WETRN.APP_LNM_UK_SUBCLSTR_INFO.INIT_SUBCLSTR_PERD_INFO.P_LEAD_MRKT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_UK_SUBCLSTR_INFO.INIT_SUBCLSTR_PERD_INFO.P_FROM_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_UK_SUBCLSTR_INFO.INIT_SUBCLSTR_PERD_INFO.P_TO_PERD_ID</code>.
	 */
	...
	public InitSubclstrPerdInfo() {
		super("INIT_SUBCLSTR_PERD_INFO", Wetrn.WETRN, AppLnmUkSubclstrInfo.APP_LNM_UK_SUBCLSTR_INFO);
