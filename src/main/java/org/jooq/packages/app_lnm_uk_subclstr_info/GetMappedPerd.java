...
public class GetMappedPerd extends AbstractRoutine<BigDecimal> {
	...
	private static final long serialVersionUID = -198197195;

	/**
	 * The parameter <code>WETRN.APP_LNM_UK_SUBCLSTR_INFO.GET_MAPPED_PERD.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_UK_SUBCLSTR_INFO.GET_MAPPED_PERD.P_SRC_MRKT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_UK_SUBCLSTR_INFO.GET_MAPPED_PERD.P_SRC_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_UK_SUBCLSTR_INFO.GET_MAPPED_PERD.P_TRG_MRKT_ID</code>.
	 */
	...
	public GetMappedPerd() {
		super("GET_MAPPED_PERD", Wetrn.WETRN, AppLnmUkSubclstrInfo.APP_LNM_UK_SUBCLSTR_INFO, org.jooq.impl.SQLDataType.NUMERIC);
