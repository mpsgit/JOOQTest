...
public class GetAssignedMsBl extends AbstractRoutine<Object> {

	private static final long serialVersionUID = 1134422694;

	/**
	 * The parameter <code>WETRN.APP_LNM_SC_REASSIGN_BI_MS.GET_ASSIGNED_MS_BL.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SC_REASSIGN_BI_MS.GET_ASSIGNED_MS_BL.P_OFFR_SKU_SET_ID</code>.
	 */
	 ...
	 */
	public GetAssignedMsBl() {
		super("GET_ASSIGNED_MS_BL", Wetrn.WETRN, AppLnmScReassignBiMs.APP_LNM_SC_REASSIGN_BI_MS, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
