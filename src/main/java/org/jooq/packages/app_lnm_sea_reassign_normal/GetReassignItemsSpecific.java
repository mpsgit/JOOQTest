...
public class GetReassignItemsSpecific extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = -854311066;

	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_REASSIGN_NORMAL.GET_REASSIGN_ITEMS_SPECIFIC.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_REASSIGN_NORMAL.GET_REASSIGN_ITEMS_SPECIFIC.P_LEAD_MRKT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_REASSIGN_NORMAL.GET_REASSIGN_ITEMS_SPECIFIC.P_PRFL_CD</code>.
	 */
	public static final Parameter<BigDecimal> P_PRFL_CD = createParameter("P_PRFL_CD", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_REASSIGN_NORMAL.GET_REASSIGN_ITEMS_SPECIFIC.P_PRFL_NM</code>.
	 */
	public static final Parameter<String> P_PRFL_NM = createParameter("P_PRFL_NM", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_REASSIGN_NORMAL.GET_REASSIGN_ITEMS_SPECIFIC.P_SKU_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_SKU_ID = createParameter("P_SKU_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_REASSIGN_NORMAL.GET_REASSIGN_ITEMS_SPECIFIC.P_SKU_NM</code>.
	 */
	public static final Parameter<String> P_SKU_NM = createParameter("P_SKU_NM", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_REASSIGN_NORMAL.GET_REASSIGN_ITEMS_SPECIFIC.P_FSC_CD</code>.
	 */
	public static final Parameter<String> P_FSC_CD = createParameter("P_FSC_CD", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_REASSIGN_NORMAL.GET_REASSIGN_ITEMS_SPECIFIC.P_LINE_NR</code>.
	 */
	...
	public GetReassignItemsSpecific() {
		super("GET_REASSIGN_ITEMS_SPECIFIC", Wetrn.WETRN, AppLnmSeaReassignNormal.APP_LNM_SEA_REASSIGN_NORMAL, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
