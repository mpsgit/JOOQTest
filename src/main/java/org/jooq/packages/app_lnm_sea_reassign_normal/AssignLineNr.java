...
public class AssignLineNr extends AbstractRoutine<java.lang.Void> {
	...
	private static final long serialVersionUID = 2104759854;

	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_REASSIGN_NORMAL.ASSIGN_LINE_NR.P_LEAD_MRKT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_REASSIGN_NORMAL.ASSIGN_LINE_NR.P_SKU_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_SKU_ID = createParameter("P_SKU_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_REASSIGN_NORMAL.ASSIGN_LINE_NR.P_LINE_NR</code>.
	 */
	public static final Parameter<String> P_LINE_NR = createParameter("P_LINE_NR", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_REASSIGN_NORMAL.ASSIGN_LINE_NR.P_OLDLINE_NR</code>.
	 */
	public static final Parameter<String> P_OLDLINE_NR = createParameter("P_OLDLINE_NR", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_REASSIGN_NORMAL.ASSIGN_LINE_NR.P_OLD_LINE_NR_GRP_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_REASSIGN_NORMAL.ASSIGN_LINE_NR.P_START_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_REASSIGN_NORMAL.ASSIGN_LINE_NR.P_END_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_SEA_REASSIGN_NORMAL.ASSIGN_LINE_NR.P_USER_ID</code>.
	 */
	 ...
	 */
	public AssignLineNr() {
		super("ASSIGN_LINE_NR", Wetrn.WETRN, AppLnmSeaReassignNormal.APP_LNM_SEA_REASSIGN_NORMAL);

		addInParameter(P_LEAD_MRKT_ID);
		addInParameter(P_SKU_ID);
		addInParameter(P_LINE_NR);
		addInParameter(P_OLDLINE_NR);
	...
	/**
	 * Set the <code>P_OLDLINE_NR</code> parameter IN value to the routine
	 */
	public void setPOldlineNr(String value) {
		setValue(P_OLDLINE_NR, value);
	}
