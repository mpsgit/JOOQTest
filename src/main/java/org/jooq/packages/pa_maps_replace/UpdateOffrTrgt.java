...
public class UpdateOffrTrgt extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 968758360;

	/**
	 * The parameter <code>WETRN.PA_MAPS_REPLACE.UPDATE_OFFR_TRGT.PAR_OLDOFFRID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_REPLACE.UPDATE_OFFR_TRGT.PAR_NEWOFFRID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_REPLACE.UPDATE_OFFR_TRGT.PAR_USER</code>.
	 */
	 ...
	 */
	public UpdateOffrTrgt() {
		super("UPDATE_OFFR_TRGT", Wetrn.WETRN, PaMapsReplace.PA_MAPS_REPLACE);
