...
public class AddNewConcept extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 1826186365;

	/**
	 * The parameter <code>WETRN.PA_MAPS_REPLACE.ADD_NEW_CONCEPT.PAR_OLDOFFRID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_REPLACE.ADD_NEW_CONCEPT.PAR_NEWOFFRID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_REPLACE.ADD_NEW_CONCEPT.PAR_NEWMRKTID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_REPLACE.ADD_NEW_CONCEPT.PAR_NEWPERDID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_REPLACE.ADD_NEW_CONCEPT.PAR_NEWVEHID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_REPLACE.ADD_NEW_CONCEPT.PAR_USER</code>.
	 */
	public static final Parameter<String> PAR_USER = createParameter("PAR_USER", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.PA_MAPS_REPLACE.ADD_NEW_CONCEPT.PAR_ZEROUNITS</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_REPLACE.ADD_NEW_CONCEPT.PAR_RETAINDEST</code>.
	 */
	 ...
	 */
	public AddNewConcept() {
		super("ADD_NEW_CONCEPT", Wetrn.WETRN, PaMapsReplace.PA_MAPS_REPLACE);
