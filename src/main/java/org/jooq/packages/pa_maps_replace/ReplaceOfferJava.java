...
public class ReplaceOfferJava extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = 1072805380;

	/**
	 * The parameter <code>WETRN.PA_MAPS_REPLACE.REPLACE_OFFER_JAVA.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_REPLACE.REPLACE_OFFER_JAVA.PAR_OFFERID</code>.
	 */
	public static final Parameter<BigDecimal> PAR_OFFERID = createParameter("PAR_OFFERID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.PA_MAPS_REPLACE.REPLACE_OFFER_JAVA.PAR_NEWOFFRID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_REPLACE.REPLACE_OFFER_JAVA.PAR_NEWMARKETID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_REPLACE.REPLACE_OFFER_JAVA.PAR_NEWOFFERPERIOD</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_REPLACE.REPLACE_OFFER_JAVA.PAR_NEWVEHID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_REPLACE.REPLACE_OFFER_JAVA.PAR_ZEROUNITS</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_REPLACE.REPLACE_OFFER_JAVA.PAR_WHATIF</code>.
	 */
	public static final Parameter<BigDecimal> PAR_WHATIF = createParameter("PAR_WHATIF", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.PA_MAPS_REPLACE.REPLACE_OFFER_JAVA.PAR_RETAINDEST</code>.
	 */
	public static final Parameter<BigDecimal> PAR_RETAINDEST = createParameter("PAR_RETAINDEST", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.PA_MAPS_REPLACE.REPLACE_OFFER_JAVA.PAR_USER</code>.
	 */
	 ...
	 */
	public ReplaceOfferJava() {
		super("REPLACE_OFFER_JAVA", Wetrn.WETRN, PaMapsReplace.PA_MAPS_REPLACE, org.jooq.impl.SQLDataType.NUMERIC);
	 ...
	 */
	public void setParRetaindest(Number value) {
		setNumber(PAR_RETAINDEST, value);
	}

	/**
	 * Set the <code>PAR_RETAINDEST</code> parameter to the function to be used with a {@link org.jooq.Select} statement
	 */
	public void setParRetaindest(Field<? extends Number> field) {
		setNumber(PAR_RETAINDEST, field);
	}
