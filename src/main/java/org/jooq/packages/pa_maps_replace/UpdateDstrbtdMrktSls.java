...
public class UpdateDstrbtdMrktSls extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 1055280416;

	/**
	 * The parameter <code>WETRN.PA_MAPS_REPLACE.UPDATE_DSTRBTD_MRKT_SLS.PAR_OLDOFFRID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_REPLACE.UPDATE_DSTRBTD_MRKT_SLS.PAR_NEWOFFRID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_REPLACE.UPDATE_DSTRBTD_MRKT_SLS.PAR_USER</code>.
	 */
	public static final Parameter<String> PAR_USER = createParameter("PAR_USER", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.PA_MAPS_REPLACE.UPDATE_DSTRBTD_MRKT_SLS.PAR_ZEROUNITS</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_REPLACE.UPDATE_DSTRBTD_MRKT_SLS.PAR_WHATIF</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_REPLACE.UPDATE_DSTRBTD_MRKT_SLS.PAR_RETAINDEST</code>.
	 */
	 ...
	 */
	public UpdateDstrbtdMrktSls() {
		super("UPDATE_DSTRBTD_MRKT_SLS", Wetrn.WETRN, PaMapsReplace.PA_MAPS_REPLACE);
