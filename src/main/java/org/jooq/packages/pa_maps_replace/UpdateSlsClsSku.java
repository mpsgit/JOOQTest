...
public class UpdateSlsClsSku extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 1172236056;

	/**
	 * The parameter <code>WETRN.PA_MAPS_REPLACE.UPDATE_SLS_CLS_SKU.PAR_OLDOFFRID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_REPLACE.UPDATE_SLS_CLS_SKU.PAR_NEWOFFRID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_REPLACE.UPDATE_SLS_CLS_SKU.PAR_USER</code>.
	 */
	 ...
	 */
	public UpdateSlsClsSku() {
		super("UPDATE_SLS_CLS_SKU", Wetrn.WETRN, PaMapsReplace.PA_MAPS_REPLACE);
