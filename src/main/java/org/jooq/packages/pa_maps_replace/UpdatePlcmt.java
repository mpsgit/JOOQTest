...
public class UpdatePlcmt extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 2103633272;

	/**
	 * The parameter <code>WETRN.PA_MAPS_REPLACE.UPDATE_PLCMT.PAR_OLDOFFRID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_REPLACE.UPDATE_PLCMT.PAR_NEWOFFRID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_MAPS_REPLACE.UPDATE_PLCMT.PAR_USER</code>.
	 */
	 ...
	 */
	public UpdatePlcmt() {
		super("UPDATE_PLCMT", Wetrn.WETRN, PaMapsReplace.PA_MAPS_REPLACE);
