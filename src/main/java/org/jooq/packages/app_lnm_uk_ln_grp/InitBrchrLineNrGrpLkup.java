...
public class InitBrchrLineNrGrpLkup extends AbstractRoutine<java.lang.Void> {
	...
	private static final long serialVersionUID = 1352486066;

	/**
	 * The parameter <code>WETRN.APP_LNM_UK_LN_GRP.INIT_BRCHR_LINE_NR_GRP_LKUP.P_CLSTR_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_CLSTR_ID = createParameter("P_CLSTR_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_UK_LN_GRP.INIT_BRCHR_LINE_NR_GRP_LKUP.P_LEAD_MRKT_ID</code>.
	 */
	...
	public InitBrchrLineNrGrpLkup() {
		super("INIT_BRCHR_LINE_NR_GRP_LKUP", Wetrn.WETRN, AppLnmUkLnGrp.APP_LNM_UK_LN_GRP);
