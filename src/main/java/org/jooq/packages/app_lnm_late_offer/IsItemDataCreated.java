...
public class IsItemDataCreated extends AbstractRoutine<String> {

	private static final long serialVersionUID = 740634462;

	/**
	 * The parameter <code>WETRN.APP_LNM_LATE_OFFER.IS_ITEM_DATA_CREATED.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_LATE_OFFER.IS_ITEM_DATA_CREATED.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_LATE_OFFER.IS_ITEM_DATA_CREATED.P_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_LATE_OFFER.IS_ITEM_DATA_CREATED.P_CONTINGENCY_IND</code>.
	 */
	 ...
	 */
	public IsItemDataCreated() {
		super("IS_ITEM_DATA_CREATED", Wetrn.WETRN, AppLnmLateOffer.APP_LNM_LATE_OFFER, org.jooq.impl.SQLDataType.CHAR.length(1));
