...
public class GetMsPymtTyp extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = -1607410669;

	/**
	 * The parameter <code>WETRN.APP_LNM_LATE_OFFER.GET_MS_PYMT_TYP.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_LATE_OFFER.GET_MS_PYMT_TYP.P_OFFR_SKU_SET_ID</code>.
	 */
	 ...
	 */
	public GetMsPymtTyp() {
		super("GET_MS_PYMT_TYP", Wetrn.WETRN, AppLnmLateOffer.APP_LNM_LATE_OFFER, org.jooq.impl.SQLDataType.NUMERIC);
