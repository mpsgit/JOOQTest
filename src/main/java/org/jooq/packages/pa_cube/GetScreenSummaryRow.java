...
public class GetScreenSummaryRow extends AbstractRoutine<ObjProductPricingRecord> {

	private static final long serialVersionUID = 1177879463;

	/**
	 * The parameter <code>WETRN.PA_CUBE.GET_SCREEN_SUMMARY_ROW.RETURN_VALUE</code>.
	 */
	public static final Parameter<ObjProductPricingRecord> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.udt.ObjProductPricing.OBJ_PRODUCT_PRICING.getDataType(), false);

	/**
	 * The parameter <code>WETRN.PA_CUBE.GET_SCREEN_SUMMARY_ROW.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.PA_CUBE.GET_SCREEN_SUMMARY_ROW.P_TRGT_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_CUBE.GET_SCREEN_SUMMARY_ROW.P_STRT_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.PA_CUBE.GET_SCREEN_SUMMARY_ROW.P_SKU_ID</code>.
	 */
	 ...
	 */
	public GetScreenSummaryRow() {
		super("GET_SCREEN_SUMMARY_ROW", Wetrn.WETRN, PaCube.PA_CUBE, org.jooq.udt.ObjProductPricing.OBJ_PRODUCT_PRICING.getDataType());
