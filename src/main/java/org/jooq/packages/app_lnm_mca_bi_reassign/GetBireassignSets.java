...
public class GetBireassignSets extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = -1110164373;

	/**
	 * The parameter <code>WETRN.APP_LNM_MCA_BI_REASSIGN.GET_BIREASSIGN_SETS.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_MCA_BI_REASSIGN.GET_BIREASSIGN_SETS.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_MCA_BI_REASSIGN.GET_BIREASSIGN_SETS.P_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_MCA_BI_REASSIGN.GET_BIREASSIGN_SETS.P_FSC_CD</code>.
	 */
	...
	public GetBireassignSets() {
		super("GET_BIREASSIGN_SETS", Wetrn.WETRN, AppLnmMcaBiReassign.APP_LNM_MCA_BI_REASSIGN, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
