...
public class CheckMiBilngLineNrUsage extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = 1047921864;

	/**
	 * The parameter <code>WETRN.APP_LNM_MCA_BI_REASSIGN.CHECK_MI_BILNG_LINE_NR_USAGE.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_MCA_BI_REASSIGN.CHECK_MI_BILNG_LINE_NR_USAGE.P_OFFR_SKU_LINE_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_MCA_BI_REASSIGN.CHECK_MI_BILNG_LINE_NR_USAGE.P_LEAD_MRKT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_MCA_BI_REASSIGN.CHECK_MI_BILNG_LINE_NR_USAGE.P_LINE_NR</code>.
	 */
	public static final Parameter<String> P_LINE_NR = createParameter("P_LINE_NR", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>WETRN.APP_LNM_MCA_BI_REASSIGN.CHECK_MI_BILNG_LINE_NR_USAGE.P_OFFR_PERD_ID</code>.
	 */
	...
	public CheckMiBilngLineNrUsage() {
		super("CHECK_MI_BILNG_LINE_NR_USAGE", Wetrn.WETRN, AppLnmMcaBiReassign.APP_LNM_MCA_BI_REASSIGN, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
