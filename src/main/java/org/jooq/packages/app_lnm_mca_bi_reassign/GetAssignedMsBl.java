...
public class GetAssignedMsBl extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = -159033980;

	/**
	 * The parameter <code>WETRN.APP_LNM_MCA_BI_REASSIGN.GET_ASSIGNED_MS_BL.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_MCA_BI_REASSIGN.GET_ASSIGNED_MS_BL.P_OFFR_SKU_SET_ID</code>.
	 */
	...
	public GetAssignedMsBl() {
		super("GET_ASSIGNED_MS_BL", Wetrn.WETRN, AppLnmMcaBiReassign.APP_LNM_MCA_BI_REASSIGN, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
