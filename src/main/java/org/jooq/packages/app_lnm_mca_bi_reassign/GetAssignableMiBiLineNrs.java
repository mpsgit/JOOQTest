...
public class GetAssignableMiBiLineNrs extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = -1559122821;

	/**
	 * The parameter <code>WETRN.APP_LNM_MCA_BI_REASSIGN.GET_ASSIGNABLE_MI_BI_LINE_NRS.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_MCA_BI_REASSIGN.GET_ASSIGNABLE_MI_BI_LINE_NRS.P_OFFR_SKU_LINE_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_MCA_BI_REASSIGN.GET_ASSIGNABLE_MI_BI_LINE_NRS.P_LINE_NR_GRP_ID</code>.
	 */
	...
	public GetAssignableMiBiLineNrs() {
		super("GET_ASSIGNABLE_MI_BI_LINE_NRS", Wetrn.WETRN, AppLnmMcaBiReassign.APP_LNM_MCA_BI_REASSIGN, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
