...
public class SHistCtgryCamp extends AbstractRoutine<java.lang.Void> {
	...
	private static final long serialVersionUID = 1588983354;

	/**
	 * The parameter <code>WETRN.TRND_ALOCTN.S_HIST_CTGRY_CAMP.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.TRND_ALOCTN.S_HIST_CTGRY_CAMP.P_SLS_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.TRND_ALOCTN.S_HIST_CTGRY_CAMP.P_CTGRY_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_CTGRY_ID = createParameter("P_CTGRY_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.TRND_ALOCTN.S_HIST_CTGRY_CAMP.P_REF_SLS_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.TRND_ALOCTN.S_HIST_CTGRY_CAMP.P_REF_OFFR_PERD_ID</code>.
	 */
	...
	public SHistCtgryCamp() {
		super("S_HIST_CTGRY_CAMP", Wetrn.WETRN, TrndAloctn.TRND_ALOCTN);
