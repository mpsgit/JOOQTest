...
public class ProcsMultmtch extends AbstractRoutine<java.lang.Void> {
	...
	private static final long serialVersionUID = 2142193814;

	/**
	 * The parameter <code>WETRN.TRND_ALOCTN.PROCS_MULTMTCH.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.TRND_ALOCTN.PROCS_MULTMTCH.P_SLS_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.TRND_ALOCTN.PROCS_MULTMTCH.P_SLS_TYP_ID</code>.
	 */
	...
	public ProcsMultmtch() {
		super("PROCS_MULTMTCH", Wetrn.WETRN, TrndAloctn.TRND_ALOCTN);
