...
public class ClcCatgryTrendSls extends AbstractRoutine<java.lang.Void> {
	...
	private static final long serialVersionUID = 1055640494;

	/**
	 * The parameter <code>WETRN.TRND_ALOCTN.CLC_CATGRY_TREND_SLS.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.TRND_ALOCTN.CLC_CATGRY_TREND_SLS.P_SLS_PERD_ID</code>.
	 */
	...
	public ClcCatgryTrendSls() {
		super("CLC_CATGRY_TREND_SLS", Wetrn.WETRN, TrndAloctn.TRND_ALOCTN);
