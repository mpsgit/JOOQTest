...
public class ClcCatgrySls extends AbstractRoutine<java.lang.Void> {
	...
	private static final long serialVersionUID = -2142446410;

	/**
	 * The parameter <code>WETRN.TRND_ALOCTN.CLC_CATGRY_SLS.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.TRND_ALOCTN.CLC_CATGRY_SLS.P_SLS_PERD_ID</code>.
	 */
	 ...
	 */
	public ClcCatgrySls() {
		super("CLC_CATGRY_SLS", Wetrn.WETRN, TrndAloctn.TRND_ALOCTN);
