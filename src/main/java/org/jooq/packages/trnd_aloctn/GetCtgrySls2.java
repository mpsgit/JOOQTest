...
public class GetCtgrySls2 extends AbstractRoutine<Object> {

	private static final long serialVersionUID = -1956264000;
	...
	/**
	 * The parameter <code>WETRN.TRND_ALOCTN.GET_CTGRY_SLS.P_SLS_TYP_ID2</code>.
	 */
	public static final Parameter<BigDecimal> P_SLS_TYP_ID2 = createParameter("P_SLS_TYP_ID2", org.jooq.impl.SQLDataType.NUMERIC, false);
	...
	/**
	 * Set the <code>P_SLS_TYP_ID2</code> parameter IN value to the routine
	 */
	public void setPSlsTypId2(Number value) {
		setNumber(P_SLS_TYP_ID2, value);
	}

	/**
	 * Set the <code>P_SLS_TYP_ID2</code> parameter to the function to be used with a {@link org.jooq.Select} statement
	 */
	public void setPSlsTypId2(Field<? extends Number> field) {
		setNumber(P_SLS_TYP_ID2, field);
	}
}
