...
public class RunTrendAloctn extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 1652148819;

	/**
	 * The parameter <code>WETRN.TRND_ALOCTN.RUN_TREND_ALOCTN.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.TRND_ALOCTN.RUN_TREND_ALOCTN.P_SLS_PERD_ID</code>.
	 */
	 ...
	 */
	public RunTrendAloctn() {
		super("RUN_TREND_ALOCTN", Wetrn.WETRN, TrndAloctn.TRND_ALOCTN);
