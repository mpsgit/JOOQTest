...
public class SaveTrendSls extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 191596753;

	/**
	 * The parameter <code>WETRN.TRND_ALOCTN.SAVE_TREND_SLS.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.TRND_ALOCTN.SAVE_TREND_SLS.P_SLS_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.TRND_ALOCTN.SAVE_TREND_SLS.P_SLS_TYPE_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.TRND_ALOCTN.SAVE_TREND_SLS.P_DAY_NUM</code>.
	 */
	 ...
	 */
	public SaveTrendSls() {
		super("SAVE_TREND_SLS", Wetrn.WETRN, TrndAloctn.TRND_ALOCTN);
