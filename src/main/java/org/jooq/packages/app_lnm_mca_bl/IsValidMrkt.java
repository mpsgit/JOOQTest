...
public class IsValidMrkt extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = -1378651427;

	/**
	 * The parameter <code>WETRN.APP_LNM_MCA_BL.IS_VALID_MRKT.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_MCA_BL.IS_VALID_MRKT.P_MRKT_ID</code>.
	 */
	 ...
	 */
	public IsValidMrkt() {
		super("IS_VALID_MRKT", Wetrn.WETRN, AppLnmMcaBl.APP_LNM_MCA_BL, org.jooq.impl.SQLDataType.NUMERIC);
