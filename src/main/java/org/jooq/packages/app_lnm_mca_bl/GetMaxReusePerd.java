...
public class GetMaxReusePerd extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = -476089783;

	/**
	 * The parameter <code>WETRN.APP_LNM_MCA_BL.GET_MAX_REUSE_PERD.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_MCA_BL.GET_MAX_REUSE_PERD.P_LINE_NR_TYP_ID</code>.
	 */
	 ...
	 */
	public GetMaxReusePerd() {
		super("GET_MAX_REUSE_PERD", Wetrn.WETRN, AppLnmMcaBl.APP_LNM_MCA_BL, org.jooq.impl.SQLDataType.NUMERIC);
