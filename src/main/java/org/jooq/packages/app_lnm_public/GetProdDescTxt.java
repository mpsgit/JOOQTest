...
public class GetProdDescTxt extends AbstractRoutine<String> {

	private static final long serialVersionUID = -1408431752;

	/**
	 * The parameter <code>WETRN.APP_LNM_PUBLIC.GET_PROD_DESC_TXT.RETURN_VALUE</code>.
	 */
	 ...
	 */
	public GetProdDescTxt() {
		super("GET_PROD_DESC_TXT", Wetrn.WETRN, AppLnmPublic.APP_LNM_PUBLIC, org.jooq.impl.SQLDataType.VARCHAR.length(100));
