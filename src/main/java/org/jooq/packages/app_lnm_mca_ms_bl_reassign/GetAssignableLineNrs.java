...
public class GetAssignableLineNrs extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = -346472682;

	/**
	 * The parameter <code>WETRN.APP_LNM_MCA_MS_BL_REASSIGN.GET_ASSIGNABLE_LINE_NRS.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_MCA_MS_BL_REASSIGN.GET_ASSIGNABLE_LINE_NRS.P_OFFR_SKU_SET_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_MCA_MS_BL_REASSIGN.GET_ASSIGNABLE_LINE_NRS.P_LINE_NR_TYP_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_MCA_MS_BL_REASSIGN.GET_ASSIGNABLE_LINE_NRS.P_LINE_NR_GRP_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_MCA_MS_BL_REASSIGN.GET_ASSIGNABLE_LINE_NRS.P_SELECTED_NUMBERS</code>.
	 */
	...
	public GetAssignableLineNrs() {
		super("GET_ASSIGNABLE_LINE_NRS", Wetrn.WETRN, AppLnmMcaMsBlReassign.APP_LNM_MCA_MS_BL_REASSIGN, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
