...
public class GetReassignMsByLineNr extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = 259082598;

	/**
	 * The parameter <code>WETRN.APP_LNM_MCA_MS_BL_REASSIGN.GET_REASSIGN_MS_BY_LINE_NR.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_MCA_MS_BL_REASSIGN.GET_REASSIGN_MS_BY_LINE_NR.P_LEAD_MRKT_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_MCA_MS_BL_REASSIGN.GET_REASSIGN_MS_BY_LINE_NR.P_STRT_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_MCA_MS_BL_REASSIGN.GET_REASSIGN_MS_BY_LINE_NR.P_END_OFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.APP_LNM_MCA_MS_BL_REASSIGN.GET_REASSIGN_MS_BY_LINE_NR.P_SET_LINE_NR</code>.
	 */
	...
	public GetReassignMsByLineNr() {
		super("GET_REASSIGN_MS_BY_LINE_NR", Wetrn.WETRN, AppLnmMcaMsBlReassign.APP_LNM_MCA_MS_BL_REASSIGN, org.jooq.impl.DefaultDataType.getDefaultDataType("TABLE"));
