...
public class PAddAddRegPrcItems extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 350310185;

	/**
	 * The parameter <code>WETRN.CPY_OFFR.P_ADD_ADD_REG_PRC_ITEMS.P_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> P_MRKT_ID = createParameter("P_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.CPY_OFFR.P_ADD_ADD_REG_PRC_ITEMS.P_OFFR_PERD_ID</code>.
	 */
	 ...
	 */
	public PAddAddRegPrcItems() {
		super("P_ADD_ADD_REG_PRC_ITEMS", Wetrn.WETRN, CpyOffr.CPY_OFFR);
