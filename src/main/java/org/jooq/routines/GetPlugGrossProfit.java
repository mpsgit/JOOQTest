...
public class GetPlugGrossProfit extends AbstractRoutine<BigDecimal> {
	...
	private static final long serialVersionUID = 1606297764;

	/**
	 * The parameter <code>WETRN.GET_PLUG_GROSS_PROFIT.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.GET_PLUG_GROSS_PROFIT.TO_OFFER_PERIOD_ID</code>.
	 */
	...
	public GetPlugGrossProfit() {
		super("GET_PLUG_GROSS_PROFIT", Wetrn.WETRN, org.jooq.impl.SQLDataType.NUMERIC);
