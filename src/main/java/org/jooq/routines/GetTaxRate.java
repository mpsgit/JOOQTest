...
public class GetTaxRate extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = 1916598126;

	/**
	 * The parameter <code>WETRN.GET_TAX_RATE.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.GET_TAX_RATE.POFFR_PERD_ID</code>.
	 */
	 ...
	 */
	public GetTaxRate() {
		super("GET_TAX_RATE", Wetrn.WETRN, org.jooq.impl.SQLDataType.NUMERIC);
