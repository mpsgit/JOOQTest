...
public class GetMsLineNrTypId extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = 2017813974;

	/**
	 * The parameter <code>WETRN.GET_MS_LINE_NR_TYP_ID.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.GET_MS_LINE_NR_TYP_ID.P_SET_ID</code>.
	 */
	 ...
	 */
	public GetMsLineNrTypId() {
		super("GET_MS_LINE_NR_TYP_ID", Wetrn.WETRN, org.jooq.impl.SQLDataType.NUMERIC);
