...
public class GetPlugUnits extends AbstractRoutine<BigDecimal> {
	...
	private static final long serialVersionUID = 708270296;

	/**
	 * The parameter <code>WETRN.GET_PLUG_UNITS.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.GET_PLUG_UNITS.TO_OFFER_PERIOD_ID</code>.
	 */
	 ...
	 */
	public GetPlugUnits() {
		super("GET_PLUG_UNITS", Wetrn.WETRN, org.jooq.impl.SQLDataType.NUMERIC);
