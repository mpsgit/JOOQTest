...
public class GetPlugProfitVerAllCat extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = 301291472;

	/**
	 * The parameter <code>WETRN.GET_PLUG_PROFIT_VER_ALL_CAT.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.GET_PLUG_PROFIT_VER_ALL_CAT.TO_OFFER_PERIOD_ID</code>.
	 */
	 ...
	 */
	public GetPlugProfitVerAllCat() {
		super("GET_PLUG_PROFIT_VER_ALL_CAT", Wetrn.WETRN, org.jooq.impl.SQLDataType.NUMERIC);
