...
public class GetPlugProfitAllCatUsc extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = -644763613;

	/**
	 * The parameter <code>WETRN.GET_PLUG_PROFIT_ALL_CAT_USC.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.GET_PLUG_PROFIT_ALL_CAT_USC.TO_OFFER_PERIOD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.GET_PLUG_PROFIT_ALL_CAT_USC.MIN_OFFSET</code>.
	 */
	public static final Parameter<BigDecimal> MIN_OFFSET = createParameter("MIN_OFFSET", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.GET_PLUG_PROFIT_ALL_CAT_USC.MAX_OFFSET</code>.
	 */
	 ...
	 */
	public GetPlugProfitAllCatUsc() {
		super("GET_PLUG_PROFIT_ALL_CAT_USC", Wetrn.WETRN, org.jooq.impl.SQLDataType.NUMERIC);
