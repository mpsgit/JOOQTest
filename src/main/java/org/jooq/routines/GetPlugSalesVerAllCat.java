...
public class GetPlugSalesVerAllCat extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = -1815683312;

	/**
	 * The parameter <code>WETRN.GET_PLUG_SALES_VER_ALL_CAT.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.GET_PLUG_SALES_VER_ALL_CAT.TO_OFFER_PERIOD_ID</code>.
	 */
	 ...
	 */
	public GetPlugSalesVerAllCat() {
		super("GET_PLUG_SALES_VER_ALL_CAT", Wetrn.WETRN, org.jooq.impl.SQLDataType.NUMERIC);
