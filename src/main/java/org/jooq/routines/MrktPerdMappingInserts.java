...
public class MrktPerdMappingInserts extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = -1068990206;

	/**
	 * The parameter <code>WETRN.MRKT_PERD_MAPPING_INSERTS.V_MRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> V_MRKT_ID = createParameter("V_MRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.MRKT_PERD_MAPPING_INSERTS.V_PERD_ID</code>.
	 */
	 ...
	 */
	public MrktPerdMappingInserts() {
		super("MRKT_PERD_MAPPING_INSERTS", Wetrn.WETRN);
