...
public class GetEqualSetSkuidNrfor extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = -1942518557;

	/**
	 * The parameter <code>WETRN.GET_EQUAL_SET_SKUID_NRFOR.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.GET_EQUAL_SET_SKUID_NRFOR.T_SET_ID</code>.
	 */
	public static final Parameter<BigDecimal> T_SET_ID = createParameter("T_SET_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.GET_EQUAL_SET_SKUID_NRFOR.S_SET_ID</code>.
	 */
	 ...
	 */
	public GetEqualSetSkuidNrfor() {
		super("GET_EQUAL_SET_SKUID_NRFOR", Wetrn.WETRN, org.jooq.impl.SQLDataType.NUMERIC);
