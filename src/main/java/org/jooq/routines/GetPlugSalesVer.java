...
public class GetPlugSalesVer extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = -486363079;

	/**
	 * The parameter <code>WETRN.GET_PLUG_SALES_VER.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.GET_PLUG_SALES_VER.TO_OFFER_PERIOD_ID</code>.
	 */
	 ...
	 */
	public GetPlugSalesVer() {
		super("GET_PLUG_SALES_VER", Wetrn.WETRN, org.jooq.impl.SQLDataType.NUMERIC);
