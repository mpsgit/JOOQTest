...
public class GetPlugProfVerAllCatUsc extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = 499388913;

	/**
	 * The parameter <code>WETRN.GET_PLUG_PROF_VER_ALL_CAT_USC.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.GET_PLUG_PROF_VER_ALL_CAT_USC.TO_OFFER_PERIOD_ID</code>.
	 */
	 ...
	 */
	public GetPlugProfVerAllCatUsc() {
		super("GET_PLUG_PROF_VER_ALL_CAT_USC", Wetrn.WETRN, org.jooq.impl.SQLDataType.NUMERIC);
