...
public class GetPlugUnitsVerAllCat extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = 645765025;

	/**
	 * The parameter <code>WETRN.GET_PLUG_UNITS_VER_ALL_CAT.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.GET_PLUG_UNITS_VER_ALL_CAT.TO_OFFER_PERIOD_ID</code>.
	 */
	 ...
	 */
	public GetPlugUnitsVerAllCat() {
		super("GET_PLUG_UNITS_VER_ALL_CAT", Wetrn.WETRN, org.jooq.impl.SQLDataType.NUMERIC);
