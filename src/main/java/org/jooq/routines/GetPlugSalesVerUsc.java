...
public class GetPlugSalesVerUsc extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = -1453832835;

	/**
	 * The parameter <code>WETRN.GET_PLUG_SALES_VER_USC.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.GET_PLUG_SALES_VER_USC.TO_OFFER_PERIOD_ID</code>.
	 */
	 ...
	 */
	public GetPlugSalesVerUsc() {
		super("GET_PLUG_SALES_VER_USC", Wetrn.WETRN, org.jooq.impl.SQLDataType.NUMERIC);
