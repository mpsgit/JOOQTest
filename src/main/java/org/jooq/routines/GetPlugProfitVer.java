...
public class GetPlugProfitVer extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = 1253615795;

	/**
	 * The parameter <code>WETRN.GET_PLUG_PROFIT_VER.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.GET_PLUG_PROFIT_VER.TO_OFFER_PERIOD_ID</code>.
	 */
	 ...
	 */
	public GetPlugProfitVer() {
		super("GET_PLUG_PROFIT_VER", Wetrn.WETRN, org.jooq.impl.SQLDataType.NUMERIC);
