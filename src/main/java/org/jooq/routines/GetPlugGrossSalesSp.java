...
public class GetPlugGrossSalesSp extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = 1965231845;

	/**
	 * The parameter <code>WETRN.GET_PLUG_GROSS_SALES_SP.RETURN_VALUE</code>.
	 */
	 ...
	 */
	public GetPlugGrossSalesSp() {
		super("GET_PLUG_GROSS_SALES_SP", Wetrn.WETRN, org.jooq.impl.SQLDataType.NUMERIC);
