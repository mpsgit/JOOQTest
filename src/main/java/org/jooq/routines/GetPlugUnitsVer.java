...
public class GetPlugUnitsVer extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = 977383557;

	/**
	 * The parameter <code>WETRN.GET_PLUG_UNITS_VER.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.GET_PLUG_UNITS_VER.TO_OFFER_PERIOD_ID</code>.
	 */
	 ...
	 */
	public GetPlugUnitsVer() {
		super("GET_PLUG_UNITS_VER", Wetrn.WETRN, org.jooq.impl.SQLDataType.NUMERIC);
