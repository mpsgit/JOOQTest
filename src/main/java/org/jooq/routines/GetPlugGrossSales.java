...
public class GetPlugGrossSales extends AbstractRoutine<BigDecimal> {
	...
	private static final long serialVersionUID = 346416550;

	/**
	 * The parameter <code>WETRN.GET_PLUG_GROSS_SALES.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.GET_PLUG_GROSS_SALES.TO_OFFER_PERIOD_ID</code>.
	 */
	...
	public GetPlugGrossSales() {
		super("GET_PLUG_GROSS_SALES", Wetrn.WETRN, org.jooq.impl.SQLDataType.NUMERIC);
