...
public class GetDefaultTaxTypeId extends AbstractRoutine<BigDecimal> {
	...
	private static final long serialVersionUID = -361477578;

	/**
	 * The parameter <code>WETRN.GET_DEFAULT_TAX_TYPE_ID.RETURN_VALUE</code>.
	 */
	...
	public GetDefaultTaxTypeId() {
		super("GET_DEFAULT_TAX_TYPE_ID", Wetrn.WETRN, org.jooq.impl.SQLDataType.NUMERIC);
