...
public class GetPlugGrossSalesUsc extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = -1377162700;

	/**
	 * The parameter <code>WETRN.GET_PLUG_GROSS_SALES_USC.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.GET_PLUG_GROSS_SALES_USC.TO_OFFER_PERIOD_ID</code>.
	 */
	 ...
	 */
	public GetPlugGrossSalesUsc() {
		super("GET_PLUG_GROSS_SALES_USC", Wetrn.WETRN, org.jooq.impl.SQLDataType.NUMERIC);
