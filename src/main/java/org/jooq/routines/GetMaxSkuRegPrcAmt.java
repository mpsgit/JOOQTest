...
public class GetMaxSkuRegPrcAmt extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = 1888499570;

	/**
	 * The parameter <code>WETRN.GET_MAX_SKU_REG_PRC_AMT.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.GET_MAX_SKU_REG_PRC_AMT.PMRKT_ID</code>.
	 */
	public static final Parameter<BigDecimal> PMRKT_ID = createParameter("PMRKT_ID", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.GET_MAX_SKU_REG_PRC_AMT.POFFR_PERD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.GET_MAX_SKU_REG_PRC_AMT.PPRFL_CD</code>.
	 */
	 ...
	 */
	public GetMaxSkuRegPrcAmt() {
		super("GET_MAX_SKU_REG_PRC_AMT", Wetrn.WETRN, org.jooq.impl.SQLDataType.NUMERIC);
