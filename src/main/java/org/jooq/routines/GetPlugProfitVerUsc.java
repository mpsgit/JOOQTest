...
public class GetPlugProfitVerUsc extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = -2138476569;

	/**
	 * The parameter <code>WETRN.GET_PLUG_PROFIT_VER_USC.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.GET_PLUG_PROFIT_VER_USC.TO_OFFER_PERIOD_ID</code>.
	 */
	 ...
	 */
	public GetPlugProfitVerUsc() {
		super("GET_PLUG_PROFIT_VER_USC", Wetrn.WETRN, org.jooq.impl.SQLDataType.NUMERIC);
