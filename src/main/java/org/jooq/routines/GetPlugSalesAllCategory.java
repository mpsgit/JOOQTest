...
public class GetPlugSalesAllCategory extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = 808358081;

	/**
	 * The parameter <code>WETRN.GET_PLUG_SALES_ALL_CATEGORY.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.GET_PLUG_SALES_ALL_CATEGORY.TO_OFFER_PERIOD_ID</code>.
	 */
	...
	/**
	 * The parameter <code>WETRN.GET_PLUG_SALES_ALL_CATEGORY.MIN_OFFSET</code>.
	 */
	public static final Parameter<BigDecimal> MIN_OFFSET = createParameter("MIN_OFFSET", org.jooq.impl.SQLDataType.NUMERIC, false);

	/**
	 * The parameter <code>WETRN.GET_PLUG_SALES_ALL_CATEGORY.MAX_OFFSET</code>.
	 */
	 ...
	 */
	public GetPlugSalesAllCategory() {
		super("GET_PLUG_SALES_ALL_CATEGORY", Wetrn.WETRN, org.jooq.impl.SQLDataType.NUMERIC);
